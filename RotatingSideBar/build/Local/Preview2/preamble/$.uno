...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.5.12"), 12124)}, "/Users/SauvikDolui/Documents/sauvik.dolui/FuseDevelopment/Tutorials/RotatingSideBar/RotatingSidebar.unoproj", new string[] { })
{

// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Elements/0.24.6/Triggers/$.uno'.
...
struct LayoutTransition : uObject
{
    ...
    static void SetPositionChange(::g::Fuse::Node* n, ::g::Uno::Float2 oldPos, ::g::Uno::Float2 newPos);
    ...
    static ::g::Fuse::NodeEvent* Transitioned();
};
// }

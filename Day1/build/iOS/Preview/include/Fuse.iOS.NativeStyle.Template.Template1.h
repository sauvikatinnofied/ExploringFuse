...
namespace g{namespace Fuse{namespace iOS{struct NativeStyle__Template__Template1;}}}
...
struct NativeStyle__Template__Template1 : ::g::Uno::UX::Template
{
    ...
    static NativeStyle__Template__Template1* New1(::g::Fuse::iOS::NativeStyle__Template* parent);
};
// }

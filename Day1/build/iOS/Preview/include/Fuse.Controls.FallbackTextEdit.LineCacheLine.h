...
struct LineCacheLine : uObject
{
    ...
    int Backspace(int p);
    int BoundsToPos(::g::Fuse::Controls::Internal::WordWrapInfo* wrapInfo, int textAlignment, float boundsWidth, ::g::Uno::Float2 p);
    ::g::Fuse::Controls::Internal::WrappedLine* BoundsToWrappedLine(::g::Fuse::Controls::Internal::WordWrapInfo* wrapInfo, ::g::Uno::Float2 p);
    void Delete(int p);
    int End(::g::Fuse::Controls::Internal::WordWrapInfo* wrapInfo, int p);
    ...
    int Home(::g::Fuse::Controls::Internal::WordWrapInfo* wrapInfo, int p);

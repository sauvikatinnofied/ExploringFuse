// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Gestures/0.24.6/Internal/$.uno'.
...
struct Swiper : uObject
{
    ...
    void MoveUser(::g::Uno::Float2 coord);
    void OnLostCapture();
    ...
    void SetActivation(::g::Fuse::Gestures::Internal::SwipeRegion* region, bool on, uObject* origin, bool bypass);

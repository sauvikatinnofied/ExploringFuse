...
struct UserAppState : uObject
{
    ...
    uStrong< ::g::Fuse::Node*> RootNode;
    uStrong< ::g::Fuse::Theme*> Theme;
    static uSStrong<UserAppState*> _Default_;
    static uSStrong<UserAppState*>& _Default() { return _Default_; }

    void ctor_(::g::Uno::Float4 background, uArray* behaviors, uArray* resources, ::g::Fuse::Node* rootNode, ::g::Fuse::Theme* theme, ::g::Uno::Float4 clearColor, float clearDepth);
    void ApplyTo(::g::Outracks::Simulator::FakeApp* app);
    static UserAppState* New1(::g::Uno::Float4 background, uArray* behaviors, uArray* resources, ::g::Fuse::Node* rootNode, ::g::Fuse::Theme* theme, ::g::Uno::Float4 clearColor, float clearDepth);

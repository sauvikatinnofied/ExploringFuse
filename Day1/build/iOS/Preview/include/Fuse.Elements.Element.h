...
{
    ::g::Fuse::Triggers::Actions::IShow interface2;
    ::g::Fuse::Triggers::Actions::IHide interface3;
    ::g::Fuse::Triggers::Actions::ICollapse interface4;
    ::g::Fuse::IActualPlacement interface5;
    ::g::Fuse::Animations::IResize interface6;
...
struct Element : ::g::Fuse::Node
{
    ...
    static uSStrong< ::g::Fuse::StyleProperty1*> AspectProperty_;
    static uSStrong< ::g::Fuse::StyleProperty1*>& AspectProperty() { return Element_typeof()->Init(), AspectProperty_; }

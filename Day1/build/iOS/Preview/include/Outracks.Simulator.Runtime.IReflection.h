...
struct IReflection
{
    ...
    void(*fp_CreateDelegate)(uObject*, ::g::Outracks::Simulator::Bytecode::TypeName*, uObject*, ::g::Outracks::Simulator::Bytecode::TypeMemberName*, ::g::Outracks::Simulator::Bytecode::Signature*, uObject**);

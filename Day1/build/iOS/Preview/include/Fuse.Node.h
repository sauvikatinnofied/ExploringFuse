...
struct Node_type : uType
{
    ...
    ::g::Fuse::IDataContext interface1;
    ...
    void(*fp_GetMarginSize)(::g::Fuse::Node*, ::g::Fuse::LayoutParams*, ::g::Uno::Float2*);
    ...
    void(*fp_OnArrangeMarginBox)(::g::Fuse::Node*, ::g::Uno::Float2*, ::g::Fuse::LayoutParams*, ::g::Uno::Float2*);
...
struct Node : uObject
{
    ...
    bool IsCompatibleLayout(::g::Uno::Float2 curSize, ::g::Fuse::LayoutParams olp, ::g::Fuse::LayoutParams nlp);
    bool IsEnabled();
    ...
    static ::g::Uno::Float2 GetMarginSize(Node* __this, ::g::Fuse::LayoutParams lp);
    static bool GetSnapToPixels(Node* n);
    ...
    static ::g::Uno::Float2 OnArrangeMarginBox(Node* __this, ::g::Uno::Float2 position, ::g::Fuse::LayoutParams lp);
    ...
    static void SetSnapToPixels(Node* n, bool value);
...
inline ::g::Uno::Float2 Node::GetMarginSize(::g::Fuse::LayoutParams lp) { ::g::Uno::Float2 __retval; return (((Node_type*)__type)->fp_GetMarginSize)(this, &lp, &__retval), __retval; }
...
inline ::g::Uno::Float2 Node::OnArrangeMarginBox(::g::Uno::Float2 position, ::g::Fuse::LayoutParams lp) { ::g::Uno::Float2 __retval; return (((Node_type*)__type)->fp_OnArrangeMarginBox)(this, &position, &lp, &__retval), __retval; }
...
inline ::g::Uno::Float2 Node::GetMarginSize(Node* __this, ::g::Fuse::LayoutParams lp) { ::g::Uno::Float2 __retval; return Node__GetMarginSize_fn(__this, &lp, &__retval), __retval; }
...
inline ::g::Uno::Float2 Node::OnArrangeMarginBox(Node* __this, ::g::Uno::Float2 position, ::g::Fuse::LayoutParams lp) { ::g::Uno::Float2 __retval; return Node__OnArrangeMarginBox_fn(__this, &position, &lp, &__retval), __retval; }

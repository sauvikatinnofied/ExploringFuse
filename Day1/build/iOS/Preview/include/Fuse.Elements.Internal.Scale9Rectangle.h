...
{
    ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall _draw_d7134d74;
    uStrong<uArray*> Draw_indices_d7134d74_1_2_13;
    uStrong< ::g::Uno::Graphics::IndexBuffer*> Draw_xv_d7134d74_1_3_2;
    uStrong< ::g::Uno::Graphics::VertexBuffer*> Draw_xv_d7134d74_1_3_3;
    uStrong< ::g::Uno::Graphics::VertexBuffer*> Draw_yv_d7134d74_1_4_6;
    static uSStrong<Scale9Rectangle*> Impl_;
    static uSStrong<Scale9Rectangle*>& Impl() { return Scale9Rectangle_typeof()->Init(), Impl_; }

    void ctor_();
    void Draw(::g::Fuse::DrawContext* dc, ::g::Fuse::Node* element, ::g::Uno::Float2 size, ::g::Uno::Float2 scaleTextureSize, ::g::Uno::Graphics::Texture2D* tex, ::g::Uno::Float4 color, ::g::Uno::Float4 margin);
    void init_DrawCalls();

...
struct FuseBasicTheme_FuseElementsElement_float_Height_Property : ::g::Uno::UX::Property
{
    uStrong< ::g::Fuse::Elements::Element*> _obj;

    void ctor_1(::g::Fuse::Elements::Element* obj);
    static FuseBasicTheme_FuseElementsElement_float_Height_Property* New1(::g::Fuse::Elements::Element* obj);
};
// }

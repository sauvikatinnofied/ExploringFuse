...
struct LineCache : uObject
{
    ...
    ::g::Fuse::Controls::FallbackTextEdit::TextPosition* BoundsToTextPos(::g::Fuse::Controls::Internal::WordWrapInfo* wrapInfo, int textAlignment, float boundsWidth, ::g::Uno::Float2 p);
    ...
    ::g::Fuse::Controls::FallbackTextEdit::TextPosition* End(::g::Fuse::Controls::Internal::WordWrapInfo* wrapInfo, ::g::Fuse::Controls::FallbackTextEdit::TextPosition* p);
    ...
    ::g::Fuse::Controls::FallbackTextEdit::TextPosition* Home(::g::Fuse::Controls::Internal::WordWrapInfo* wrapInfo, ::g::Fuse::Controls::FallbackTextEdit::TextPosition* p);
    ...
    ::g::Fuse::Controls::FallbackTextEdit::TextPosition* TryMoveDown(::g::Fuse::Controls::Internal::WordWrapInfo* wrapInfo, int textAlignment, float boundsWidth, ::g::Fuse::Controls::FallbackTextEdit::TextPosition* p);
    ...
    ::g::Fuse::Controls::FallbackTextEdit::TextPosition* TryMoveUp(::g::Fuse::Controls::Internal::WordWrapInfo* wrapInfo, int textAlignment, float boundsWidth, ::g::Fuse::Controls::FallbackTextEdit::TextPosition* p);

// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Physics/0.24.6/$.uno'.
...
struct Body : uObject
{
    ...
    void ctor_(::g::Fuse::Physics::World* world, ::g::Fuse::Node* node);
    ...
    static float GetFriction(::g::Fuse::Node* n);
    static Body* New1(::g::Fuse::Physics::World* world, ::g::Fuse::Node* node);
    static Body* Pin(::g::Fuse::Node* n);
    static void SetFriction(::g::Fuse::Node* n, float friction);
};
// }

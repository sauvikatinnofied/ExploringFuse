// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Controls/0.24.6/Layouts/$.uno'.
...
struct GridLayout : ::g::Fuse::Layouts::Layout
{
    ...
    static int GetRow(::g::Fuse::Node* elm);
    static int GetRowSpan(::g::Fuse::Node* elm);
    static GridLayout* New1();
    static void ResetColumn(::g::Fuse::Node* elm);
    static void ResetColumnSpan(::g::Fuse::Node* elm);
    static void ResetRow(::g::Fuse::Node* elm);
    static void ResetRowSpan(::g::Fuse::Node* elm);
    static void SetColumn(::g::Fuse::Node* elm, int col);
    static void SetColumnSpan(::g::Fuse::Node* elm, int span);
    static void SetRow(::g::Fuse::Node* elm, int row);
    static void SetRowSpan(::g::Fuse::Node* elm, int span);
};
// }

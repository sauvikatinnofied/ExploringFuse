...
struct Optional1
{
    ...
    static bool op_Equality(uType* __type, Optional1<T> left, Optional1<T> right) { bool __retval; return Optional1__op_Equality_fn(__type, uConstrain(__type, left), uConstrain(__type, right), &__retval), __retval; }
    static bool op_Inequality(uType* __type, Optional1<T> left, Optional1<T> right) { bool __retval; return Optional1__op_Inequality_fn(__type, uConstrain(__type, left), uConstrain(__type, right), &__retval), __retval; }
};

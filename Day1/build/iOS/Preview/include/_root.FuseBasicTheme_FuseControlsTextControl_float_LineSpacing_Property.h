...
struct FuseBasicTheme_FuseControlsTextControl_float_LineSpacing_Property : ::g::Uno::UX::Property
{
    uStrong< ::g::Fuse::Controls::TextControl*> _obj;

    void ctor_1(::g::Fuse::Controls::TextControl* obj);
    static FuseBasicTheme_FuseControlsTextControl_float_LineSpacing_Property* New1(::g::Fuse::Controls::TextControl* obj);
};
// }

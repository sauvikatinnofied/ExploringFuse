// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Elements/0.24.6/Caching/$.uno'.
...
struct ElementBatcher : uObject
{
    ...
    void ctor_();
    void AddElement(::g::Fuse::Node* elm);
    ...
    static bool ShouldBatchElement(::g::Fuse::Node* node);

...
struct Player : uObject
{
    ...
    void ctor_(::g::Fuse::Node* elm, ::g::Fuse::Animations::TriggerAnimation* animation, int variant, int mode);
    ...
    static Player* New1(::g::Fuse::Node* elm, ::g::Fuse::Animations::TriggerAnimation* animation, int variant, int mode);
};
// }

...
struct Math : uObject
{
    ...
    static float Acos1(float radians_);
    static double Asin(double radians_);
    static float Asin1(float radians_);
    static float Atan22(float y_, float x_);
    static double Ceil(double x_);
    static float Ceil1(float x_);
    ...
    static float Cos1(float radians_);
    ...
    static double Floor(double x_);
    static float Floor1(float x_);
    ...
    static double Pow(double x_, double y_);
    static float Pow1(float x_, float y_);
    ...
    static double Sin(double radians_);
    static float Sin1(float radians_);
    static double Sqrt(double x_);
    static float Sqrt1(float x_);
    static ::g::Uno::Float2 Sqrt2(::g::Uno::Float2 x);
    static float Tan1(float radians_);
};
// }

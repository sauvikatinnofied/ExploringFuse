// This file was generated based on '/usr/local/share/uno/Packages/UnoCore/0.24.3/Source/OpenGL/$.uno'.
...
struct GL : uObject
{
    ...
    static void TexImage2D1(int target_, int level_, int internalFormat_, int width_, int height_, int border_, int format_, int type_, void* data_);

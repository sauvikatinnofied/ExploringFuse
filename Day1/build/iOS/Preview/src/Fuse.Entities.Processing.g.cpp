...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Entities/0.24.6/Processing/$.uno(27)
// -------------------------------------------------------------------------------------------
...
Extrude_type* Extrude_typeof()
{
    ...
    ::TYPES[2] = ::g::Fuse::IOutput_typeof()->MakeType(::g::Fuse::Drawing::Polygon_typeof());
    type->SetInterfaces(
...
void Extrude::Source(uObject* value)
{
    ...
    if (_source != NULL)
        ::g::Fuse::IOutput::remove_OutputChanged(uInterface(uPtr(_source), ::TYPES[2/*Fuse.IOutput<Fuse.Drawing.Polygon>*/]), uDelegate::New(::TYPES[1/*Uno.Action*/], (void*)Extrude__Invalidate_fn, this));

    _source = value;

    if (_source != NULL)
        ::g::Fuse::IOutput::add_OutputChanged(uInterface(uPtr(_source), ::TYPES[2/*Fuse.IOutput<Fuse.Drawing.Polygon>*/]), uDelegate::New(::TYPES[1/*Uno.Action*/], (void*)Extrude__Invalidate_fn, this));
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Entities/0.24.6/Processing/$.uno(108)
// --------------------------------------------------------------------------------------------

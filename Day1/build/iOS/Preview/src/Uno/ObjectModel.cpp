// This file was generated based on '/usr/local/share/uno/Packages/UnoCore/0.24.3/Targets/CPlusPlus/Source/Uno/ObjectModel.cpp'.
...
static Xli::MutexHandle _Mutex;
static Xli::HashMap<Xli::String, uString*>* _StringConsts;
static Xli::HashMap<uTypeKey, uType*>* _TypeMap;
static Xli::Array<uGenericType*>* _GenericTypes;
static Xli::Array<uType*>* _RuntimeTypes;
...
{
    _Mutex = Xli::CreateMutex();
    _GenericTypes = new Xli::Array<uGenericType*>();
    _RuntimeTypes = new Xli::Array<uType*>();
    _StringConsts = new Xli::HashMap<Xli::String, uString*>();
    _TypeMap = new Xli::HashMap<uTypeKey, uType*>();
...
static void uBuildParameterization(uType* type)
{
    ...
    if (type->Type == uTypeTypeGeneric)
    {
        ...
        parent->Build();
        U_ASSERT(type->PrecalcCount == parent->PrecalcCount);
    ...
    else
    {
        ...
        U_ASSERT(type->PrecalcCount == def->PrecalcCount &&
...
static void uVerifyBuild(uType* type)
{
    ...
    Xli::ShellSort<uInterfaceInfo, uInterfaceCompararer>(type->Interfaces, 0, (int)type->InterfaceCount);
...
{
    Xli::Utf16String utf16 = Xli::Unicode::Utf8To16(mutf8, (int)length, Xli::UnicodeFlagsModifiedUtf8 | Xli::UnicodeFlagsIgnoreError);
...
{
    return string ? Xli::Unicode::Utf16To8(string->Ptr(), string->Length()).SwapPtr() : NULL;
}

...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Desktop/0.24.6/$.uno(71)
// -------------------------------------------------------------------------------

// internal sealed class DesktopRootViewport :71
// {
::g::Fuse::RootViewport_type* DesktopRootViewport_typeof()
{
    ...
    type->interface2.fp_get_PointDensity = (void(*)(uObject*, float*))::g::Fuse::RootViewport__get_PointDensity_fn;
...
// public DesktopRootViewport(Uno.Platform.Window window) :75
void DesktopRootViewport__ctor_2_fn(DesktopRootViewport* __this, ::g::Uno::Platform::Window* window)
{
    __this->ctor_2(window);
}

// public DesktopRootViewport New(Uno.Platform.Window window) :75
...
// private Fuse.Input.PointerEventData TranslatePointerEvent(Uno.Platform.PointerEventArgs args) :90
...
// public DesktopRootViewport(Uno.Platform.Window window) [instance] :75
...
// private Fuse.Input.PointerEventData TranslatePointerEvent(Uno.Platform.PointerEventArgs args) [instance] :90
::g::Fuse::Input::PointerEventData* DesktopRootViewport::TranslatePointerEvent(::g::Uno::Platform::PointerEventArgs* args)
{
    ...
    uPtr(collection1)->WindowPoint = ::g::Uno::Float2__op_Division1(uPtr(args)->Position(), OSPointDensity());
...
// public DesktopRootViewport New(Uno.Platform.Window window) [static] :75
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Desktop/0.24.6/.uno/$.uno(30)
// ------------------------------------------------------------------------------------
...
void NativeStyle__Template1__Factory__ctor_1_fn(NativeStyle__Template1__Factory* __this, ::g::Fuse::Desktop::NativeStyle__Template1* parent)
{
...
{
    uStackFrame __("Fuse.Desktop.NativeStyle.Template1.Factory", "New()");
...
void NativeStyle__Template1__Factory::ctor_1(::g::Fuse::Desktop::NativeStyle__Template1* parent)
{
    uStackFrame __("Fuse.Desktop.NativeStyle.Template1.Factory", ".ctor(Fuse.Desktop.NativeStyle.Template1)");
    ctor_(NULL, false);
    __parent1 = parent;
}
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Desktop/0.24.6/.uno/$.uno(5)
// -----------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Desktop/0.24.6/.uno/$.uno(7)
// -----------------------------------------------------------------------------------
...
{
    uStackFrame __("Fuse.Desktop.NativeStyle.Template", "OnApply(Fuse.Controls.TextBlock)");
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Desktop/0.24.6/.uno/$.uno(23)
// ------------------------------------------------------------------------------------
...
::g::Uno::UX::Template_type* NativeStyle__Template1_typeof()
{
    ...
    ::TYPES[16] = ::g::Uno::UX::Factory_typeof();
    type->SetInterfaces(
        ::g::Uno::UX::ITemplate_typeof(), offsetof(::g::Uno::UX::Template_type, interface0));
    type->SetFields(2,
...
{
    uStackFrame __("Fuse.Desktop.NativeStyle.Template1", ".ctor(Fuse.Desktop.NativeStyle)");
    ctor_();
    __parent1 = parent;
}

...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Protocol.Uno/0.0.0/$.uno(31)
// -------------------------------------------------------------------------------------------------
...
uString* AggregateConnectError::ToIndentedLines(uObject* innerExceptions)
{
    ...
    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(innerExceptions), ::TYPES[69/*Uno.Collections.IEnumerable<Uno.Exception>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::g::Uno::Collections::IEnumerator_typeof())); )
    {
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(21)
// -----------------------------------------------------------------------------------------------
...
Application_type* Application_typeof()
{
    ...
    ::TYPES[9] = ::g::Fuse::NodeEventArgs_typeof();
    ::TYPES[10] = ::g::Fuse::UnhandledExceptionArgs_typeof();
    ::TYPES[11] = ::g::Fuse::App_typeof();
    ::TYPES[12] = ::g::Outracks::Simulator::FakeApp_typeof();
    ::TYPES[13] = ::g::Fuse::Node_typeof();
    ::TYPES[14] = ::g::Outracks::Simulator::UserAppState_typeof();
    ::TYPES[15] = ::g::Outracks::Simulator::Context_typeof();
    type->SetInterfaces(
...
// public void OnPointerMoved(Fuse.Input.PointerMovedArgs args) :76
void Application__OnPointerMoved_fn(Application* __this, ::g::Fuse::Input::PointerMovedArgs* args)
{
    __this->OnPointerMoved(args);
}

// public void OnPointerPressed(Fuse.Input.PointerPressedArgs args) :69
...
// public void OnPointerReleased(Fuse.Input.PointerReleasedArgs args) :83
...
// public void OnPointerWheelMoved(Fuse.Input.PointerWheelMovedArgs args) :90
...
// private void OnUnhandledException(object sender, Fuse.UnhandledExceptionArgs args) :100
...
// protected override sealed void OnUpdate() :107
...
// public void OnPointerMoved(Fuse.Input.PointerMovedArgs args) [instance] :76
...
// public void OnPointerPressed(Fuse.Input.PointerPressedArgs args) [instance] :69
...
// public void OnPointerReleased(Fuse.Input.PointerReleasedArgs args) [instance] :83
...
// public void OnPointerWheelMoved(Fuse.Input.PointerWheelMovedArgs args) [instance] :90
...
// private void OnUnhandledException(object sender, Fuse.UnhandledExceptionArgs args) [instance] :100
...
// private void ResetEverything() [instance] :43
...
// private void SetState(Outracks.Simulator.State nextState) [instance] :121
...
// private void TryUnrootEverything() [instance] :56
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Protocol.Uno/0.0.0/Common/$.uno(83)
// --------------------------------------------------------------------------------------------------------
...
uType* Apply_typeof()
{
    ...
    ::TYPES[16] = ::g::Uno::Action1_typeof();
    type->SetPrecalc(
        ::TYPES[16/*Uno.Action`1*/]->MakeType(type->T(0)));
    type->SetFields(0,
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Protocol.Uno/0.0.0/Common/$.uno(100)
// ---------------------------------------------------------------------------------------------------------
...
uType* ApplyFirst_typeof()
{
    ...
    ::TYPES[17] = ::g::Uno::Action2_typeof();
    type->SetPrecalc(
        ::TYPES[17/*Uno.Action`2*/]->MakeType(type->T(0), type->T(1)));
    type->SetFields(0,
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Protocol.Uno/0.0.0/Common/$.uno(116)
// ---------------------------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(972)
// ------------------------------------------------------------------------------------------------

// public sealed class ArrayStream :972
// {
...
// public override sealed bool get_CanSeek() :991
...
// public override sealed bool get_CanTimeout() :996
...
// public override sealed bool get_CanWrite() :986
...
// public ArrayStream New(byte[] buffer) :1017
void ArrayStream__New1_fn(uArray* buffer, ArrayStream** __retval)
{
    *__retval = ArrayStream::New1(buffer);
}

// public generated override sealed long get_Position() :1015
...
// public generated override sealed void set_Position(long value) :1015
...
// public override sealed int Read(byte[] dst, int byteOffset, int byteCount) :1037
...
// private void ResizeTo(int newSize) :1081
void ArrayStream__ResizeTo_fn(ArrayStream* __this, int* newSize)
{
    __this->ResizeTo(*newSize);
}

// public override sealed long Seek(long byteOffset, Uno.IO.SeekOrigin origin) :1048
...
// public override sealed void SetLength(long value) :1094
...
// public override sealed void Write(byte[] src, int byteOffset, int byteCount) :1023
...
// public int get_Capacity() [instance] :1009
...
// private void EnsureCapacity(int byteCount) [instance] :1065
...
// public byte[] GetBuffer() [instance] :1089
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(1427)
// -------------------------------------------------------------------------------------------------

// public static class BytecodeCache :1427
// {
uClassType* BytecodeCache_typeof()
{
    ...
    ::TYPES[23] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Protocol::Reify_typeof());
    ::TYPES[24] = ::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(::g::Outracks::Simulator::Protocol::Reify_typeof());
    ::TYPES[25] = uObject_typeof();
    ::TYPES[26] = ::g::Outracks::Simulator::Protocol::Reify_typeof();
    ::TYPES[27] = ::g::Uno::UInt_typeof();
    ::TYPES[15] = ::g::Outracks::Simulator::Context_typeof();
...
// public static void TrySave(Outracks.Simulator.Protocol.Reify reify) :1430
void BytecodeCache__TrySave_fn(::g::Outracks::Simulator::Protocol::Reify* reify)
{
    BytecodeCache::TrySave(reify);
}

// private static Outracks.Simulator.Protocol.Reify Load() [static] :1466
...
// private static void Save(Outracks.Simulator.Protocol.Reify reify) [static] :1442
...
// public static Outracks.Simulator.Bytecode.Optional<Outracks.Simulator.Protocol.Reify> TryLoad() [static] :1454
::g::Outracks::Simulator::Bytecode::Optional1<uStrong< ::g::Outracks::Simulator::Protocol::Reify*> > BytecodeCache::TryLoad()
{
    ...
    try
    {
        return (::g::Outracks::Simulator::Bytecode::Optional__Some_fn(::TYPES[23/*Outracks.Simulator.Bytecode.Optional.Some<Outracks.Simulator.Protocol.Reify>*/], BytecodeCache::Load(), &ret1), ret1);
    }
    catch (const uThrowable& __t)
    {
        ::g::Uno::Exception* _ = __t.Exception;
        return (::g::Outracks::Simulator::Bytecode::Optional1__op_Implicit_fn(::TYPES[24/*Outracks.Simulator.Bytecode.Optional<Outracks.Simulator.Protocol.Reify>*/], ::g::Outracks::Simulator::Bytecode::Optional::None(), &ret2), ret2);
    }
}

// public static void TrySave(Outracks.Simulator.Protocol.Reify reify) [static] :1430
...
// private static string get_CacheFileName() [static] :1488
uString* BytecodeCache::CacheFileName()
{
    uStackFrame __("Outracks.Simulator.BytecodeCache", "get_CacheFileName()");
    return ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition(uBox<uint32_t>(::TYPES[27/*uint*/], BytecodeCache::ProjectHash()), ::STRINGS[6/*"."*/]), ::g::Outracks::Simulator::Protocol::Reify::BinaryFormat());
}

// private static string get_CachePath() [static] :1478
...
// private static string get_FuseDataDirectory() [static] :1483
...
// private static uint get_ProjectHash() [static] :1493
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(580)
// ------------------------------------------------------------------------------------------------

// internal sealed class ChangeIp :580
// {
::g::Outracks::Simulator::ShowingPrompt_type* ChangeIp_typeof()
{
    ...
    ::TYPES[2] = ::g::Outracks::Simulator::State_typeof();
    ::TYPES[1] = ::g::Uno::Exception_typeof();
    ::TYPES[29] = ::g::Uno::Net::IPEndPoint_typeof()->Array();
    ::TYPES[30] = ::g::Uno::Net::IPEndPoint_typeof();
    ::TYPES[15] = ::g::Outracks::Simulator::Context_typeof();
    type->SetFields(5);
    return type;
}

// public ChangeIp([string body]) :582
void ChangeIp__ctor_2_fn(ChangeIp* __this, uString* body)
{
    __this->ctor_2(body);
}

// public ChangeIp New([string body]) :582
void ChangeIp__New1_fn(uString* body, ChangeIp** __retval)
{
    *__retval = ChangeIp::New1(body);
}

// protected override sealed Outracks.Simulator.State OnCancel() :596
...
// public override sealed Outracks.Simulator.State OnException(Uno.Exception e) :601
...
// protected override sealed Outracks.Simulator.State OnOk(string input) :587
void ChangeIp__OnOk_fn(ChangeIp* __this, uString* input, ::g::Outracks::Simulator::State** __retval)
{
    ...
    uArray* endpoints = uArray::Init< ::g::Uno::Net::IPEndPoint*>(::TYPES[29/*Uno.Net.IPEndPoint[]*/], 1, (::g::Uno::Net::IPEndPoint*)::g::Uno::Net::IPEndPoint::New1(::g::Uno::Net::IPAddress::Parse(input), uPtr(uPtr(::g::Outracks::Simulator::Context::ProxyEndpoints())->Strong< ::g::Uno::Net::IPEndPoint*>(0))->Port()));
    return *__retval = ::g::Outracks::Simulator::ConnectingToProxy::New2(endpoints), void();
}

// public ChangeIp([string body]) [instance] :582
...
// public ChangeIp New([string body]) [static] :582
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Protocol.Uno/0.0.0/Common/$.uno(9)
// -------------------------------------------------------------------------------------------------------
...
uClassType* Closure_typeof()
{
    ...
    ::TYPES[32] = ::g::Outracks::Simulator::Apply_typeof();
    ::TYPES[16] = ::g::Uno::Action1_typeof();
    ::TYPES[33] = ::g::Outracks::Simulator::ApplyFirst_typeof();
    ::TYPES[34] = ::g::Outracks::Simulator::ApplySecond_typeof();
    ::TYPES[17] = ::g::Uno::Action2_typeof();
    ::TYPES[35] = ::g::Outracks::Simulator::ForgetAction_typeof();
    ::TYPES[36] = ::g::Uno::Func1_typeof();
    ::TYPES[37] = ::g::Outracks::Simulator::Forget_typeof();
...
void Closure__Apply_fn(uType* __type, uDelegate* action, void* arg, uDelegate** __retval)
{
    uType* __types[] = {
        __type->U(0),
        ::TYPES[32/*Outracks.Simulator.Apply`1*/]->MakeType(__type->U(0)),
    };
    uStackFrame __("Outracks.Simulator.Closure", "Apply`1(Uno.Action<T>,T)");
    ::g::Outracks::Simulator::Apply* ret1;
    return *__retval = uDelegate::New(::TYPES[31/*Uno.Action*/], (void*)::g::Outracks::Simulator::Apply__Execute_fn, (::g::Outracks::Simulator::Apply__New1_fn(__types[1], action, arg, &ret1), ret1)), void();
}
...
void Closure__ApplyFirst_fn(uType* __type, uDelegate* action, void* arg1, uDelegate** __retval)
{
    uType* __types[] = {
        __type->U(0),
        ::TYPES[16/*Uno.Action`1*/]->MakeType(__type->U(1)),
        __type->U(1),
        ::TYPES[33/*Outracks.Simulator.ApplyFirst`2*/]->MakeType(__type->U(0), __type->U(1)),
    };
...
void Closure__ApplySecond_fn(uType* __type, uDelegate* action, void* arg2, uDelegate** __retval)
{
    uType* __types[] = {
        __type->U(1),
        ::TYPES[16/*Uno.Action`1*/]->MakeType(__type->U(0)),
        __type->U(0),
        ::TYPES[34/*Outracks.Simulator.ApplySecond`2*/]->MakeType(__type->U(0), __type->U(1)),
    };
...
void Closure__Return_fn(uType* __type, void* result, uDelegate** __retval)
{
    uType* __types[] = {
        __type->U(1),
        ::TYPES[36/*Uno.Func`2*/]->MakeType(__type->U(0), __type->U(1)),
        __type->U(0),
        ::TYPES[37/*Outracks.Simulator.Forget`2*/]->MakeType(__type->U(0), __type->U(1)),
    };
...
{
    uType* __types[] = {
        ::TYPES[17/*Uno.Action`2*/]->MakeType(__type->U(0), __type->U(1)),
        __type->U(0),
        __type->U(1),
        ::TYPES[35/*Outracks.Simulator.ForgetAction`2*/]->MakeType(__type->U(0), __type->U(1)),
    };
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(1936)
// -------------------------------------------------------------------------------------------------

// private sealed class EnumerableHitTestExtension.CollectHitNodesClosure :1936
// {
uType* EnumerableHitTestExtension__CollectHitNodesClosure_typeof()
{
    ...
    ::TYPES[38] = ::g::Fuse::HitTestResult_typeof();
    type->SetFields(0,
...
// public CollectHitNodesClosure(Uno.Collections.List<Fuse.Node> nodes) :1940
...
// public void HitTestCallback(Fuse.HitTestResult result) :1945
...
// public CollectHitNodesClosure New(Uno.Collections.List<Fuse.Node> nodes) :1940
...
// public CollectHitNodesClosure(Uno.Collections.List<Fuse.Node> nodes) [instance] :1940
...
// public void HitTestCallback(Fuse.HitTestResult result) [instance] :1945
...
// public CollectHitNodesClosure New(Uno.Collections.List<Fuse.Node> nodes) [static] :1940
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Protocol.Uno/0.0.0/Concurrency/$.uno(10)
// -------------------------------------------------------------------------------------------------------------
...
uType* ConcurrentQueue_typeof()
{
    ...
    ::TYPES[39] = ::g::Uno::Collections::Queue_typeof();
    type->SetPrecalc(
        ::TYPES[39/*Uno.Collections.Queue`1*/]->MakeType(type->T(0)));
    type->SetFields(0,
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(267)
// ------------------------------------------------------------------------------------------------

// internal abstract class Connected :267
// {
Connected_type* Connected_typeof()
{
    ...
    ::TYPES[2] = ::g::Outracks::Simulator::State_typeof();
    ::TYPES[40] = ::g::Outracks::Simulator::Protocol::Error_typeof();
    ::TYPES[14] = ::g::Outracks::Simulator::UserAppState_typeof();
    ::TYPES[15] = ::g::Outracks::Simulator::Context_typeof();
    ::TYPES[41] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Exception_typeof());
    ::TYPES[42] = ::g::Outracks::Simulator::Protocol::Execute_typeof();
    ::TYPES[43] = uObject_typeof()->Array();
    ::TYPES[44] = ::g::Outracks::Simulator::ISimulatorClient_typeof();
    ::TYPES[45] = ::g::Outracks::Simulator::Protocol::MessageToClient_typeof()->MakeMethod(1, ::g::Outracks::Simulator::State_typeof());
    ::TYPES[46] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Protocol::Reify_typeof(), ::g::Outracks::Simulator::State_typeof());
    ::TYPES[47] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Protocol::Execute_typeof(), ::g::Outracks::Simulator::State_typeof());
    ::TYPES[48] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Protocol::Error_typeof(), ::g::Outracks::Simulator::State_typeof());
    type->SetFields(0,
        ::g::Outracks::Simulator::ISimulatorClient_typeof(), offsetof(::g::Outracks::Simulator::Connected, Client), 0);
    return type;
}

// protected Connected(Outracks.Simulator.ISimulatorClient client) :271
void Connected__ctor_1_fn(Connected* __this, uObject* client)
{
    __this->ctor_1(client);
}

// protected Outracks.Simulator.State OnConnectionError(Outracks.Simulator.Protocol.Error error) :321
...
// public override Outracks.Simulator.State OnEnterState() :277
...
// public override sealed Outracks.Simulator.State OnException(Uno.Exception e) :283
...
// protected Outracks.Simulator.State OnExecute(Outracks.Simulator.Protocol.Execute args) :315
...
// protected Outracks.Simulator.State OnReify(Outracks.Simulator.Protocol.Reify reify) :310
...
// public override Outracks.Simulator.State OnUpdate() :293
void Connected__OnUpdate_fn(Connected* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    while ((::g::Outracks::Simulator::ConcurrentQueue__TryDequeue_fn(uPtr(::g::Outracks::Simulator::ISimulatorClient::IncommingMessages(uInterface(uPtr(__this->Client), ::TYPES[44/*Outracks.Simulator.ISimulatorClient*/]))), (void**)(&message), &ret2), ret2))
    {
        ::g::Outracks::Simulator::State* newState = (::g::Outracks::Simulator::Protocol::MessageToClient__Match1_fn(uPtr(message), ::TYPES[45/*Outracks.Simulator.Protocol.MessageToClient.Match<Outracks.Simulator.State>*/], uDelegate::New(::TYPES[46/*Uno.Func<Outracks.Simulator.Protocol.Reify, Outracks.Simulator.State>*/], (void*)Connected__OnReify_fn, __this), uDelegate::New(::TYPES[47/*Uno.Func<Outracks.Simulator.Protocol.Execute, Outracks.Simulator.State>*/], (void*)Connected__OnExecute_fn, __this), uDelegate::New(::TYPES[48/*Uno.Func<Outracks.Simulator.Protocol.Error, Outracks.Simulator.State>*/], (void*)Connected__OnConnectionError_fn, __this), &ret3), ret3);
...
// protected Connected(Outracks.Simulator.ISimulatorClient client) [instance] :271
...
// protected Outracks.Simulator.State OnConnectionError(Outracks.Simulator.Protocol.Error error) [instance] :321
...
// protected Outracks.Simulator.State OnExecute(Outracks.Simulator.Protocol.Execute args) [instance] :315
::g::Outracks::Simulator::State* Connected::OnExecute(::g::Outracks::Simulator::Protocol::Execute* args)
{
    ...
    ::g::Outracks::Simulator::Runtime::VirtualMachine::Execute(uPtr(args)->Function, uArray::New(::TYPES[43/*object[]*/], 0));
    return this;
}

// protected Outracks.Simulator.State OnReify(Outracks.Simulator.Protocol.Reify reify) [instance] :310
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(198)
// ------------------------------------------------------------------------------------------------

// internal abstract class Connecting :198
// {
...
// protected generated Connecting() :198
void Connecting__ctor_1_fn(Connecting* __this)
{
    __this->ctor_1();
}

// public override sealed Outracks.Simulator.State OnException(Uno.Exception e) :200
...
// protected generated Connecting() [instance] :198
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(238)
// ------------------------------------------------------------------------------------------------

// internal sealed class ConnectingToHost :238
// {
::g::Outracks::Simulator::State_type* ConnectingToHost_typeof()
{
    ...
    ::TYPES[49] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Uno::Net::IPEndPoint_typeof());
    ::TYPES[50] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof());
    ::TYPES[51] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof());
    ::TYPES[15] = ::g::Outracks::Simulator::Context_typeof();
    ::TYPES[2] = ::g::Outracks::Simulator::State_typeof();
    ::TYPES[52] = ::g::Outracks::Simulator::Task_typeof()->MakeType(::g::Outracks::Simulator::ISimulatorClient_typeof());
    type->SetFields(0,
...
// public ConnectingToHost(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint> simulatorEndpoints) :242
void ConnectingToHost__ctor_2_fn(ConnectingToHost* __this, uObject* simulatorEndpoints)
{
    __this->ctor_2(simulatorEndpoints);
}

// public ConnectingToHost New(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint> simulatorEndpoints) :242
...
// public override sealed Outracks.Simulator.State OnEnterState() :249
void ConnectingToHost__OnEnterState_fn(ConnectingToHost* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    __this->_connecting = ::g::Outracks::Simulator::SimulatorClient::Connect((uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[51/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Uno.Net.IPEndPoint>*/], __this->_simulatorEndpoints)));
    ::g::Outracks::Simulator::LoadingScreen::Show(::g::Outracks::Simulator::Context::App(), ::STRINGS[13/*"Connecting"*/], ::STRINGS[14/*"Connecting ...*/]);
    return *__retval = __this, void();
}

// public override sealed Outracks.Simulator.State OnUpdate() :256
...
// public ConnectingToHost(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint> simulatorEndpoints) [instance] :242
void ConnectingToHost::ctor_2(uObject* simulatorEndpoints)
{
    ...
    ctor_1();
    _simulatorEndpoints = ((uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[49/*Uno.Collections.EnumerableExtensions.ToArray<Uno.Net.IPEndPoint>*/], simulatorEndpoints));
}

// public ConnectingToHost New(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint> simulatorEndpoints) [static] :242
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(207)
// ------------------------------------------------------------------------------------------------

// internal sealed class ConnectingToProxy :207
// {
::g::Outracks::Simulator::State_type* ConnectingToProxy_typeof()
{
    ...
    ::TYPES[50] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof());
    ::TYPES[51] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof());
    ::TYPES[53] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[54] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[2] = ::g::Outracks::Simulator::State_typeof();
    ::TYPES[55] = ::g::Outracks::Simulator::Task_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof()->Array());
    type->SetFields(0,
...
// public override sealed Outracks.Simulator.State OnEnterState() :222
void ConnectingToProxy__OnEnterState_fn(ConnectingToProxy* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    __this->_connecting = ::g::Outracks::Simulator::ProxyClient::GetSimulatorEndpoint((uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[51/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Uno.Net.IPEndPoint>*/], __this->_proxyEndpoints)), ::g::Outracks::Simulator::Context::Project(), (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[54/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<string>*/], ::g::Outracks::Simulator::Context::Defines())));
    ::g::Outracks::Simulator::LoadingScreen::Show(::g::Outracks::Simulator::Context::App(), ::STRINGS[13/*"Connecting"*/], ::STRINGS[15/*"Connecting ...*/]);
    return *__retval = __this, void();
}

// public override sealed Outracks.Simulator.State OnUpdate() :229
void ConnectingToProxy__OnUpdate_fn(ConnectingToProxy* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    if (uPtr(__this->_connecting)->IsCompleted())
        return *__retval = ::g::Outracks::Simulator::ConnectingToHost::New1((uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[51/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Uno.Net.IPEndPoint>*/], (::g::Outracks::Simulator::Task__get_Result_fn(uPtr(__this->_connecting), &ret3), ret3)))), void();

    return *__retval = __this, void();
}

// public ConnectingToProxy() [instance] :217
...
// public ConnectingToProxy(Uno.Net.IPEndPoint[] proxyEndpoints) [instance] :212
...
// public ConnectingToProxy New() [static] :217
...
// public ConnectingToProxy New(Uno.Net.IPEndPoint[] proxyEndpoints) [static] :212
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(550)
// ------------------------------------------------------------------------------------------------

// internal sealed class ConnectionLost :550
// {
::g::Outracks::Simulator::State_type* ConnectionLost_typeof()
{
    ...
    ::TYPES[56] = ::g::Outracks::Simulator::Protocol::ExceptionInfo_typeof();
    ::TYPES[57] = ::g::Outracks::Simulator::DialogButton_typeof()->Array();
    ::TYPES[2] = ::g::Outracks::Simulator::State_typeof();
    type->SetFields(5);
    return type;
}

// public ConnectionLost(Outracks.Simulator.Protocol.ExceptionInfo exception) :556
...
// public ConnectionLost(Uno.Exception exception) :552
void ConnectionLost__ctor_3_fn(ConnectionLost* __this, ::g::Uno::Exception* exception)
{
    __this->ctor_3(exception);
}

// public ConnectionLost New(Outracks.Simulator.Protocol.ExceptionInfo exception) :556
...
// public ConnectionLost New(Uno.Exception exception) :552
void ConnectionLost__New3_fn(::g::Uno::Exception* exception, ConnectionLost** __retval)
{
    *__retval = ConnectionLost::New3(exception);
}

// public ConnectionLost(Outracks.Simulator.Protocol.ExceptionInfo exception) [instance] :556
...
// public ConnectionLost New(Outracks.Simulator.Protocol.ExceptionInfo exception) [static] :556
...
// public ConnectionLost New(Uno.Exception exception) [static] :552
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(800)
// ------------------------------------------------------------------------------------------------

// internal sealed class ConnectToSimulator :800
// {
uType* ConnectToSimulator_typeof()
{
    ...
    ::TYPES[58] = ::g::Uno::Net::EndPoint_typeof();
    ::TYPES[44] = ::g::Outracks::Simulator::ISimulatorClient_typeof();
    type->SetFields(0,
...
// public ConnectToSimulator(Uno.Net.IPEndPoint endpoint) [instance] :804
void ConnectToSimulator::ctor_(::g::Uno::Net::IPEndPoint* endpoint)
{
    uStackFrame __("Outracks.Simulator.ConnectToSimulator", ".ctor(Uno.Net.IPEndPoint)");
    _endpoint = endpoint;
}

// public Outracks.Simulator.ISimulatorClient Execute() [instance] :809
uObject* ConnectToSimulator::Execute()
{
    uStackFrame __("Outracks.Simulator.ConnectToSimulator", "Execute()");
...
// public ConnectToSimulator New(Uno.Net.IPEndPoint endpoint) [static] :804
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(1609)
// -------------------------------------------------------------------------------------------------

// public static class Context :1609
// {
...
// public static generated Outracks.Simulator.FakeApp get_App() :1612
void Context__get_App_fn(::g::Outracks::Simulator::FakeApp** __retval)
{
    *__retval = Context::App();
}

// private static generated void set_App(Outracks.Simulator.FakeApp value) :1612
void Context__set_App_fn(::g::Outracks::Simulator::FakeApp* value)
{
    Context::App(value);
}

// public static generated string[] get_Defines() :1615
void Context__get_Defines_fn(uArray** __retval)
{
    *__retval = Context::Defines();
}

// private static generated void set_Defines(string[] value) :1615
void Context__set_Defines_fn(uArray* value)
{
    Context::Defines(value);
}

// public static generated Outracks.Simulator.InputMode get_InputMode() :1611
void Context__get_InputMode_fn(int* __retval)
{
    *__retval = Context::InputMode();
}

// private static generated void set_InputMode(Outracks.Simulator.InputMode value) :1611
void Context__set_InputMode_fn(int* value)
{
    Context::InputMode(*value);
}

// public static generated string get_Project() :1614
void Context__get_Project_fn(uString** __retval)
{
    *__retval = Context::Project();
}

// private static generated void set_Project(string value) :1614
void Context__set_Project_fn(uString* value)
{
    Context::Project(value);
}

// public static generated Uno.Net.IPEndPoint[] get_ProxyEndpoints() :1613
void Context__get_ProxyEndpoints_fn(uArray** __retval)
{
    *__retval = Context::ProxyEndpoints();
}

// private static generated void set_ProxyEndpoints(Uno.Net.IPEndPoint[] value) :1613
void Context__set_ProxyEndpoints_fn(uArray* value)
{
    Context::ProxyEndpoints(value);
}

// public static generated Outracks.Simulator.Runtime.IReflection get_Reflection() :1617
void Context__get_Reflection_fn(uObject** __retval)
{
    *__retval = Context::Reflection();
}

// public static generated void set_Reflection(Outracks.Simulator.Runtime.IReflection value) :1617
void Context__set_Reflection_fn(uObject* value)
{
    Context::Reflection(value);
}

// public static void SetApp(Outracks.Simulator.FakeApp app) :1635
void Context__SetApp_fn(::g::Outracks::Simulator::FakeApp* app)
{
    Context::SetApp(app);
}

// public static void SetDesignMode() :1619
void Context__SetDesignMode_fn()
{
    Context::SetDesignMode();
}

// public static void SetGlobals(Uno.Net.IPEndPoint[] proxyEndpoints, string project, string[] defines) :1640
...
// public static void SetInteractiveMode() :1627
...
// public static void SetApp(Outracks.Simulator.FakeApp app) [static] :1635
...
// public static void SetDesignMode() [static] :1619
...
// public static void SetGlobals(Uno.Net.IPEndPoint[] proxyEndpoints, string project, string[] defines) [static] :1640
...
// public static void SetInteractiveMode() [static] :1627
...
// public static generated Outracks.Simulator.FakeApp get_App() [static] :1612
...
// private static generated void set_App(Outracks.Simulator.FakeApp value) [static] :1612
...
// public static generated string[] get_Defines() [static] :1615
...
// private static generated void set_Defines(string[] value) [static] :1615
...
// public static generated Outracks.Simulator.InputMode get_InputMode() [static] :1611
...
// private static generated void set_InputMode(Outracks.Simulator.InputMode value) [static] :1611
...
// public static generated string get_Project() [static] :1614
...
// private static generated void set_Project(string value) [static] :1614
...
// public static generated Uno.Net.IPEndPoint[] get_ProxyEndpoints() [static] :1613
...
// private static generated void set_ProxyEndpoints(Uno.Net.IPEndPoint[] value) [static] :1613
...
// public static generated Outracks.Simulator.Runtime.IReflection get_Reflection() [static] :1617
...
// public static generated void set_Reflection(Outracks.Simulator.Runtime.IReflection value) [static] :1617
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(1514)
// -------------------------------------------------------------------------------------------------

// public static extern class DeviceInfo :1514
// {
uClassType* DeviceInfo_typeof()
{
    ...
    ::TYPES[60] = ::g::iOS::Foundation::NSUUID_typeof();
    ::TYPES[61] = ::g::iOS::UIKit::UIDevice_typeof();
    type->Reflection.SetFunctions(2,
...
// public static string get_Name() [static] :1518
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(1397)
// -------------------------------------------------------------------------------------------------

// internal sealed class DialogButton :1397
// {
...
// public DialogButton(string text, Outracks.Simulator.State destination) :1402
...
// public DialogButton New(string text, Outracks.Simulator.State destination) :1402
...
// public DialogButton(string text, Outracks.Simulator.State destination) [instance] :1402
...
// public DialogButton New(string text, Outracks.Simulator.State destination) [static] :1402
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Protocol.Uno/0.0.0/Common/$.uno(563)
// ---------------------------------------------------------------------------------------------------------

// public sealed class DummyApplication :563
// {
::g::Uno::Application_type* DummyApplication_typeof()
{
    ...
    type = (::g::Uno::Application_type*)uClassType::New("Outracks.Simulator.DummyApplication", options);
...
// public generated DummyApplication New() [static] :563
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(1926)
// -------------------------------------------------------------------------------------------------

// internal static class EnumerableHitTestExtension :1926
// {
uClassType* EnumerableHitTestExtension_typeof()
{
    ...
    ::TYPES[62] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[63] = ::g::Fuse::HitTestCallback_typeof();
    ::TYPES[64] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof());
    return type;
}

// public static Uno.Collections.IList<Fuse.Node> HitTest2(Fuse.Node node, float2 windowPoint) :1928
...
// public static Uno.Collections.IList<Fuse.Node> HitTest2(Fuse.Node node, float2 windowPoint) [static] :1928
uObject* EnumerableHitTestExtension::HitTest2(::g::Fuse::Node* node, ::g::Uno::Float2 windowPoint)
{
    ...
    ::g::Uno::Collections::List* nodes = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[62/*Uno.Collections.List<Fuse.Node>*/]);
    ::g::Fuse::HitTestContext* htc = ::g::Fuse::HitTestContext::New1(windowPoint, uDelegate::New(::TYPES[63/*Fuse.HitTestCallback*/], (void*)EnumerableHitTestExtension__CollectHitNodesClosure__HitTestCallback_fn, EnumerableHitTestExtension__CollectHitNodesClosure::New1(nodes)));
    uPtr(node)->HitTest(htc);
    return (uObject*)nodes;
}
// }

// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(506)
// ------------------------------------------------------------------------------------------------

// internal static class Exceptions :506
// {
uClassType* Exceptions_typeof()
{
    ...
    ::TYPES[41] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Exception_typeof());
    ::TYPES[65] = ::g::Outracks::Simulator::Protocol::MessageFromClient_typeof();
    ::TYPES[66] = ::g::Outracks::Simulator::DeviceInfo_typeof();
    ::TYPES[1] = ::g::Uno::Exception_typeof();
    ::TYPES[67] = ::g::Uno::AggregateException_typeof();
    ::TYPES[68] = ::g::Uno::Collections::ReadOnlyCollection_typeof()->MakeType(::g::Uno::Exception_typeof());
    ::TYPES[69] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Exception_typeof());
    return type;
}

// public static void Send(Outracks.Simulator.ISimulatorClient client, Uno.Collections.List<Uno.Exception> exceptions) :508
void Exceptions__Send_fn(uObject* client, ::g::Uno::Collections::List* exceptions)
{
    Exceptions::Send(client, exceptions);
}

// public static Uno.Collections.List<Uno.Exception> Unpack(Uno.Exception e) :517
void Exceptions__Unpack_fn(::g::Uno::Exception* e, ::g::Uno::Collections::List** __retval)
{
    *__retval = Exceptions::Unpack(e);
}

// public static void Send(Outracks.Simulator.ISimulatorClient client, Uno.Collections.List<Uno.Exception> exceptions) [static] :508
...
::g::Uno::Collections::List* Exceptions::Unpack(::g::Uno::Exception* e)
{
    ...
    ::g::Uno::Exception* ret2;
    ::g::Uno::Collections::List* exceptions = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[41/*Uno.Collections.List<Uno.Exception>*/]);

    if (uIs(e, ::TYPES[67/*Uno.AggregateException*/]))
    {
        ::g::Uno::AggregateException* aggregate = uCast< ::g::Uno::AggregateException*>(e, ::TYPES[67/*Uno.AggregateException*/]);
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(567)
// ------------------------------------------------------------------------------------------------

// internal sealed class FailedToConnect :567
// {
...
// public FailedToConnect New(Uno.Exception exception) [static] :569
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Protocol.Uno/0.0.0/$.uno(13)
// -------------------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Protocol.Uno/0.0.0/$.uno(20)
// -------------------------------------------------------------------------------------------------
...
::g::Uno::Exception_type* FailedToConnectToProxy_typeof()
{
    ...
    ::STRINGS[26] = uString::Const("Failed to connect to proxy:\n"
        "");
    ::TYPES[70] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, ::g::Uno::Exception_typeof());
    type->SetFields(3,
...
void FailedToConnectToProxy::ctor_3(uObject* innerExceptions)
{
    ...
    InnerExceptions = ((::g::Outracks::Simulator::ImmutableList*)::g::Outracks::Simulator::List::ToImmutableList(::TYPES[70/*Outracks.Simulator.List.ToImmutableList<Uno.Exception>*/], innerExceptions));
}
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(789)
// ------------------------------------------------------------------------------------------------

// public sealed class FailedToConnectToSimulator :789
// {
...
// public FailedToConnectToSimulator(Uno.Collections.IEnumerable<Uno.Exception> innerExceptions) :793
void FailedToConnectToSimulator__ctor_3_fn(FailedToConnectToSimulator* __this, uObject* innerExceptions)
{
    __this->ctor_3(innerExceptions);
}

// public FailedToConnectToSimulator New(Uno.Collections.IEnumerable<Uno.Exception> innerExceptions) :793
...
// public FailedToConnectToSimulator(Uno.Collections.IEnumerable<Uno.Exception> innerExceptions) [instance] :793
...
// public FailedToConnectToSimulator New(Uno.Collections.IEnumerable<Uno.Exception> innerExceptions) [static] :793
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(1671)
// -------------------------------------------------------------------------------------------------

// public sealed class FakeApp :1671
// {
::g::Fuse::Controls::ParentControl_type* FakeApp_typeof()
{
    ...
    ::TYPES[71] = ::g::Outracks::Simulator::ConcurrentQueue_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[72] = ::g::Fuse::Controls::ParentControl_typeof();
    ::TYPES[13] = ::g::Fuse::Node_typeof();
    ::TYPES[31] = ::g::Uno::Action_typeof();
    ::TYPES[8] = ::g::Uno::Bool_typeof();
    ::TYPES[6] = ::g::Fuse::AppBase_typeof();
    ::TYPES[73] = ::g::Uno::Application_typeof();
    ::TYPES[74] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Node_typeof());
    ::TYPES[75] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[20] = ::g::Uno::Int_typeof();
    ::TYPES[76] = ::g::Fuse::Elements::Element_typeof();
    type->SetInterfaces(
...
void FakeApp::ctor_5(::g::Fuse::App* app)
{
    ...
    _flashes = ((::g::Outracks::Simulator::ConcurrentQueue*)::g::Outracks::Simulator::ConcurrentQueue::New1(::TYPES[71/*Outracks.Simulator.ConcurrentQueue<string>*/]));
    ctor_4();
    _app = app;
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Children()), ::TYPES[124/*Uno.Collections.ICollection<Fuse.Node>*/]), _overlayPlaceholde);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Children()), ::TYPES[124/*Uno.Collections.ICollection<Fuse.Node>*/]), _rootPlaceholder);
    OverlayVisible(false);
}

// private void AddNewFlashes() [instance] :1744
...
// public new float4 get_Background() [instance] :1758
...
// public new void set_Background(float4 value) [instance] :1759
...
// public new Uno.Collections.IList<Fuse.Behavior> get_Behaviors() [instance] :1764
...
// public float4 get_ClearColor() [instance] :1808
...
// public void set_ClearColor(float4 value) [instance] :1809
...
// public float get_ClearDepth() [instance] :1814
...
// public void set_ClearDepth(float value) [instance] :1815
void FakeApp::ClearDepth(float value)
{
}

// public void Flash(string message) [instance] :1718
...
// private bool get_HasFlash() [instance] :1732
...
// private void OnUpdate() [instance] :1711
...
// public Fuse.Node get_Overlay() [instance] :1786
::g::Fuse::Node* FakeApp::Overlay()
{
    uStackFrame __("Outracks.Simulator.FakeApp", "get_Overlay()");
    ::g::Fuse::Node* ret3;
    return (::g::Uno::Collections::EnumerableExtensions__FirstOrDefault_fn(::TYPES[74/*Uno.Collections.EnumerableExtensions.FirstOrDefault<Fuse.Node>*/], uPtr(_overlayPlaceholde)->Children(), &ret3), ret3);
}

// public void set_Overlay(Fuse.Node value) [instance] :1787
void FakeApp::Overlay(::g::Fuse::Node* value)
{
    uStackFrame __("Outracks.Simulator.FakeApp", "set_Overlay(Fuse.Node)");
    ::g::Uno::Collections::ICollection::Clear(uInterface(uPtr(uPtr(_overlayPlaceholde)->Children()), ::TYPES[124/*Uno.Collections.ICollection<Fuse.Node>*/]));
    OverlayVisible(false);

    if (value != NULL)
    {
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(_overlayPlaceholde)->Children()), ::TYPES[124/*Uno.Collections.ICollection<Fuse.Node>*/]), value);
        OverlayVisible(true);
    }
}

// private bool get_OverlayVisible() [instance] :1683
...
// private void set_OverlayVisible(bool value) [instance] :1684
...
// private void RemoveExpiredFlashes() [instance] :1735
...
// public new Uno.Collections.IList<Uno.UX.Resource> get_Resources() [instance] :1771
...
// public Fuse.Node get_RootNode() [instance] :1776
::g::Fuse::Node* FakeApp::RootNode()
{
    uStackFrame __("Outracks.Simulator.FakeApp", "get_RootNode()");
    ::g::Fuse::Node* ret4;
    return (::g::Uno::Collections::EnumerableExtensions__FirstOrDefault_fn(::TYPES[74/*Uno.Collections.EnumerableExtensions.FirstOrDefault<Fuse.Node>*/], uPtr(_rootPlaceholder)->Children(), &ret4), ret4);
}

// public void set_RootNode(Fuse.Node value) [instance] :1777
void FakeApp::RootNode(::g::Fuse::Node* value)
{
    uStackFrame __("Outracks.Simulator.FakeApp", "set_RootNode(Fuse.Node)");
    ::g::Uno::Collections::ICollection::Clear(uInterface(uPtr(uPtr(_rootPlaceholder)->Children()), ::TYPES[124/*Uno.Collections.ICollection<Fuse.Node>*/]));

    if (value != NULL)
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(_rootPlaceholder)->Children()), ::TYPES[124/*Uno.Collections.ICollection<Fuse.Node>*/]), value);
}

// public Fuse.Theme get_Theme() [instance] :1802
...
// public void set_Theme(Fuse.Theme value) [instance] :1803
...
// private void UpdateFlashes() [instance] :1723
...
// public FakeApp New(Fuse.App app) [static] :1691
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(539)
// ------------------------------------------------------------------------------------------------

// internal sealed class Faulted :539
// {
...
// public Faulted(bool isOnline, Uno.Exception exception, Outracks.Simulator.DialogButton[] buttons) :541
...
// public Faulted New(bool isOnline, Uno.Exception exception, Outracks.Simulator.DialogButton[] buttons) :541
...
// public Faulted(bool isOnline, Uno.Exception exception, Outracks.Simulator.DialogButton[] buttons) [instance] :541
...
// public Faulted New(bool isOnline, Uno.Exception exception, Outracks.Simulator.DialogButton[] buttons) [static] :541
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(1851)
// -------------------------------------------------------------------------------------------------

// internal sealed class Flasher :1851
// {
::g::Fuse::Controls::ParentControl_type* Flasher_typeof()
{
    ...
    ::TYPES[77] = ::g::Fuse::Drawing::LinearGradient_typeof();
    ::TYPES[78] = ::g::Uno::Float4_typeof();
    ::TYPES[79] = ::g::Fuse::Controls::Control_typeof();
    ::TYPES[80] = ::g::Fuse::Drawing::Brush_typeof();
    ::TYPES[72] = ::g::Fuse::Controls::ParentControl_typeof();
    ::TYPES[13] = ::g::Fuse::Node_typeof();
    ::TYPES[81] = ::g::Fuse::BasicTheme::BasicStyle_typeof();
    ::TYPES[82] = ::g::Fuse::Controls::TextControl_typeof();
    ::TYPES[76] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[83] = ::g::Fuse::Time_typeof();
    ::TYPES[31] = ::g::Uno::Action_typeof();
    ::TYPES[84] = ::g::Uno::Float_typeof();
    type->SetInterfaces(
        ::g::Fuse::Scripting::INameScope_typeof(), offsetof(::g::Fuse::Controls::ParentControl_type, interface0),
        ::g::Fuse::IDataContext_typeof(), offsetof(::g::Fuse::Controls::ParentControl_type, interface1),
        ::g::Fuse::Triggers::Actions::IShow_typeof(), offsetof(::g::Fuse::Controls::ParentControl_type, interface2),
...
void Flasher__OnRooted_fn(Flasher* __this)
{
    ...
    ::g::Fuse::UpdateManager::AddAction(uDelegate::New(::TYPES[31/*Uno.Action*/], (void*)Flasher__OnUpdate_fn, __this), 0);
    uPtr(__this->Background())->Pin();
}

// protected override sealed void OnUnrooted() :1881
void Flasher__OnUnrooted_fn(Flasher* __this)
{
    uStackFrame __("Outracks.Simulator.Flasher", "OnUnrooted()");
    ::g::Fuse::UpdateManager::RemoveAction(uDelegate::New(::TYPES[31/*Uno.Action*/], (void*)Flasher__OnUpdate_fn, __this), 0);
    uPtr(__this->Background())->Unpin();
}

// private void OnUpdate() :1887
void Flasher__OnUpdate_fn(Flasher* __this)
{
    __this->OnUpdate();
}

// public Flasher(string text) [instance] :1855
void Flasher::ctor_5(uString* text)
{
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(linearGradient->Stops()), ::TYPES[155/*Uno.Collections.ICollection`1*/]->MakeType(::g::Fuse::Drawing::GradientStop_typeof())), ::g::Fuse::Drawing::GradientStop::New2(::g::Uno::Float4__New8((ind2 = ::g::Uno::Color::FromHex(::STRINGS[30/*"#222"*/]), ::g::Uno::Float3__New2(ind2.X, ind2.Y, ind2.Z)), 0.9f), 0.0f));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(linearGradient->Stops()), ::TYPES[155/*Uno.Collections.ICollection`1*/]->MakeType(::g::Fuse::Drawing::GradientStop_typeof())), ::g::Fuse::Drawing::GradientStop::New2(::g::Uno::Float4__New8((ind3 = ::g::Uno::Color::FromHex(::STRINGS[30/*"#222"*/]), ::g::Uno::Float3__New2(ind3.X, ind3.Y, ind3.Z)), 0.9f), 1.0f));
    Background(linearGradient);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Children()), ::TYPES[124/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection1 = ::g::Fuse::Controls::Text::New2(), ind4 = ::g::Fuse::BasicTheme::BasicStyle::RobotoRegular(), uPtr(collection1)->Font(ind4), ind4, uPtr(collection1)->FontSize(25.0f), 25.0f, uPtr(collection1)->Value(text), text, ind5 = ::g::Uno::Float4__New2(1.0f, 1.0f, 1.0f, 1.0f), uPtr(collection1)->TextColor(ind5), ind5, uPtr(collection1)->Alignment(10), 10, collection1));
}

// private double get_AnimationParameter() [instance] :1899
...
// public bool IsExpired() [instance] :1892
...
// private void OnUpdate() [instance] :1887
...
// public Flasher New(string text) [static] :1855
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Protocol.Uno/0.0.0/Common/$.uno(39)
// --------------------------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Protocol.Uno/0.0.0/Common/$.uno(69)
// --------------------------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Protocol.Uno/0.0.0/Common/$.uno(54)
// --------------------------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Protocol.Uno/0.0.0/$.uno(62)
// -------------------------------------------------------------------------------------------------
...
uType* GetSimulatorEndpoint_typeof()
{
    ...
    ::TYPES[58] = ::g::Uno::Net::EndPoint_typeof();
    ::TYPES[85] = ::g::Uno::IO::Stream_typeof();
    ::TYPES[29] = ::g::Uno::Net::IPEndPoint_typeof()->Array();
    ::TYPES[22] = ::g::Uno::IDisposable_typeof();
    type->SetFields(0,
...

        {
...

            {
...

                {
                    ...
                    uArray* endpoints = uArray::New(::TYPES[29/*Uno.Net.IPEndPoint[]*/], ::g::Uno::Int::Parse(endpointCount));
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(607)
// ------------------------------------------------------------------------------------------------

// internal static class GoOffline :607
// {
uClassType* GoOffline_typeof()
{
    ...
    ::TYPES[24] = ::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(::g::Outracks::Simulator::Protocol::Reify_typeof());
    ::TYPES[86] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Outracks::Simulator::DialogButton_typeof());
    ...
    ::TYPES[2] = ::g::Outracks::Simulator::State_typeof();
    ::TYPES[44] = ::g::Outracks::Simulator::ISimulatorClient_typeof();
    ::TYPES[89] = ::g::Outracks::Simulator::Protocol::MessageToClient_typeof()->Array();
    ::TYPES[90] = ::g::Outracks::Simulator::Protocol::MessageToClient_typeof();
    ::TYPES[91] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Outracks::Simulator::DialogButton_typeof());
    ::TYPES[92] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Outracks::Simulator::DialogButton_typeof());
    return type;
}

// public static Outracks.Simulator.DialogButton[] PrependOption(Outracks.Simulator.DialogButton[] otherButtons) :609
void GoOffline__PrependOption_fn(uArray* otherButtons, uArray** __retval)
{
    *__retval = GoOffline::PrependOption(otherButtons);
}

// public static Outracks.Simulator.DialogButton[] PrependOption(Outracks.Simulator.DialogButton[] otherButtons) [static] :609
uArray* GoOffline::PrependOption(uArray* otherButtons)
{
    ...
    return oldReify.HasValue(::TYPES[24/*Outracks.Simulator.Bytecode.Optional<Outracks.Simulator.Protocol.Reify>*/]) ? (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[86/*Uno.Collections.EnumerableExtensions.ToArray<Outracks.Simulator.DialogButton>*/], (uObject*)::g::Uno::Collections::EnumerableExtensions::Union(::TYPES[87/*Uno.Collections.EnumerableExtensions.Union<Outracks.Simulator.DialogButton>*/], (uObject*)::g::Uno::Collections::EnumerableExtensions::AsEnumerable(::TYPES[88/*Uno.Collections.EnumerableExtensions.AsEnumerable<Outracks.Simulator.DialogButton>*/], uArray::Init< ::g::Outracks::Simulator::DialogButton*>(::TYPES[57/*Outracks.Simulator.DialogButton[]*/], 1, (::g::Outracks::Simulator::DialogButton*)::g::Outracks::Simulator::DialogButton::New1(::STRINGS[32/*"Go offline"*/], ::g::Outracks::Simulator::Idle::New1((uObject*)::g::Outracks::Simulator::OfflineSimulatorClient::New1(uArray::Init< ::g::Outracks::Simulator::Protocol::MessageToClient*>(::TYPES[89/*Outracks.Simulator.Protocol.MessageToClient[]*/], 1, (::g::Outracks::Simulator::Protocol::Reify*)oldReify.Value(::TYPES[24/*Outracks.Simulator.Bytecode.Optional<Outracks.Simulator.Protocol.Reify>*/]))))))), (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[92/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Outracks.Simulator.DialogButton>*/], otherButtons)))) : otherButtons;
}
// }

// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(328)
// ------------------------------------------------------------------------------------------------

// internal sealed class Idle :328
// {
::g::Outracks::Simulator::Connected_type* Idle_typeof()
{
    ...
    ::STRINGS[24] = uString::Const("Try again");
    ::TYPES[93] = ::g::Uno::Diagnostics::LogHandler_typeof();
    ::TYPES[94] = ::g::Outracks::Simulator::Connected_typeof();
    ::TYPES[65] = ::g::Outracks::Simulator::Protocol::MessageFromClient_typeof();
    ::TYPES[66] = ::g::Outracks::Simulator::DeviceInfo_typeof();
    ::TYPES[15] = ::g::Outracks::Simulator::Context_typeof();
    ::TYPES[2] = ::g::Outracks::Simulator::State_typeof();
...
// public Idle(Outracks.Simulator.ISimulatorClient client) :330
void Idle__ctor_2_fn(Idle* __this, uObject* client)
{
    __this->ctor_2(client);
}

// public Idle New(Outracks.Simulator.ISimulatorClient client) :330
void Idle__New1_fn(uObject* client, Idle** __retval)
{
    *__retval = Idle::New1(client);
}

// public override sealed Outracks.Simulator.State OnEnterState() :334
void Idle__OnEnterState_fn(Idle* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    ::g::Uno::Diagnostics::Debug::SetLogHandler(uDelegate::New(::TYPES[93/*Uno.Diagnostics.LogHandler*/], (void*)Idle__SendDebugLog_fn, __this));
    ::g::Outracks::Simulator::ISimulatorClient::Send(uInterface(uPtr(__this->Client), ::TYPES[44/*Outracks.Simulator.ISimulatorClient*/]), ::g::Outracks::Simulator::Protocol::RegisterName::New1(::g::Outracks::Simulator::DeviceInfo::GUID(), ::g::Outracks::Simulator::DeviceInfo::Name()));
    ::g::Outracks::Simulator::LoadingScreen::Show(::g::Outracks::Simulator::Context::App(), ::STRINGS[33/*"Loading"*/], ::STRINGS[34/*"Host is loa...*/]);
    return *__retval = __this, void();
}

// protected override sealed Outracks.Simulator.State OnFaulted(Uno.Exception e) :347
...
// private void SendDebugLog(string text, Uno.Diagnostics.DebugMessageType type) [instance] :342
void Idle::SendDebugLog(uString* text, int type)
{
    ...
    ::g::Outracks::Simulator::ISimulatorClient::Send(uInterface(uPtr(Client), ::TYPES[44/*Outracks.Simulator.ISimulatorClient*/]), ::g::Outracks::Simulator::Protocol::DebugLog::New1(::g::Outracks::Simulator::DeviceInfo::GUID(), ::g::Outracks::Simulator::DeviceInfo::Name(), text));
}

// public Idle New(Outracks.Simulator.ISimulatorClient client) [static] :330
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Protocol.Uno/0.0.0/Common/$.uno(548)
// ---------------------------------------------------------------------------------------------------------

// internal abstract interface IEquatable<T> :548
// {
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Protocol.Uno/0.0.0/Common/$.uno(142)
// ---------------------------------------------------------------------------------------------------------

// public sealed class ImmutableList<T> :142
// {
ImmutableList_type* ImmutableList_typeof()
{
    ...
    type->SetPrecalc(
        type->T(0)->Array(),
        ::TYPES[95/*Uno.Array*/]->MakeMethod(1, type->T(0)),
        ::TYPES[96/*Uno.Collections.IEnumerable`1*/]->MakeType(type->T(0)),
        ::TYPES[97/*Uno.Runtime.Implementation.Internal.ArrayEnumerable`1*/]->MakeType(type->T(0)),
        ::TYPES[98/*Uno.Collections.EnumerableExtensions*/]->MakeMethod(1, type->T(0)));
    type->SetInterfaces(
...
// internal ImmutableList(T[] array) :151
void ImmutableList__ctor__fn(ImmutableList* __this, uArray* array)
{
    __this->ctor_(array);
}

// public Outracks.Simulator.ImmutableList<T> Add(T element) :166
...
// public Uno.Collections.IEnumerator<T> GetEnumerator() :161
void ImmutableList__GetEnumerator_fn(ImmutableList* __this, uObject** __retval)
{
    *__retval = __this->GetEnumerator();
}

// public Outracks.Simulator.ImmutableList<T> InsertRange(int index, Uno.Collections.IEnumerable<T> items) :174
...
// internal ImmutableList(T[] array) [instance] :151
...
// public int get_Count() [instance] :158
...
// public Uno.Collections.IEnumerator<T> GetEnumerator() [instance] :161
...
// public Outracks.Simulator.ImmutableList<T> InsertRange(int index, Uno.Collections.IEnumerable<T> items) [instance] :174
...
// internal ImmutableList New(T[] array) [static] :151
...
// public static Outracks.Simulator.ImmutableList<T> get_Empty() [static] :146
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Protocol.Uno/0.0.0/Common/$.uno(435)
// ---------------------------------------------------------------------------------------------------------

// public static class IndentString :435
// {
...
// public static string Indent(string str) :437
void IndentString__Indent_fn(uString* str, uString** __retval)
{
    *__retval = IndentString::Indent(str);
}

// private static string PrefixWithTab(string s) :442
void IndentString__PrefixWithTab_fn(uString* s, uString** __retval)
{
    *__retval = IndentString::PrefixWithTab(s);
}

// public static string Indent(string str) [static] :437
uString* IndentString::Indent(uString* str)
{
    uStackFrame __("Outracks.Simulator.IndentString", "Indent(string)");
    return ::g::Outracks::Simulator::StringSplitting::Join((uObject*)::g::Uno::Collections::EnumerableExtensions::Select(::TYPES[99/*Uno.Collections.EnumerableExtensions.Select<string, string>*/], (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[54/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<string>*/], ::g::Uno::String::Split(uPtr(str), uArray::Init<int>(::TYPES[100/*char[]*/], 1, 10)))), uDelegate::New(::TYPES[101/*Uno.Func<string, string>*/], (void*)IndentString__PrefixWithTab_fn)), ::STRINGS[2/*"\n"*/]);
}

// private static string PrefixWithTab(string s) [static] :442
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(1603)
// -------------------------------------------------------------------------------------------------

// public enum InputMode :1603
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Protocol.Uno/0.0.0/$.uno(143)
// --------------------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(745)
// ------------------------------------------------------------------------------------------------

// public abstract interface ISimulatorClient :745
// {
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Protocol.Uno/0.0.0/Common/$.uno(207)
// ---------------------------------------------------------------------------------------------------------

// public static class List :207
// {
uClassType* List_typeof()
{
    ...
    ::TYPES[43] = uObject_typeof()->Array();
    ::TYPES[36] = ::g::Uno::Func1_typeof();
    ::TYPES[103] = ::g::Uno::IO::BinaryReader_typeof();
    ::TYPES[98] = ::g::Uno::Collections::EnumerableExtensions_typeof();
    ::TYPES[104] = ::g::Uno::Collections::IEnumerator1_typeof();
    ::TYPES[17] = ::g::Uno::Action2_typeof();
    ::TYPES[105] = ::g::Uno::IO::BinaryWriter_typeof();
...
// public static Outracks.Simulator.ImmutableList<T> Create<T>(T[] elements) :209
...
// public static Outracks.Simulator.ImmutableList<T> Read<T>(Uno.IO.BinaryReader reader, Uno.Func<Uno.IO.BinaryReader, T> elementReader) :231
...
// public static Outracks.Simulator.ImmutableList<T> ReadImmutableList<T>(Uno.IO.BinaryReader reader, Uno.Func<Uno.IO.BinaryReader, T> elementReader) :236
...
// public static Outracks.Simulator.ImmutableList<T> ToImmutableList<T>(Uno.Collections.IEnumerable<T> self) :214
...
// public static void Write<T>(Outracks.Simulator.ImmutableList<T> array, Uno.IO.BinaryWriter writer, Uno.Action<T, Uno.IO.BinaryWriter> elementWriter) :219
...
// public static void Write<T>(Uno.IO.BinaryWriter writer, Outracks.Simulator.ImmutableList<T> array, Uno.Action<T, Uno.IO.BinaryWriter> elementWriter) :224
...
// public static Outracks.Simulator.ImmutableList<T> Create<T>(T[] elements) [static] :209
...
// public static Outracks.Simulator.ImmutableList<T> Read<T>(Uno.IO.BinaryReader reader, Uno.Func<Uno.IO.BinaryReader, T> elementReader) [static] :231
...
// public static Outracks.Simulator.ImmutableList<T> ReadImmutableList<T>(Uno.IO.BinaryReader reader, Uno.Func<Uno.IO.BinaryReader, T> elementReader) [static] :236
::g::Outracks::Simulator::ImmutableList* List::ReadImmutableList(uType* __type, ::g::Uno::IO::BinaryReader* reader, uDelegate* elementReader)
{
    uType* __types[] = {
        __type->U(0),
        __type->U(0)->Array(),
        ::TYPES[36/*Uno.Func`2*/]->MakeType(::TYPES[103/*Uno.IO.BinaryReader*/], __type->U(0)),
        ::TYPES[102/*Outracks.Simulator.ImmutableList`1*/]->MakeType(__type->U(0)),
    };
...
// public static Outracks.Simulator.ImmutableList<T> ToImmutableList<T>(Uno.Collections.IEnumerable<T> self) [static] :214
...
// public static void Write<T>(Outracks.Simulator.ImmutableList<T> array, Uno.IO.BinaryWriter writer, Uno.Action<T, Uno.IO.BinaryWriter> elementWriter) [static] :219
...
// public static void Write<T>(Uno.IO.BinaryWriter writer, Outracks.Simulator.ImmutableList<T> array, Uno.Action<T, Uno.IO.BinaryWriter> elementWriter) [static] :224
void List::Write1(uType* __type, ::g::Uno::IO::BinaryWriter* writer, ::g::Outracks::Simulator::ImmutableList* array, uDelegate* elementWriter)
{
    uType* __types[] = {
        __type->U(0),
        ::TYPES[102/*Outracks.Simulator.ImmutableList`1*/]->MakeType(__type->U(0)),
        ::TYPES[104/*Uno.Collections.IEnumerator`1*/]->MakeType(__type->U(0)),
        ::TYPES[17/*Uno.Action`2*/]->MakeType(__type->U(0), ::TYPES[105/*Uno.IO.BinaryWriter*/]),
    };
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(1123)
// -------------------------------------------------------------------------------------------------

// internal sealed class LoadingScreen :1123
// {
...
// public generated LoadingScreen() :1123
void LoadingScreen__ctor__fn(LoadingScreen* __this)
{
    __this->ctor_();
}

// public generated LoadingScreen New() :1123
void LoadingScreen__New1_fn(LoadingScreen** __retval)
{
    *__retval = LoadingScreen::New1();
}

// public static void Show(Outracks.Simulator.FakeApp app, string header, string message) :1125
...
// public generated LoadingScreen() [instance] :1123
void LoadingScreen::ctor_()
{
}

// public generated LoadingScreen New() [static] :1123
...
// public static void Show(Outracks.Simulator.FakeApp app, string header, string message) [static] :1125
void LoadingScreen::Show(::g::Outracks::Simulator::FakeApp* app, uString* header, uString* message)
{
    ...
    app->RootNode((collection1 = ::g::Fuse::Controls::StackPanel::New3(), uPtr(collection1)->Alignment(10), 10, ind5 = ::g::Uno::Float4__New1(40.0f), uPtr(collection1)->Padding(ind5), ind5, array2 = uPtr(collection1)->Children(), ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array2), ::TYPES[124/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection3 = ::g::Fuse::Controls::Text::New2(), ind6 = ::g::Uno::Float4__New2(0.0f, 0.0f, 0.0f, 20.0f), uPtr(collection3)->Margin(ind6), ind6, uPtr(collection3)->Value(header), header, uPtr(collection3)->FontSize(40.0f), 40.0f, uPtr(collection3)->TextAlignment(1), 1, uPtr(collection3)->TextWrapping(1), 1, collection3)), ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array2), ::TYPES[124/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection4 = ::g::Fuse::Controls::Text::New2(), ind7 = ::g::Uno::Float4__New2(0.0f, 0.0f, 0.0f, 20.0f), uPtr(collection4)->Margin(ind7), ind7, uPtr(collection4)->Value(message), message, uPtr(collection4)->TextWrapping(1), 1, collection4)), collection1));
}
// }

// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(1155)
// -------------------------------------------------------------------------------------------------

// internal sealed class ModalDialog :1155
// {
uType* ModalDialog_typeof()
{
    ...
    ::TYPES[72] = ::g::Fuse::Controls::ParentControl_typeof();
    ::TYPES[13] = ::g::Fuse::Node_typeof();
    ::TYPES[107] = ::g::Uno::UX::FileSource_typeof();
    ::TYPES[108] = ::g::OutracksSimulatorClientUno_bundle_typeof();
    ::TYPES[109] = ::g::Fuse::Controls::Image_typeof();
    ::TYPES[82] = ::g::Fuse::Controls::TextControl_typeof();
    ::TYPES[8] = ::g::Uno::Bool_typeof();
    ::TYPES[110] = ::g::Fuse::Controls::ScrollView_typeof();
    ::TYPES[111] = ::g::Fuse::Controls::StackPanel_typeof();
    ::TYPES[112] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Controls::Control_typeof());
    ::TYPES[14] = ::g::Outracks::Simulator::UserAppState_typeof();
    ::TYPES[15] = ::g::Outracks::Simulator::Context_typeof();
    ::TYPES[12] = ::g::Outracks::Simulator::FakeApp_typeof();
    ::TYPES[106] = ::g::Fuse::Theme_typeof();
...
// public generated ModalDialog() :1155
void ModalDialog__ctor__fn(ModalDialog* __this)
{
    __this->ctor_();
}

// public generated ModalDialog New() :1155
void ModalDialog__New1_fn(ModalDialog** __retval)
{
    *__retval = ModalDialog::New1();
}

// public static void Show(Outracks.Simulator.FakeApp app, string header, string body, string details, Uno.Collections.IEnumerable<Fuse.Controls.Control> buttons) :1200
...
// public static void ShowPrompt(Outracks.Simulator.FakeApp app, string header, string body, Fuse.Controls.Control inputControl, Uno.Collections.IEnumerable<Fuse.Controls.Control> buttons) :1157
...
// public generated ModalDialog() [instance] :1155
void ModalDialog::ctor_()
{
}

// public generated ModalDialog New() [static] :1155
...
// public static void Show(Outracks.Simulator.FakeApp app, string header, string body, string details, Uno.Collections.IEnumerable<Fuse.Controls.Control> buttons) [static] :1200
void ModalDialog::Show(::g::Outracks::Simulator::FakeApp* app, uString* header, uString* body, uString* details, uObject* buttons)
{
    ...
    collection7 = ::g::Fuse::Controls::StackPanel::New3();
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array8), ::TYPES[124/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection9 = ::g::Fuse::Controls::Image::New2(), ind21 = ::g::Uno::Float4__New2(0.0f, 0.0f, 0.0f, 30.0f), uPtr(collection9)->Margin(ind21), ind21, ind22 = ::g::Uno::UX::BundleFileSource::New1(::g::OutracksSimulatorClientUno_bundle::fightb073b460()), uPtr(collection9)->File(ind22), ind22, collection9));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array8), ::TYPES[124/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection10 = ::g::Fuse::Controls::Text::New2(), ind23 = ::g::Uno::Float4__New2(0.0f, 0.0f, 0.0f, 20.0f), uPtr(collection10)->Margin(ind23), ind23, uPtr(collection10)->Value(header), header, uPtr(collection10)->FontSize(25.0f), 25.0f, uPtr(collection10)->TextAlignment(1), 1, uPtr(collection10)->TextWrapping(1), 1, collection10));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array8), ::TYPES[124/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection11 = ::g::Fuse::Controls::Text::New2(), ind24 = ::g::Uno::Float4__New2(0.0f, 0.0f, 0.0f, 20.0f), uPtr(collection11)->Margin(ind24), ind24, uPtr(collection11)->Value(body), body, uPtr(collection11)->FontSize(15.0f), 15.0f, uPtr(collection11)->TextWrapping(1), 1, collection11));
    ...
    if (!::g::Uno::String::IsNullOrWhiteSpace(details))
    {
        ...
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(root)->Children()), ::TYPES[124/*Uno.Collections.ICollection<Fuse.Node>*/]), detailsScroller);
    }

    collection14 = ::g::Fuse::Controls::StackPanel::New3();
    ...
    for (uObject* enum15 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(buttons), ::TYPES[134/*Uno.Collections.IEnumerable<Fuse.Controls.Control>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum15), ::g::Uno::Collections::IEnumerator_typeof())); )
    {
        ::g::Fuse::Controls::Control* btn = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum15), ::TYPES[112/*Uno.Collections.IEnumerator<Fuse.Controls.Control>*/]), &ret29), ret29);
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(buttonPanel)->Children()), ::TYPES[124/*Uno.Collections.ICollection<Fuse.Node>*/]), btn);
    }

    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(root)->Children()), ::TYPES[124/*Uno.Collections.ICollection<Fuse.Node>*/]), buttonPanel);
    uPtr(::g::Outracks::Simulator::UserAppState::Default())->ApplyTo(::g::Outracks::Simulator::Context::App());
    uPtr(app)->Theme(::g::Fuse::BasicTheme::BasicTheme::New3());
    app->RootNode(root);
}

// public static void ShowPrompt(Outracks.Simulator.FakeApp app, string header, string body, Fuse.Controls.Control inputControl, Uno.Collections.IEnumerable<Fuse.Controls.Control> buttons) [static] :1157
void ModalDialog::ShowPrompt(::g::Outracks::Simulator::FakeApp* app, uString* header, uString* body, ::g::Fuse::Controls::Control* inputControl, uObject* buttons)
{
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array2), ::TYPES[124/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection3 = ::g::Fuse::Controls::Text::New2(), ind17 = ::g::Uno::Float4__New2(0.0f, 0.0f, 0.0f, 20.0f), uPtr(collection3)->Margin(ind17), ind17, uPtr(collection3)->Value(header), header, uPtr(collection3)->FontSize(40.0f), 40.0f, uPtr(collection3)->TextAlignment(1), 1, uPtr(collection3)->TextWrapping(1), 1, collection3));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array2), ::TYPES[124/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection4 = ::g::Fuse::Controls::Text::New2(), ind18 = ::g::Uno::Float4__New2(0.0f, 0.0f, 0.0f, 20.0f), uPtr(collection4)->Margin(ind18), ind18, uPtr(collection4)->Value(body), body, uPtr(collection4)->TextWrapping(1), 1, collection4));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array2), ::TYPES[124/*Uno.Collections.ICollection<Fuse.Node>*/]), inputControl);
    ...
    for (uObject* enum6 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(buttons), ::TYPES[134/*Uno.Collections.IEnumerable<Fuse.Controls.Control>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum6), ::g::Uno::Collections::IEnumerator_typeof())); )
    {
        ::g::Fuse::Controls::Control* btn = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum6), ::TYPES[112/*Uno.Collections.IEnumerator<Fuse.Controls.Control>*/]), &ret30), ret30);
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(buttonPanel)->Children()), ::TYPES[124/*Uno.Collections.ICollection<Fuse.Node>*/]), btn);
    }
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Protocol.Uno/0.0.0/$.uno(148)
// --------------------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(754)
// ------------------------------------------------------------------------------------------------

// public sealed class OfflineSimulatorClient :754
// {
OfflineSimulatorClient_type* OfflineSimulatorClient_typeof()
{
    ...
    ::TYPES[113] = ::g::Outracks::Simulator::ConcurrentQueue_typeof()->MakeType(::g::Outracks::Simulator::Protocol::MessageFromClient_typeof());
    ::TYPES[114] = ::g::Outracks::Simulator::ConcurrentQueue_typeof()->MakeType(::g::Outracks::Simulator::Protocol::MessageToClient_typeof());
    ::TYPES[89] = ::g::Outracks::Simulator::Protocol::MessageToClient_typeof()->Array();
    type->SetInterfaces(
...
// public OfflineSimulatorClient(Outracks.Simulator.Protocol.MessageToClient[] initialMessages) :759
void OfflineSimulatorClient__ctor__fn(OfflineSimulatorClient* __this, uArray* initialMessages)
{
    __this->ctor_(initialMessages);
}

// public void Dispose() :775
void OfflineSimulatorClient__Dispose_fn(OfflineSimulatorClient* __this)
{
    __this->Dispose();
}

// public Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageToClient> get_IncommingMessages() :767
...
// public bool get_IsOnline() :782
void OfflineSimulatorClient__get_IsOnline_fn(OfflineSimulatorClient* __this, bool* __retval)
{
    *__retval = __this->IsOnline();
}

// public OfflineSimulatorClient New(Outracks.Simulator.Protocol.MessageToClient[] initialMessages) :759
...
// public void Send(Outracks.Simulator.Protocol.MessageFromClient message) :770
...
// public OfflineSimulatorClient(Outracks.Simulator.Protocol.MessageToClient[] initialMessages) [instance] :759
void OfflineSimulatorClient::ctor_(uArray* initialMessages)
{
    ...
    int index2;
    int length3;
    _messagesFromClient = ((::g::Outracks::Simulator::ConcurrentQueue*)::g::Outracks::Simulator::ConcurrentQueue::New1(::TYPES[113/*Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageFromClient>*/]));
    _messagesToClient = ((::g::Outracks::Simulator::ConcurrentQueue*)::g::Outracks::Simulator::ConcurrentQueue::New1(::TYPES[114/*Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageToClient>*/]));
...
// public void Dispose() [instance] :775
void OfflineSimulatorClient::Dispose()
{
}

// public Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageToClient> get_IncommingMessages() [instance] :767
...
// public bool get_IsOnline() [instance] :782
...
// public void Send(Outracks.Simulator.Protocol.MessageFromClient message) [instance] :770
...
// public OfflineSimulatorClient New(Outracks.Simulator.Protocol.MessageToClient[] initialMessages) [static] :759
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Protocol.Uno/0.0.0/$.uno(42)
// -------------------------------------------------------------------------------------------------
...
uType* ProxyClient_typeof()
{
    ...
    ::TYPES[115] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Outracks::Simulator::Task_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof()->Array()));
    ::TYPES[116] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof());
    ::TYPES[117] = ::g::Outracks::Simulator::Tasks_typeof()->MakeMethod(1, ::g::Uno::Net::IPEndPoint_typeof()->Array());
    ::TYPES[118] = ::g::Uno::Func_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof()->Array());
    ::TYPES[119] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Uno::String_typeof());
    ::TYPES[120] = ::g::Outracks::Simulator::Tasks_typeof()->MakeMethod(1, ::g::Uno::Net::IPEndPoint_typeof()->Array());
    ::TYPES[121] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Outracks::Simulator::Task_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof()->Array()));
    ::TYPES[122] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Exception_typeof()), ::g::Uno::Net::IPEndPoint_typeof()->Array());
    type->Reflection.SetFunctions(2,
...
::g::Outracks::Simulator::Task* ProxyClient::GetSimulatorEndpoint(uObject* proxyEndpoints, uString* project, uObject* defines)
{
    ...
    ::g::Uno::Collections::List* tasks = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[115/*Uno.Collections.List<Outracks.Simulator.Task<Uno.Net.IPEndPoint[]>>*/]);

    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(proxyEndpoints), ::TYPES[50/*Uno.Collections.IEnumerable<Uno.Net.IPEndPoint>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::g::Uno::Collections::IEnumerator_typeof())); )
    {
        ::g::Uno::Net::IPEndPoint* endpoint = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[116/*Uno.Collections.IEnumerator<Uno.Net.IPEndPoint>*/]), &ret3), ret3);
        ::g::Uno::Collections::List__Add_fn(uPtr(tasks), (::g::Outracks::Simulator::Task*)::g::Outracks::Simulator::Tasks::Run(::TYPES[117/*Outracks.Simulator.Tasks.Run<Uno.Net.IPEndPoint[]>*/], uDelegate::New(::TYPES[118/*Uno.Func<Uno.Net.IPEndPoint[]>*/], (void*)::g::Outracks::Simulator::GetSimulatorEndpoint__Execute_fn, ::g::Outracks::Simulator::GetSimulatorEndpoint::New1(endpoint, project, (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[119/*Uno.Collections.EnumerableExtensions.ToArray<string>*/], defines)))));
    }

    return (::g::Outracks::Simulator::Task*)::g::Outracks::Simulator::Tasks::WaitForFirstResult(::TYPES[120/*Outracks.Simulator.Tasks.WaitForFirstResult<Uno.Net.IPEndPoint[]>*/], (uObject*)tasks, uDelegate::New(::TYPES[122/*Uno.Func<Uno.Collections.IEnumerable<Uno.Exception>, Uno.Net.IPEndPoint[]>*/], (void*)ProxyClient__OnNoResult_fn));
}
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(391)
// ------------------------------------------------------------------------------------------------

// internal sealed class Reifying :391
// {
...
// public Reifying(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.Protocol.Reify reify) :395
...
// public Reifying New(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.Protocol.Reify reify) :395
...
// public override sealed Outracks.Simulator.State OnEnterState() :401
void Reifying__OnEnterState_fn(Reifying* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    uPtr(::g::Outracks::Simulator::UserAppState::Default())->ApplyTo(::g::Outracks::Simulator::Context::App());
    ::g::Outracks::Simulator::Runtime::VirtualMachine::Execute(uPtr(__this->_reify)->AppMutator, uArray::Init<uObject*>(::TYPES[43/*object[]*/], 1, (::g::Outracks::Simulator::FakeApp*)::g::Outracks::Simulator::Context::App()));
...
// protected override sealed Outracks.Simulator.State OnFaulted(Uno.Exception e) :413
...
// public Reifying(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.Protocol.Reify reify) [instance] :395
...
// public Reifying New(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.Protocol.Reify reify) [static] :395
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(419)
// ------------------------------------------------------------------------------------------------

// internal sealed class Running :419
// {
::g::Outracks::Simulator::Connected_type* Running_typeof()
{
    ...
    ::STRINGS[0] = uString::Const("");
    ::STRINGS[36] = uString::Const("Ignore");
    ::STRINGS[37] = uString::Const("Restart");
    ::STRINGS[19] = uString::Const("N/A");
    ::STRINGS[38] = uString::Const("Density changed, reifying");
    ::STRINGS[4] = uString::Const("/usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno");
    ::TYPES[25] = uObject_typeof();
    ::TYPES[13] = ::g::Fuse::Node_typeof();
    ::TYPES[15] = ::g::Outracks::Simulator::Context_typeof();
    ...
    ::TYPES[20] = ::g::Uno::Int_typeof();
    ::TYPES[14] = ::g::Outracks::Simulator::UserAppState_typeof();
    ::TYPES[123] = ::g::Fuse::Input::PointerEventArgs_typeof();
    ::TYPES[124] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[64] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[65] = ::g::Outracks::Simulator::Protocol::MessageFromClient_typeof();
    ::TYPES[59] = ::g::Fuse::Preview::ISelection_typeof();
    ::TYPES[9] = ::g::Fuse::NodeEventArgs_typeof();
...
// public Running(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.UserAppState userApp, Outracks.Simulator.Protocol.Reify runningReify) :426
...
// private static string GetTag(Fuse.Node node) :494
void Running__GetTag_fn(::g::Fuse::Node* node, uString** __retval)
{
    *__retval = Running::GetTag(node);
}

// public Running New(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.UserAppState userApp, Outracks.Simulator.Protocol.Reify runningReify) :426
...
// public override sealed Outracks.Simulator.State OnEnterState() :436
...
// protected override sealed Outracks.Simulator.State OnFaulted(Uno.Exception e) :460
void Running__OnFaulted_fn(Running* __this, ::g::Uno::Exception* e, ::g::Outracks::Simulator::State** __retval)
{
    ...
    return *__retval = ::g::Outracks::Simulator::Faulted::New2(::g::Outracks::Simulator::ISimulatorClient::IsOnline(uInterface(uPtr(__this->Client), ::TYPES[44/*Outracks.Simulator.ISimulatorClient*/])), e, uArray::Init< ::g::Outracks::Simulator::DialogButton*>(::TYPES[57/*Outracks.Simulator.DialogButton[]*/], 2, (::g::Outracks::Simulator::DialogButton*)::g::Outracks::Simulator::DialogButton::New1(::STRINGS[36/*"Ignore"*/], __this), (::g::Outracks::Simulator::DialogButton*)::g::Outracks::Simulator::DialogButton::New1(::STRINGS[37/*"Restart"*/], ::g::Outracks::Simulator::ConnectingToProxy::New1()))), void();
}

// public override sealed void OnLeaveState() :443
...
// public override sealed Outracks.Simulator.State OnPointerPressed(Fuse.Input.PointerPressedArgs args) :473
void Running__OnPointerPressed_fn(Running* __this, ::g::Fuse::Input::PointerPressedArgs* args, ::g::Outracks::Simulator::State** __retval)
{
    ...
    uString* selectedTag = (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(nodes), ::TYPES[124/*Uno.Collections.ICollection<Fuse.Node>*/])) >= 1) ? (uString*)Running::GetTag((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(nodes), ::TYPES[64/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(0), &ret2), ret2)) : ::STRINGS[19/*"N/A"*/];
    ::g::Outracks::Simulator::ISimulatorClient::Send(uInterface(uPtr(__this->Client), ::TYPES[44/*Outracks.Simulator.ISimulatorClient*/]), ::g::Outracks::Simulator::Protocol::SetSelection::New1(selectedTag));
    ::g::Fuse::Preview::SelectionManager::SetSelection((uObject*)::g::Outracks::Simulator::Runtime::Selection::New1(selectedTag, NULL));
    args->IsHandled(true);
    return *__retval = __this, void();
}

// public override sealed Outracks.Simulator.State OnUpdate() :448
void Running__OnUpdate_fn(Running* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[38/*"Density cha...*/], 1, ::STRINGS[4/*"/usr/local/...*/], 453);
...
// private static float QueryDensity() :467
void Running__QueryDensity_fn(float* __retval)
{
    *__retval = Running::QueryDensity();
}

// public Running(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.UserAppState userApp, Outracks.Simulator.Protocol.Reify runningReify) [instance] :426
...
// private static string GetTag(Fuse.Node node) [static] :494
...
// public Running New(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.UserAppState userApp, Outracks.Simulator.Protocol.Reify runningReify) [static] :426
...
// private static float QueryDensity() [static] :467
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Protocol.Uno/0.0.0/Common/$.uno(553)
// ---------------------------------------------------------------------------------------------------------

// internal static class Serialization :553
// {
// static Serialization() :553
static void Serialization__cctor__fn(uType* __type)
{
    Serialization::ReadString_ = uDelegate::New(::TYPES[125/*Uno.Func<Uno.IO.BinaryReader, string>*/], (void*)Serialization___ReadString_fn);
}
...
uClassType* Serialization_typeof()
{
    ...
    ::TYPES[125] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::IO::BinaryReader_typeof(), ::g::Uno::String_typeof());
    type->SetFields(0,
...
// public static string _ReadString(Uno.IO.BinaryReader reader) :557
...
// public static string _ReadString(Uno.IO.BinaryReader reader) [static] :557
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(1335)
// -------------------------------------------------------------------------------------------------

// internal class ShowingModalDialog :1335
// {
::g::Outracks::Simulator::State_type* ShowingModalDialog_typeof()
{
    ...
    ::STRINGS[4] = uString::Const("/usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno");
    ::TYPES[126] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Outracks::Simulator::DialogButton_typeof());
    ::TYPES[127] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Controls::Control_typeof());
    ::TYPES[57] = ::g::Outracks::Simulator::DialogButton_typeof()->Array();
    ::TYPES[128] = ::g::Outracks::Simulator::DialogButton_typeof();
    ::TYPES[129] = ::g::Fuse::Controls::Button_typeof();
    ::TYPES[130] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(1, ::g::Outracks::Simulator::DialogButton_typeof());
    ::TYPES[131] = ::g::Uno::Action1_typeof()->MakeType(::g::Outracks::Simulator::DialogButton_typeof());
    ::TYPES[132] = ::g::Fuse::Gestures::ClickedHandler_typeof();
    ::TYPES[133] = ::g::Outracks::Simulator::ForgetAction_typeof()->MakeType(uObject_typeof(), ::g::Fuse::Gestures::ClickedArgs_typeof());
    ::TYPES[13] = ::g::Fuse::Node_typeof();
    ::TYPES[79] = ::g::Fuse::Controls::Control_typeof();
    ::TYPES[15] = ::g::Outracks::Simulator::Context_typeof();
    ::TYPES[134] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Controls::Control_typeof());
    ::TYPES[2] = ::g::Outracks::Simulator::State_typeof();
    ::TYPES[1] = ::g::Uno::Exception_typeof();
    ::TYPES[135] = ::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(::g::Outracks::Simulator::DialogButton_typeof());
    type->SetFields(0,
...
// public ShowingModalDialog(string header, string body, string details, Outracks.Simulator.DialogButton[] buttons) :1344
...
// public ShowingModalDialog New(string header, string body, string details, Outracks.Simulator.DialogButton[] buttons) :1344
...
// private void OnButtonClicked(Outracks.Simulator.DialogButton button) :1377
...
// public override sealed Outracks.Simulator.State OnEnterState() :1356
void ShowingModalDialog__OnEnterState_fn(ShowingModalDialog* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    uDelegate* ret8;
    ::g::Uno::Collections::List* buttons = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[127/*Uno.Collections.List<Fuse.Controls.Control>*/]);
    ...
    for (array1 = __this->_buttons, index2 = 0, length3 = uPtr(array1)->Length(); index2 < length3; ++index2)
    {
        ...
        uDelegate* action = (::g::Outracks::Simulator::Closure__Apply_fn(::TYPES[130/*Outracks.Simulator.Closure.Apply<Outracks.Simulator.DialogButton>*/], uDelegate::New(::TYPES[131/*Uno.Action<Outracks.Simulator.DialogButton>*/], (void*)ShowingModalDialog__OnButtonClicked_fn, __this), button, &ret8), ret8);
        uDelegate* handler = uDelegate::New(::TYPES[132/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Outracks::Simulator::ForgetAction__Execute_fn, (::g::Outracks::Simulator::ForgetAction*)::g::Outracks::Simulator::ForgetAction::New1(::TYPES[133/*Outracks.Simulator.ForgetAction<object, Fuse.Gestures.ClickedArgs>*/], action));
...
// public override sealed Outracks.Simulator.State OnException(Uno.Exception e) :1390
void ShowingModalDialog__OnException_fn(ShowingModalDialog* __this, ::g::Uno::Exception* e, ::g::Outracks::Simulator::State** __retval)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(uPtr(e)->Message(), 1, ::STRINGS[4/*"/usr/local/...*/], 1392);
    return *__retval = __this, void();
}

// public override sealed Outracks.Simulator.State OnUpdate() :1382
void ShowingModalDialog__OnUpdate_fn(ShowingModalDialog* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    if (__this->_clickedButton().Value< ::g::Outracks::Simulator::Bytecode::Optional1<uStrong< ::g::Outracks::Simulator::DialogButton*> > >().HasValue(::TYPES[135/*Outracks.Simulator.Bytecode.Optional<Outracks.Simulator.DialogButton>*/]))
        return *__retval = uPtr(__this->_clickedButton().Value< ::g::Outracks::Simulator::Bytecode::Optional1<uStrong< ::g::Outracks::Simulator::DialogButton*> > >().Value(::TYPES[135/*Outracks.Simulator.Bytecode.Optional<Outracks.Simulator.DialogButton>*/]))->Destination, void();

    return *__retval = __this, void();
}

// public ShowingModalDialog(string header, string body, string details, Outracks.Simulator.DialogButton[] buttons) [instance] :1344
...
// private void OnButtonClicked(Outracks.Simulator.DialogButton button) [instance] :1377
void ShowingModalDialog::OnButtonClicked(::g::Outracks::Simulator::DialogButton* button)
{
    ...
    _clickedButton().Value< ::g::Outracks::Simulator::Bytecode::Optional1<uStrong< ::g::Outracks::Simulator::DialogButton*> > >() = (::g::Outracks::Simulator::Bytecode::Optional__Some_fn(::TYPES[126/*Outracks.Simulator.Bytecode.Optional.Some<Outracks.Simulator.DialogButton>*/], button, &ret7), ret7);
}

// public ShowingModalDialog New(string header, string body, string details, Outracks.Simulator.DialogButton[] buttons) [static] :1344
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(1266)
// -------------------------------------------------------------------------------------------------

// internal abstract class ShowingPrompt :1266
// {
ShowingPrompt_type* ShowingPrompt_typeof()
{
    ...
    ::TYPES[79] = ::g::Fuse::Controls::Control_typeof();
    ::TYPES[134] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Controls::Control_typeof());
    ::TYPES[136] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Fuse::Controls::Control_typeof());
    ::TYPES[137] = ::g::Fuse::Controls::Control_typeof()->Array();
    ::TYPES[2] = ::g::Outracks::Simulator::State_typeof();
    ::TYPES[82] = ::g::Fuse::Controls::TextControl_typeof();
    type->SetFields(0,
...
// protected ShowingPrompt(string header, string body) :1275
void ShowingPrompt__ctor_1_fn(ShowingPrompt* __this, uString* header, uString* body)
{
    __this->ctor_1(header, body);
}

// private void OnCancelClicked(object s, Fuse.Gestures.ClickedArgs args) :1314
...
// public override sealed Outracks.Simulator.State OnEnterState() :1283
void ShowingPrompt__OnEnterState_fn(ShowingPrompt* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    ::g::Fuse::Gestures::Clicked::AddHandler(ok, uDelegate::New(::TYPES[132/*Fuse.Gestures.ClickedHandler*/], (void*)ShowingPrompt__OnOkClicked_fn, __this));
    collection2 = ::g::Fuse::Controls::Button::New2();
    uPtr(collection2)->Text(::STRINGS[40/*"Cancel"*/]);
    ::STRINGS[40/*"Cancel"*/];
    ::g::Fuse::Controls::Button* cancel = collection2;
    ::g::Fuse::Gestures::Clicked::AddHandler(cancel, uDelegate::New(::TYPES[132/*Fuse.Gestures.ClickedHandler*/], (void*)ShowingPrompt__OnCancelClicked_fn, __this));
    __this->_input = ::g::Fuse::Controls::TextInput::New3();
    ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[41/*"# "*/], __this->_header), 1, ::STRINGS[4/*"/usr/local/...*/], 1302);
    ::g::Uno::Diagnostics::Debug::Log5(__this->_body, 1, ::STRINGS[4/*"/usr/local/...*/], 1303);
    ::g::Outracks::Simulator::ModalDialog::ShowPrompt(::g::Outracks::Simulator::Context::App(), __this->_header, __this->_body, __this->_input, (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[136/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Fuse.Controls.Control>*/], uArray::Init< ::g::Fuse::Controls::Control*>(::TYPES[137/*Fuse.Controls.Control[]*/], 2, cancel, ok))));
    return *__retval = __this, void();
}

// private void OnOkClicked(object s, Fuse.Gestures.ClickedArgs args) :1309
...
// public override sealed Outracks.Simulator.State OnUpdate() :1323
...
// protected ShowingPrompt(string header, string body) [instance] :1275
...
// private void OnCancelClicked(object s, Fuse.Gestures.ClickedArgs args) [instance] :1314
...
// private void OnOkClicked(object s, Fuse.Gestures.ClickedArgs args) [instance] :1309
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(824)
// ------------------------------------------------------------------------------------------------

// public sealed class SimulatorClient :824
// {
SimulatorClient_type* SimulatorClient_typeof()
{
    ...
    ::TYPES[85] = ::g::Uno::IO::Stream_typeof();
    ::TYPES[31] = ::g::Uno::Action_typeof();
    ::TYPES[138] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Outracks::Simulator::Task_typeof()->MakeType(::g::Outracks::Simulator::ISimulatorClient_typeof()));
    ::TYPES[116] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof());
    ::TYPES[139] = ::g::Outracks::Simulator::Tasks_typeof()->MakeMethod(1, ::g::Outracks::Simulator::ISimulatorClient_typeof());
    ::TYPES[140] = ::g::Uno::Func_typeof()->MakeType(::g::Outracks::Simulator::ISimulatorClient_typeof());
    ::TYPES[141] = ::g::Outracks::Simulator::Tasks_typeof()->MakeMethod(1, ::g::Outracks::Simulator::ISimulatorClient_typeof());
    ::TYPES[142] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Outracks::Simulator::Task_typeof()->MakeType(::g::Outracks::Simulator::ISimulatorClient_typeof()));
    ::TYPES[143] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Exception_typeof()), ::g::Outracks::Simulator::ISimulatorClient_typeof());
    ::TYPES[1] = ::g::Uno::Exception_typeof();
    ::TYPES[90] = ::g::Outracks::Simulator::Protocol::MessageToClient_typeof();
    type->SetInterfaces(
...
// public SimulatorClient(Uno.Net.Sockets.Socket socket) :862
void SimulatorClient__ctor__fn(SimulatorClient* __this, ::g::Uno::Net::Sockets::Socket* socket)
{
    __this->ctor_(socket);
}

// public static Outracks.Simulator.Task<Outracks.Simulator.ISimulatorClient> Connect(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint> simulatorEndpoints) :826
...
void SimulatorClient::ctor_(::g::Uno::Net::Sockets::Socket* socket)
{
    ...
    _readWorker = ::g::Uno::Threading::Thread::Create(uDelegate::New(::TYPES[31/*Uno.Action*/], (void*)SimulatorClient__ReadLoop_fn, this));
    _writeWorker = ::g::Uno::Threading::Thread::Create(uDelegate::New(::TYPES[31/*Uno.Action*/], (void*)SimulatorClient__WriteLoop_fn, this));
    uPtr(_readWorker)->Start();
    uPtr(_writeWorker)->Start();
}

// public void Dispose() [instance] :923
void SimulatorClient::Dispose()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Uno::Diagnostics::Debug::Log5(uPtr(e)->Message(), 1, ::STRINGS[4/*"/usr/local/...*/], 938);
    }
}

// public Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageToClient> get_IncommingMessages() [instance] :854
...
// public bool get_IsOnline() [instance] :944
...
// private void ReadLoop() [instance] :885
...
// public void Send(Outracks.Simulator.Protocol.MessageFromClient message) [instance] :857
...
// private void WriteLoop() [instance] :903
...
// public static Outracks.Simulator.Task<Outracks.Simulator.ISimulatorClient> Connect(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint> simulatorEndpoints) [static] :826
::g::Outracks::Simulator::Task* SimulatorClient::Connect(uObject* simulatorEndpoints)
{
    uStackFrame __("Outracks.Simulator.SimulatorClient", "Connect(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint>)");
    ::g::Uno::Net::IPEndPoint* ret3;
    ::g::Uno::Collections::List* tasks = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[138/*Uno.Collections.List<Outracks.Simulator.Task<Outracks.Simulator.ISimulatorClient>>*/]);

    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(simulatorEndpoints), ::TYPES[50/*Uno.Collections.IEnumerable<Uno.Net.IPEndPoint>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::g::Uno::Collections::IEnumerator_typeof())); )
    {
        ::g::Uno::Net::IPEndPoint* endpoint = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[116/*Uno.Collections.IEnumerator<Uno.Net.IPEndPoint>*/]), &ret3), ret3);
        ::g::Uno::Collections::List__Add_fn(uPtr(tasks), (::g::Outracks::Simulator::Task*)::g::Outracks::Simulator::Tasks::Run(::TYPES[139/*Outracks.Simulator.Tasks.Run<Outracks.Simulator.ISimulatorClient>*/], uDelegate::New(::TYPES[140/*Uno.Func<Outracks.Simulator.ISimulatorClient>*/], (void*)::g::Outracks::Simulator::ConnectToSimulator__Execute_fn, ::g::Outracks::Simulator::ConnectToSimulator::New1(endpoint))));
    }

    return (::g::Outracks::Simulator::Task*)::g::Outracks::Simulator::Tasks::WaitForFirstResult(::TYPES[141/*Outracks.Simulator.Tasks.WaitForFirstResult<Outracks.Simulator.ISimulatorClient>*/], (uObject*)tasks, uDelegate::New(::TYPES[143/*Uno.Func<Uno.Collections.IEnumerable<Uno.Exception>, Outracks.Simulator.ISimulatorClient>*/], (void*)SimulatorClient__OnNoResult_fn));
}

// public SimulatorClient New(Uno.Net.Sockets.Socket socket) [static] :862
...
// private static Outracks.Simulator.ISimulatorClient OnNoResult(Uno.Collections.IEnumerable<Uno.Exception> exceptions) [static] :838
uObject* SimulatorClient::OnNoResult(uObject* exceptions)
{
    uStackFrame __("Outracks.Simulator.SimulatorClient", "OnNoResult(Uno.Collections.IEnumerable<Uno.Exception>)");
    U_THROW(::g::Outracks::Simulator::FailedToConnectToSimulator::New4(exceptions));
}
// }

// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(132)
// ------------------------------------------------------------------------------------------------

// internal abstract class State :132
// {
...
// protected generated State() :132
void State__ctor__fn(State* __this)
{
    __this->ctor_();
}

// public virtual Outracks.Simulator.State OnEnterState() :134
...
// public virtual void OnLeaveState() :139
void State__OnLeaveState_fn(State* __this)
{
}

// public virtual Outracks.Simulator.State OnPointerPressed(Fuse.Input.PointerPressedArgs args) :148
...
// public virtual Outracks.Simulator.State OnUpdate() :143
...
// protected generated State() [instance] :132
void State::ctor_()
{
}
// }

// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Protocol.Uno/0.0.0/Common/$.uno(448)
// ---------------------------------------------------------------------------------------------------------

// public static class StringSplitting :448
// {
uClassType* StringSplitting_typeof()
{
    ...
    ::TYPES[28] = ::g::Uno::String_typeof();
    ::TYPES[144] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[104] = ::g::Uno::Collections::IEnumerator1_typeof();
    type->Reflection.SetFunctions(8,
...
// public static string AfterFirst(string s, string seperator) :485
...
// public static string AfterLast(string s, string seperator) :468
...
// public static string BeforeFirst(string s, string seperator) :493
...
// public static string BeforeLast(string s, string seperator) :476
...
// public static string Join(Uno.Collections.IEnumerable<string> si, string separator) :519
void StringSplitting__Join_fn(uObject* si, uString* separator, uString** __retval)
{
    *__retval = StringSplitting::Join(si, separator);
}

// public static string JoinToString<T>(Uno.Collections.IEnumerable<T> objects, string separator) :502
...
// public static int OrdinalIndexOf(string str, string seperator) :463
...
// public static int OrdinalLastIndexOf(string str, string seperator) :450
...
// public static string AfterFirst(string s, string seperator) [static] :485
...
// public static string AfterLast(string s, string seperator) [static] :468
...
// public static string BeforeFirst(string s, string seperator) [static] :493
...
// public static string BeforeLast(string s, string seperator) [static] :476
...
// public static string Join(Uno.Collections.IEnumerable<string> si, string separator) [static] :519
uString* StringSplitting::Join(uObject* si, uString* separator)
{
    ...
    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(si), ::TYPES[53/*Uno.Collections.IEnumerable<string>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::g::Uno::Collections::IEnumerator_typeof())); )
    {
        uString* part = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[144/*Uno.Collections.IEnumerator<string>*/]), &ret2), ret2);
...
// public static string JoinToString<T>(Uno.Collections.IEnumerable<T> objects, string separator) [static] :502
uString* StringSplitting::JoinToString(uType* __type, uObject* objects, uString* separator)
{
    ...
    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(objects), ::TYPES[96/*Uno.Collections.IEnumerable`1*/]->MakeType(__types[0]))); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::g::Uno::Collections::IEnumerator_typeof())); )
    {
...
// public static int OrdinalIndexOf(string str, string seperator) [static] :463
...
// public static int OrdinalLastIndexOf(string str, string seperator) [static] :450
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Protocol.Uno/0.0.0/Concurrency/$.uno(57)
// -------------------------------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Protocol.Uno/0.0.0/Concurrency/$.uno(91)
// -------------------------------------------------------------------------------------------------------------
...
uClassType* Tasks_typeof()
{
    ...
    ::TYPES[145] = ::g::Outracks::Simulator::TaskThread_typeof();
    ::TYPES[146] = ::g::Uno::Func_typeof();
    ::TYPES[147] = ::g::Outracks::Simulator::WaitForFirstResult_typeof();
    type->Reflection.SetFunctions(2,
...
{
    uType* __types[] = {
        ::TYPES[145/*Outracks.Simulator.TaskThread`1*/]->MakeType(__type->U(0)),
        __type->U(0),
    };
...
::g::Outracks::Simulator::Task* Tasks::WaitForFirstResult(uType* __type, uObject* tasks, uDelegate* onNoResult)
{
    uType* __types[] = {
        ...
        __type->U(0),
        ::TYPES[146/*Uno.Func`1*/]->MakeType(__type->U(0)),
        ::TYPES[147/*Outracks.Simulator.WaitForFirstResult`1*/]->MakeType(__type->U(0)),
    };
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Protocol.Uno/0.0.0/Concurrency/$.uno(114)
// --------------------------------------------------------------------------------------------------------------
...
uType* TaskThread_typeof()
{
    ...
    ::TYPES[31] = ::g::Uno::Action_typeof();
    ::TYPES[148] = ::g::Outracks::Simulator::Task_typeof();
    ::TYPES[146] = ::g::Uno::Func_typeof();
    type->SetPrecalc(
        ::TYPES[148/*Outracks.Simulator.Task`1*/]->MakeType(type->T(0)),
        ::TYPES[146/*Uno.Func`1*/]->MakeType(type->T(0)));
    type->SetFields(0,
...
void TaskThread::ctor_(uDelegate* func)
{
    ...
    _func = func;
    Thread = ::g::Uno::Threading::Thread::Create(uDelegate::New(::TYPES[31/*Uno.Action*/], (void*)TaskThread__Run_fn, this));
    Task = ((::g::Outracks::Simulator::Task*)::g::Outracks::Simulator::Task::New1(__types[0], uDelegate::New(::TYPES[31/*Uno.Action*/], uPtr(Thread), offsetof(::g::Uno::Threading::Thread_type, fp_Join))));
}
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(180)
// ------------------------------------------------------------------------------------------------

// internal sealed class Uninitialized :180
// {
...
// public generated Uninitialized() :180
void Uninitialized__ctor_1_fn(Uninitialized* __this)
{
    __this->ctor_1();
}

// public generated Uninitialized New() :180
void Uninitialized__New1_fn(Uninitialized** __retval)
{
    *__retval = Uninitialized::New1();
}

// public override sealed Outracks.Simulator.State OnException(Uno.Exception e) :190
void Uninitialized__OnException_fn(Uninitialized* __this, ::g::Uno::Exception* e, ::g::Outracks::Simulator::State** __retval)
{
    ...
    return *__retval = ::g::Outracks::Simulator::Faulted::New2(false, e, uArray::Init< ::g::Outracks::Simulator::DialogButton*>(::TYPES[57/*Outracks.Simulator.DialogButton[]*/], 1, (::g::Outracks::Simulator::DialogButton*)::g::Outracks::Simulator::DialogButton::New1(::STRINGS[24/*"Try again"*/], __this))), void();
}

// public override sealed Outracks.Simulator.State OnUpdate() :182
...
// public generated Uninitialized() [instance] :180
...
// public generated Uninitialized New() [static] :180
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno(643)
// ------------------------------------------------------------------------------------------------

// internal sealed class UserAppState :643
// {
uType* UserAppState_typeof()
{
    ...
    ::TYPES[12] = ::g::Outracks::Simulator::FakeApp_typeof();
    ::TYPES[149] = UserAppState_typeof()->MakeMethod(1, ::g::Fuse::Behavior_typeof());
    ::TYPES[150] = UserAppState_typeof()->MakeMethod(1, ::g::Uno::UX::Resource_typeof());
    ::TYPES[151] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Behavior_typeof());
    ::TYPES[152] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Behavior_typeof());
    ::TYPES[153] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Uno::UX::Resource_typeof());
    ::TYPES[154] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[155] = ::g::Uno::Collections::ICollection_typeof();
    ::TYPES[43] = uObject_typeof()->Array();
    ::TYPES[25] = uObject_typeof();
    ::TYPES[156] = ::g::Uno::Collections::IList_typeof();
    ::TYPES[8] = ::g::Uno::Bool_typeof();
    ::TYPES[157] = ::g::Uno::Collections::IListExtensions_typeof();
    ::TYPES[96] = ::g::Uno::Collections::IEnumerable_typeof();
    ::TYPES[97] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof();
    type->SetFields(0,
...
// public UserAppState(float4 background, Fuse.Behavior[] behaviors, Uno.UX.Resource[] resources, Fuse.Node rootNode, Fuse.Theme theme, float4 clearColor, float clearDepth) :659
...
// public void ApplyTo(Outracks.Simulator.FakeApp app) :692
void UserAppState__ApplyTo_fn(UserAppState* __this, ::g::Outracks::Simulator::FakeApp* app)
{
    __this->ApplyTo(app);
}

// public static generated Outracks.Simulator.UserAppState get_Default() :678
void UserAppState__get_Default_fn(UserAppState** __retval)
{
    *__retval = UserAppState::Default();
}

// public static generated void set_Default(Outracks.Simulator.UserAppState value) :678
void UserAppState__set_Default_fn(UserAppState* value)
{
    UserAppState::Default(value);
}

// public UserAppState New(float4 background, Fuse.Behavior[] behaviors, Uno.UX.Resource[] resources, Fuse.Node rootNode, Fuse.Theme theme, float4 clearColor, float clearDepth) :659
...
// public static Outracks.Simulator.UserAppState Save(Outracks.Simulator.FakeApp app) :680
void UserAppState__Save_fn(::g::Outracks::Simulator::FakeApp* app, UserAppState** __retval)
{
    *__retval = UserAppState::Save(app);
}

// private static bool SequenceEquals<T>(Uno.Collections.IList<T> left, T[] right) :715
...
// private static void SetIfNotEqual<T>(Uno.Collections.IList<T> list, T[] elements) :703
...
// private static void SetSequence<T>(Uno.Collections.IList<T> list, T[] elements) :709
...
// public UserAppState(float4 background, Fuse.Behavior[] behaviors, Uno.UX.Resource[] resources, Fuse.Node rootNode, Fuse.Theme theme, float4 clearColor, float clearDepth) [instance] :659
...
// public void ApplyTo(Outracks.Simulator.FakeApp app) [instance] :692
void UserAppState::ApplyTo(::g::Outracks::Simulator::FakeApp* app)
{
    ...
    UserAppState::SetIfNotEqual(::TYPES[149/*Outracks.Simulator.UserAppState.SetIfNotEqual<Fuse.Behavior>*/], app->Behaviors1(), Behaviors);
    UserAppState::SetIfNotEqual(::TYPES[150/*Outracks.Simulator.UserAppState.SetIfNotEqual<Uno.UX.Resource>*/], app->Resources1(), Resources);
...
// public UserAppState New(float4 background, Fuse.Behavior[] behaviors, Uno.UX.Resource[] resources, Fuse.Node rootNode, Fuse.Theme theme, float4 clearColor, float clearDepth) [static] :659
...
// public static Outracks.Simulator.UserAppState Save(Outracks.Simulator.FakeApp app) [static] :680
UserAppState* UserAppState::Save(::g::Outracks::Simulator::FakeApp* app)
{
    ...
    return UserAppState::New1(uPtr(app)->Background1(), (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[151/*Uno.Collections.EnumerableExtensions.ToArray<Fuse.Behavior>*/], uPtr(app)->Behaviors1()), (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[153/*Uno.Collections.EnumerableExtensions.ToArray<Uno.UX.Resource>*/], uPtr(app)->Resources1()), uPtr(app)->RootNode(), uPtr(app)->Theme(), uPtr(app)->ClearColor(), uPtr(app)->ClearDepth());
}

// private static bool SequenceEquals<T>(Uno.Collections.IList<T> left, T[] right) [static] :715
bool UserAppState::SequenceEquals(uType* __type, uObject* left, uArray* right)
{
    uType* __types[] = {
        __type->U(0),
        ::TYPES[155/*Uno.Collections.ICollection`1*/]->MakeType(__type->U(0)),
        __type->U(0)->Array(),
        ::TYPES[156/*Uno.Collections.IList`1*/]->MakeType(__type->U(0)),
    };
...
// private static void SetIfNotEqual<T>(Uno.Collections.IList<T> list, T[] elements) [static] :703
...
// private static void SetSequence<T>(Uno.Collections.IList<T> list, T[] elements) [static] :709
void UserAppState::SetSequence(uType* __type, uObject* list, uArray* elements)
{
    uType* __types[] = {
        ::TYPES[157/*Uno.Collections.IListExtensions*/]->MakeMethod(1, __type->U(0)),
        __type->U(0),
    ...
    ::g::Uno::Collections::ICollection::Clear(uInterface(uPtr(list), ::TYPES[155/*Uno.Collections.ICollection`1*/]->MakeType(__types[1])));
...
// public static generated Outracks.Simulator.UserAppState get_Default() [static] :678
...
// public static generated void set_Default(Outracks.Simulator.UserAppState value) [static] :678
...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Protocol.Uno/0.0.0/Concurrency/$.uno(144)
// --------------------------------------------------------------------------------------------------------------
...
uType* WaitForFirstResult_typeof()
{
    ...
    ::TYPES[69] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Exception_typeof());
    type->SetPrecalc(
        ::TYPES[98/*Uno.Collections.EnumerableExtensions*/]->MakeMethod(1, ::TYPES[148/*Outracks.Simulator.Task`1*/]->MakeType(type->T(0))),
        ::TYPES[148/*Outracks.Simulator.Task`1*/]->MakeType(type->T(0)),
        ::TYPES[158/*Uno.Collections.List`1*/]->MakeType(::TYPES[148/*Outracks.Simulator.Task`1*/]->MakeType(type->T(0))),
        ::TYPES[148/*Outracks.Simulator.Task`1*/]->MakeType(type->T(0))->Array(),
        ::TYPES[36/*Uno.Func`2*/]->MakeType(::TYPES[69/*Uno.Collections.IEnumerable<Uno.Exception>*/], type->T(0)));
    type->SetFields(0,

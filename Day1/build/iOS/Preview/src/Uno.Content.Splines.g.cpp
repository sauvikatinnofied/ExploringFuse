...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Content/Splines/$.uno(46)
// -----------------------------------------------------------------------------------------------------

// public struct KeyframedSpline<TValue, TData>.Key :46
// {
...
// public Key(double time, TData value) :51
void KeyframedSpline__Key__ctor__fn(uTRef __this, uType* __type, double* time, void* value)
{
    ...
    __type->Field(__this, 1/*Value*/) = value;
}

// public Key New(double time, TData value) :51
void KeyframedSpline__Key__New1_fn(uType* __type, double* time, void* value, uTRef __retval)
{
    ...
    double time_ = *time;
    ;
    KeyframedSpline__Key__ctor__fn(&obj1, __type, uCRef(time_), value);
    return __retval.Store(obj1), void();
}
// }

// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Content/Splines/$.uno(44)
// -----------------------------------------------------------------------------------------------------
...
::g::Uno::Content::Splines::Spline_type* KeyframedSpline_typeof()
{
    ...
    type->SetPrecalc(
        ::TYPES[0/*Uno.Collections.List`1*/]->MakeType(::TYPES[1/*Uno.Content.Splines.KeyframedSpline`2.Key*/]->MakeType(type->T(0), type->T(1))),
        ::TYPES[1/*Uno.Content.Splines.KeyframedSpline`2.Key*/]->MakeType(type->T(0), type->T(1)),
        ::TYPES[1/*Uno.Content.Splines.KeyframedSpline`2.Key*/]->MakeType(type->T(0), type->T(1))->Array());
    type->SetFields(0,
...
// protected KeyframedSpline() :61
void KeyframedSpline__ctor_1_fn(KeyframedSpline* __this)
{
    __this->ctor_1();
}

// protected KeyframedSpline(Uno.Content.Splines.KeyframedSpline<TValue, TData>.Key[] keys) :65
void KeyframedSpline__ctor_2_fn(KeyframedSpline* __this, uArray* keys1)
{
    __this->ctor_2(keys1);
}

// public int AddKey(double time, TData value) :123
void KeyframedSpline__AddKey_fn(KeyframedSpline* __this, double* time, void* value, int* __retval)
{
    ...
    ::g::Uno::Collections::List__Insert_fn(uPtr(__this->keys), uCRef<int>(i), (KeyframedSpline__Key__New1_fn(__types[1], uCRef(time_), value, &ret2), ret2));
    return *__retval = i, void();
}

// public void ClearKeys() :136
void KeyframedSpline__ClearKeys_fn(KeyframedSpline* __this)
{
    __this->ClearKeys();
}

// public override sealed double get_End() :78
void KeyframedSpline__get_End_fn(KeyframedSpline* __this, double* __retval)
{
    uType* __types[] = {
        ...
        __this->__type->GetBase(KeyframedSpline_typeof())->T(0),
        __this->__type->GetBase(KeyframedSpline_typeof())->T(1),
        __this->__type->GetBase(KeyframedSpline_typeof())->Precalced(0/*Uno.Collections.List<Uno.Content.Splines.KeyframedSpline<TValue, TData>.Key>*/),
    };
...
// public TData FindValue(double time) :178
...
// public void FindValues(double time, TData& a, TData& b, float& p) :192
...
// public void FindValues(double time, TData& a, TData& b, TData& c, TData& d, float& p) :207
...
// public void SetValue(int index, TData value) :157
void KeyframedSpline__SetValue_fn(KeyframedSpline* __this, int* index, void* value)
{
    ...
    ;
    ;
    ::g::Uno::Collections::List__set_Item_fn(uPtr(__this->keys), uCRef<int>(index_), (KeyframedSpline__Key__New1_fn(__types[1], uCRef((::g::Uno::Collections::List__get_Item_fn(uPtr(__this->keys), uCRef<int>(index_), &ret25), ret25)[0/*Time*/].Value<double>()), value, &ret24), ret24));
}

// public override sealed double get_Start() :73
...
// protected KeyframedSpline() [instance] :61
...
// protected KeyframedSpline(Uno.Content.Splines.KeyframedSpline<TValue, TData>.Key[] keys) [instance] :65
void KeyframedSpline::ctor_2(uArray* keys1)
{
    uType* __types[] = {
        ...
        __type->GetBase(KeyframedSpline_typeof())->T(0),
        __type->GetBase(KeyframedSpline_typeof())->T(1),
        __type->GetBase(KeyframedSpline_typeof())->Precalced(2/*Uno.Content.Splines.KeyframedSpline<TValue, TData>.Key[]*/),
    };
...
// public void ClearKeys() [instance] :136
...
// public int FindLeftIndex(double time) [instance] :81
...
// public int FindNearestIndex(double time) [instance] :103
...
// public double GetTime(int index) [instance] :152
...
// public int get_KeyCount() [instance] :144
...
// public void RemoveKey(int index) [instance] :130
...
// public int SetTime(int index, double time) [instance] :162
...
// public static float Map(double a, double b, double t) [static] :183
...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Content/Splines/$.uno(231)
// ------------------------------------------------------------------------------------------------------

// public sealed class LinearSplineFloat :231
// {
...
// public LinearSplineFloat() [instance] :233
...
// public LinearSplineFloat(Uno.Content.Splines.KeyframedSpline<float, float>.Key[] keys) [instance] :237
...
// public LinearSplineFloat New() [static] :233
...
// public LinearSplineFloat New(Uno.Content.Splines.KeyframedSpline<float, float>.Key[] keys) [static] :237
...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Content/Splines/$.uno(258)
// ------------------------------------------------------------------------------------------------------

// public sealed class LinearSplineFloat2 :258
// {
...
// public LinearSplineFloat2() [instance] :260
...
// public LinearSplineFloat2(Uno.Content.Splines.KeyframedSpline<float2, float2>.Key[] keys) [instance] :264
...
// public LinearSplineFloat2 New() [static] :260
...
// public LinearSplineFloat2 New(Uno.Content.Splines.KeyframedSpline<float2, float2>.Key[] keys) [static] :264
...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Content/Splines/$.uno(286)
// ------------------------------------------------------------------------------------------------------

// public sealed class LinearSplineFloat3 :286
// {
...
// public LinearSplineFloat3() [instance] :288
...
// public LinearSplineFloat3(Uno.Content.Splines.KeyframedSpline<float3, float3>.Key[] keys) [instance] :292
...
// public LinearSplineFloat3 New() [static] :288
...
// public LinearSplineFloat3 New(Uno.Content.Splines.KeyframedSpline<float3, float3>.Key[] keys) [static] :292
...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Content/Splines/$.uno(314)
// ------------------------------------------------------------------------------------------------------

// public sealed class LinearSplineFloat4 :314
// {
...
// public LinearSplineFloat4() [instance] :316
...
// public LinearSplineFloat4(Uno.Content.Splines.KeyframedSpline<float4, float4>.Key[] keys) [instance] :320
...
// public LinearSplineFloat4 New() [static] :316
...
// public LinearSplineFloat4 New(Uno.Content.Splines.KeyframedSpline<float4, float4>.Key[] keys) [static] :320
...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Content/Splines/$.uno(342)
// ------------------------------------------------------------------------------------------------------

// public sealed class LinearSplineFloat4x4 :342
// {
...
// public LinearSplineFloat4x4() [instance] :344
...
// public LinearSplineFloat4x4(Uno.Content.Splines.KeyframedSpline<float4x4, float4x4>.Key[] keys) [instance] :348
...
// public LinearSplineFloat4x4 New() [static] :344
...
// public LinearSplineFloat4x4 New(Uno.Content.Splines.KeyframedSpline<float4x4, float4x4>.Key[] keys) [static] :348
...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Content/Splines/$.uno(368)
// ------------------------------------------------------------------------------------------------------

// public abstract class Spline<T> :368
// {
...
// protected generated Spline() :368
void Spline__ctor__fn(Spline* __this)
{
    __this->ctor_();
}

// public T get_First() :376
...
// public T Sample(double time) :384
...
// protected generated Spline() [instance] :368
void Spline::ctor_()
{
}
// }

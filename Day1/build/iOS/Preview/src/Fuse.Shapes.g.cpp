...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Shapes/0.24.6/$.uno(17)
// ------------------------------------------------------------------------------
...
::g::Fuse::Shapes::Shape_type* Circle_typeof()
{
    ...
    type->SetInterfaces(
        ...
        ::g::Fuse::IDataContext_typeof(), offsetof(::g::Fuse::Shapes::Shape_type, interface1),
        ::g::Fuse::Triggers::Actions::IShow_typeof(), offsetof(::g::Fuse::Shapes::Shape_type, interface2),
        ::g::Fuse::Triggers::Actions::IHide_typeof(), offsetof(::g::Fuse::Shapes::Shape_type, interface3),
        ::g::Fuse::Triggers::Actions::ICollapse_typeof(), offsetof(::g::Fuse::Shapes::Shape_type, interface4),
        ::g::Fuse::IActualPlacement_typeof(), offsetof(::g::Fuse::Shapes::Shape_type, interface5),
        ::g::Fuse::Animations::IResize_typeof(), offsetof(::g::Fuse::Shapes::Shape_type, interface6));
    type->SetFields(92,
...
{
    uStackFrame __("Fuse.Shapes.Circle", "DrawFill(Fuse.DrawContext,Fuse.Drawing.Brush)");
...
{
    uStackFrame __("Fuse.Shapes.Circle", "DrawStroke(Fuse.DrawContext,Fuse.Drawing.Stroke)");
    float startAngle = __this->_startAngle;
    float endAngle = __this->EffectiveEndAngle();
...
{
    uStackFrame __("Fuse.Shapes.Circle", "OnHitTestLocalVisual(Fuse.HitTestContext)");
...
void Circle::ctor_3()
{
    uStackFrame __("Fuse.Shapes.Circle", ".ctor()");
    ctor_2();
}
...
{
    uStackFrame __("Fuse.Shapes.Circle", "get_Center()");
...
{
    uStackFrame __("Fuse.Shapes.Circle", "get_EffectiveEndAngle()");
...
{
    uStackFrame __("Fuse.Shapes.Circle", "get_EndAngle()");
    return _endAngle;
}
...
{
    uStackFrame __("Fuse.Shapes.Circle", "set_EndAngle(float)");
    _endAngle = value;
    InvalidateVisual();
}
...
{
    uStackFrame __("Fuse.Shapes.Circle", "get_EndAngleDegrees()");
...
{
    uStackFrame __("Fuse.Shapes.Circle", "set_EndAngleDegrees(float)");
...
{
    uStackFrame __("Fuse.Shapes.Circle", "get_LengthAngle()");
    return _lengthAngle;
}
...
{
    uStackFrame __("Fuse.Shapes.Circle", "set_LengthAngle(float)");
    _lengthAngle = value;
...
{
    uStackFrame __("Fuse.Shapes.Circle", "get_LengthAngleDegrees()");
...
{
    uStackFrame __("Fuse.Shapes.Circle", "set_LengthAngleDegrees(float)");
...
float Circle::Radius()
{
    uStackFrame __("Fuse.Shapes.Circle", "get_Radius()");
...
{
    uStackFrame __("Fuse.Shapes.Circle", "get_StartAngle()");
    return _startAngle;
}
...
{
    uStackFrame __("Fuse.Shapes.Circle", "set_StartAngle(float)");
    _startAngle = value;
    _hasAngle = true;
    InvalidateVisual();
}
...
{
    uStackFrame __("Fuse.Shapes.Circle", "get_StartAngleDegrees()");
...
{
    uStackFrame __("Fuse.Shapes.Circle", "set_StartAngleDegrees(float)");
...
{
    uStackFrame __("Fuse.Shapes.Circle", "get_UseAngle()");
...
{
    uStackFrame __("Fuse.Shapes.Circle", "AngleInRange(float,float,float)");
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Shapes/0.24.6/$.uno(183)
// -------------------------------------------------------------------------------
...
::g::Fuse::Shapes::PathShape_type* Ellipse_typeof()
{
    ...
    type->SetInterfaces(
        ...
        ::g::Fuse::IDataContext_typeof(), offsetof(::g::Fuse::Shapes::PathShape_type, interface1),
        ::g::Fuse::Triggers::Actions::IShow_typeof(), offsetof(::g::Fuse::Shapes::PathShape_type, interface2),
        ::g::Fuse::Triggers::Actions::IHide_typeof(), offsetof(::g::Fuse::Shapes::PathShape_type, interface3),
        ::g::Fuse::Triggers::Actions::ICollapse_typeof(), offsetof(::g::Fuse::Shapes::PathShape_type, interface4),
        ::g::Fuse::IActualPlacement_typeof(), offsetof(::g::Fuse::Shapes::PathShape_type, interface5),
        ::g::Fuse::Animations::IResize_typeof(), offsetof(::g::Fuse::Shapes::PathShape_type, interface6));
    type->SetFields(88,
...
// public generated Ellipse() :183
void Ellipse__ctor_3_fn(Ellipse* __this)
{
    __this->ctor_3();
}

// public generated Ellipse New() :183
void Ellipse__New1_fn(Ellipse** __retval)
{
    *__retval = Ellipse::New1();
}

// protected override sealed void UpdatePath() :187
void Ellipse__UpdatePath_fn(Ellipse* __this)
{
    uStackFrame __("Fuse.Shapes.Ellipse", "UpdatePath()");
...
// public generated Ellipse() [instance] :183
void Ellipse::ctor_3()
{
    uStackFrame __("Fuse.Shapes.Ellipse", ".ctor()");
    _cachedRadius = ::g::Uno::Float2__New2(0.0f, 0.0f);
    ctor_2();
}

// public generated Ellipse New() [static] :183
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Shapes/0.24.6/$.uno(218)
// -------------------------------------------------------------------------------

// public enum FillRule :218
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Shapes/0.24.6/$.uno(223)
// -------------------------------------------------------------------------------

// public enum FitMode :223
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Shapes/0.24.6/$.uno(241)
// -------------------------------------------------------------------------------

// internal sealed class GeometryCache :241
// {
...
// private GeometryCache() :253
void GeometryCache__ctor__fn(GeometryCache* __this)
{
    __this->ctor_();
}

// private Fuse.Drawing.PathGeometry GetOrCreateImpl(string data) :258
...
// public static Fuse.Drawing.PathGeometry GetOrParse(string data) :245
...
// private GeometryCache() [instance] :253
...
// private Fuse.Drawing.PathGeometry GetOrCreateImpl(string data) [instance] :258
...
// private void Update() [instance] :267
...
// public static Fuse.Drawing.PathGeometry GetOrParse(string data) [static] :245
...
// private GeometryCache New() [static] :253
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Shapes/0.24.6/$.uno(231)
// -------------------------------------------------------------------------------

// internal sealed class GeometryCacheEntry :231
// {
...
// public GeometryCacheEntry(Fuse.Drawing.PathGeometry geometry) :235
void GeometryCacheEntry__ctor__fn(GeometryCacheEntry* __this, ::g::Fuse::Drawing::PathGeometry* geometry)
{
    __this->ctor_(geometry);
}

// public GeometryCacheEntry New(Fuse.Drawing.PathGeometry geometry) :235
...
// public GeometryCacheEntry(Fuse.Drawing.PathGeometry geometry) [instance] :235
...
// public GeometryCacheEntry New(Fuse.Drawing.PathGeometry geometry) [static] :235
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Shapes/0.24.6/$.uno(289)
// -------------------------------------------------------------------------------

// public sealed class Path :289
// {
::g::Fuse::Shapes::PathShape_type* Path_typeof()
{
    ...
    ::TYPES[1] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[16] = ::g::Fuse::LayoutParams_typeof();
    ::TYPES[17] = ::g::Uno::Int_typeof();
    ::TYPES[8] = ::g::Fuse::Drawing::PathGeometryRenderer_typeof();
    ::TYPES[9] = ::g::Fuse::Shapes::PathShape_typeof();
    ::TYPES[18] = ::g::Uno::Float4_typeof();
    ::TYPES[19] = ::g::Uno::Rect_typeof();
    ::TYPES[20] = ::g::Uno::Float4x4_typeof();
    ::TYPES[6] = ::g::Uno::Float2_typeof();
    ::TYPES[7] = ::g::Fuse::Node_typeof();
    ::TYPES[21] = ::g::Uno::Predicate_typeof()->MakeType(::g::Uno::Int_typeof());
    type->SetInterfaces(
        ::g::Fuse::Scripting::INameScope_typeof(), offsetof(::g::Fuse::Shapes::PathShape_type, interface0),
        ::g::Fuse::IDataContext_typeof(), offsetof(::g::Fuse::Shapes::PathShape_type, interface1),
        ::g::Fuse::Triggers::Actions::IShow_typeof(), offsetof(::g::Fuse::Shapes::PathShape_type, interface2),
...
// public generated Path() :289
void Path__ctor_3_fn(Path* __this)
{
    __this->ctor_3();
}

// private float4x4 AlignMatrix(float4x4 b) :495
void Path__AlignMatrix_fn(Path* __this, ::g::Uno::Float4x4* b, ::g::Uno::Float4x4* __retval)
{
    *__retval = __this->AlignMatrix(*b);
}

// protected override sealed void ArrangePaddingBox(Fuse.LayoutParams lp) :455
...
// protected override sealed Uno.Rect CalcRenderBounds() :506
...
// protected override sealed void UpdatePath() :377
void Path__UpdatePath_fn(Path* __this)
{
}

// public generated Path() [instance] :289
void Path::ctor_3()
{
...
// private float4x4 AlignMatrix(float4x4 b) [instance] :495
...
// public Fuse.Elements.Alignment get_ContentAlignment() [instance] :318
...
// public void set_ContentAlignment(Fuse.Elements.Alignment value) [instance] :319
...
// public string get_Data() [instance] :385
uString* Path::Data()
{
...
// public void set_Data(string value) [instance] :386
...
// public Fuse.Shapes.FillRule get_FillRule() [instance] :393
int Path::FillRule()
{
...
// public void set_FillRule(Fuse.Shapes.FillRule value) [instance] :394
void Path::FillRule(int value)
{
    uStackFrame __("Fuse.Shapes.Path", "set_FillRule(Fuse.Shapes.FillRule)");
    _fillRule = value;
    uPtr(Renderer())->FillRule((_fillRule == 1) ? uDelegate::New(::TYPES[21/*Uno.Predicate<int>*/], (void*)::g::Fuse::Drawing::WindingRules__Odd_fn) : uDelegate::New(::TYPES[21/*Uno.Predicate<int>*/], (void*)::g::Fuse::Drawing::WindingRules__NonZero_fn));
}

// public Fuse.Shapes.FitMode get_FitMode() [instance] :330
int Path::FitMode()
{
...
// public void set_FitMode(Fuse.Shapes.FitMode value) [instance] :331
...
// public Fuse.Drawing.PathGeometry get_Geometry() [instance] :368
...
// public void set_Geometry(Fuse.Drawing.PathGeometry value) [instance] :369
...
// protected float2 GetNaturalContentSize() [instance] :403
...
// private void OnSizingChanged() [instance] :360
...
// public Fuse.Shapes.PathScaleMode get_ScaleMode() [instance] :344
int Path::ScaleMode()
{
...
// public void set_ScaleMode(Fuse.Shapes.PathScaleMode value) [instance] :345
...
// public Fuse.Elements.StretchDirection get_StretchDirection() [instance] :307
...
// public void set_StretchDirection(Fuse.Elements.StretchDirection value) [instance] :308
...
// public generated Path New() [static] :289
Path* Path::New1()
{
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Shapes/0.24.6/$.uno(282)
// -------------------------------------------------------------------------------

// public enum PathScaleMode :282
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Shapes/0.24.6/$.uno(893)
// -------------------------------------------------------------------------------
...
PathShape_type* PathShape_typeof()
{
    ...
    ::TYPES[1] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[5] = ::g::Fuse::HitTestContext_typeof();
    ::TYPES[22] = ::g::Fuse::IViewport_typeof();
    type->SetInterfaces(
        ::g::Fuse::Scripting::INameScope_typeof(), offsetof(PathShape_type, interface0),
        ::g::Fuse::IDataContext_typeof(), offsetof(PathShape_type, interface1),
        ::g::Fuse::Triggers::Actions::IShow_typeof(), offsetof(PathShape_type, interface2),
        ::g::Fuse::Triggers::Actions::IHide_typeof(), offsetof(PathShape_type, interface3),
        ::g::Fuse::Triggers::Actions::ICollapse_typeof(), offsetof(PathShape_type, interface4),
        ::g::Fuse::IActualPlacement_typeof(), offsetof(PathShape_type, interface5),
        ::g::Fuse::Animations::IResize_typeof(), offsetof(PathShape_type, interface6));
    type->SetFields(87,
...
void PathShape__OnRooted_fn(PathShape* __this)
{
    ...
    uPtr(__this->_renderer)->Density(::g::Fuse::IViewport::PointDensity(uInterface(uPtr(__this->Viewport()), ::TYPES[22/*Fuse.IViewport*/])));
}
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Shapes/0.24.6/$.uno(535)
// -------------------------------------------------------------------------------

// public sealed class Rectangle :535
// {
// static Rectangle() :535
static void Rectangle__cctor_3_fn(uType* __type)
{
    ::g::Fuse::StyleProperty1* ret8;
    Rectangle::CornerRadiusProperty_ = (::g::Fuse::StyleProperty1__New1_fn(::TYPES[23/*Fuse.StyleProperty<Fuse.Shapes.Rectangle, float4>*/], uCRef(::g::Uno::Float4__New1(0.0f)), uDelegate::New(::TYPES[24/*Uno.Action<Fuse.Shapes.Rectangle>*/], (void*)Rectangle__OnCornerRadiusChanged_fn), &ret8), ret8);
}
...
::g::Fuse::Shapes::Shape_type* Rectangle_typeof()
{
    ...
    type->interface1.fp_get_DataContext = (void(*)(uObject*, uObject**))::g::Fuse::Node__get_DataContext_fn;
    type->interface1.fp_set_DataContext = (void(*)(uObject*, uObject*))::g::Fuse::Node__set_DataContext_fn;
    ::TYPES[23] = ::g::Fuse::StyleProperty1_typeof()->MakeType(Rectangle_typeof(), ::g::Uno::Float4_typeof());
    ::TYPES[24] = ::g::Uno::Action1_typeof()->MakeType(Rectangle_typeof());
    ::TYPES[1] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[18] = ::g::Uno::Float4_typeof();
    ::TYPES[25] = ::g::Fuse::Drawing::Primitives::Rectangle_typeof();
    ::TYPES[7] = ::g::Fuse::Node_typeof();
    ::TYPES[2] = ::g::Fuse::Shapes::Shape_typeof();
    ::TYPES[5] = ::g::Fuse::HitTestContext_typeof();
    ::TYPES[4] = ::g::Uno::Bool_typeof();
    ...
    type->Reflection.SetFields(1,
        new uField("CornerRadiusProperty", 92));
...
// protected override sealed void DrawStroke(Fuse.DrawContext dc, Fuse.Drawing.Stroke stroke) :558
void Rectangle__DrawStroke_fn(Rectangle* __this, ::g::Fuse::DrawContext* dc, ::g::Fuse::Drawing::Stroke* stroke)
{
    uStackFrame __("Fuse.Shapes.Rectangle", "DrawStroke(Fuse.DrawContext,Fuse.Drawing.Stroke)");
    ::g::Uno::Float4 ind4;
    ::g::Uno::Float4 ind5;
    ::g::Uno::Float4 ind6;
    ::g::Uno::Float4 cr = __this->CornerRadius();
...
// public generated Rectangle New() :535
void Rectangle__New1_fn(Rectangle** __retval)
{
    *__retval = Rectangle::New1();
}

// private static void OnCornerRadiusChanged(Fuse.Shapes.Rectangle r) :546
void Rectangle__OnCornerRadiusChanged_fn(Rectangle* r)
{
    Rectangle::OnCornerRadiusChanged(r);
}

// protected override sealed void OnHitTestLocalVisual(Fuse.HitTestContext htc) :565
void Rectangle__OnHitTestLocalVisual_fn(Rectangle* __this, ::g::Fuse::HitTestContext* htc)
{
    uStackFrame __("Fuse.Shapes.Rectangle", "OnHitTestLocalVisual(Fuse.HitTestContext)");
...
// public generated Rectangle() [instance] :535
void Rectangle::ctor_3()
{
    uStackFrame __("Fuse.Shapes.Rectangle", ".ctor()");
    ctor_2();
}

// public float4 get_CornerRadius() [instance] :543
::g::Uno::Float4 Rectangle::CornerRadius()
{
    uStackFrame __("Fuse.Shapes.Rectangle", "get_CornerRadius()");
    ::g::Uno::Float4 ret9;
    return (::g::Fuse::StyleProperty1__Get_fn(uPtr(Rectangle::CornerRadiusProperty()), this, &ret9), ret9);
}

// public void set_CornerRadius(float4 value) [instance] :544
void Rectangle::CornerRadius(::g::Uno::Float4 value)
{
    uStackFrame __("Fuse.Shapes.Rectangle", "set_CornerRadius(float4)");
    bool ret10;
    ::g::Fuse::StyleProperty1__Set_fn(uPtr(Rectangle::CornerRadiusProperty()), this, uCRef(value), &ret10);
}

// public generated Rectangle New() [static] :535
...
// private static void OnCornerRadiusChanged(Fuse.Shapes.Rectangle r) [static] :546
void Rectangle::OnCornerRadiusChanged(Rectangle* r)
{
    uStackFrame __("Fuse.Shapes.Rectangle", "OnCornerRadiusChanged(Fuse.Shapes.Rectangle)");
    Rectangle_typeof()->Init();
    uPtr(r)->InvalidateVisual();
}
// }

// ../../../../../../../usr/local/share/uno/Packages/Fuse.Shapes/0.24.6/$.uno(620)
// -------------------------------------------------------------------------------
...
void RegularPolygon__UpdatePath_fn(RegularPolygon* __this)
{
    ...
    __this->InvalidateRenderBounds();
    ::g::Uno::Float2 offset = (__this->ActualSize().X > __this->ActualSize().Y) ? ::g::Uno::Float2__New2((__this->ActualSize().X * 0.5f) - (__this->ActualSize().Y * 0.5f), 0.0f) : ::g::Uno::Float2__New2(0.0f, (__this->ActualSize().Y * 0.5f) - (__this->ActualSize().X * 0.5f));
    uPtr(__this->Renderer())->Geometry(::g::Fuse::Drawing::PathGeometryExtensions::RegularPolygon(::g::Fuse::Drawing::PathGeometry::New1()->MoveTo1(::g::Uno::Float2__op_Addition2(::g::Uno::Float2__New1(__this->Radius()), offset)), __this->_sides, __this->Radius()));
}

// public generated RegularPolygon() [instance] :620
void RegularPolygon::ctor_3()
{
    uStackFrame __("Fuse.Shapes.RegularPolygon", ".ctor()");
    _sides = 5;
    ctor_2();
}

// private float get_Radius() [instance] :624
float RegularPolygon::Radius()
{
    uStackFrame __("Fuse.Shapes.RegularPolygon", "get_Radius()");
    return ::g::Uno::Math::Min1(ActualSize().X, ActualSize().Y) * 0.5f;
}

// public int get_Sides() [instance] :630
int RegularPolygon::Sides()
{
    uStackFrame __("Fuse.Shapes.RegularPolygon", "get_Sides()");
    return _sides;
}

// public void set_Sides(int value) [instance] :631
void RegularPolygon::Sides(int value)
{
    uStackFrame __("Fuse.Shapes.RegularPolygon", "set_Sides(int)");
...
// public generated RegularPolygon New() [static] :620
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Shapes/0.24.6/$.uno(678)
// -------------------------------------------------------------------------------
...
static void Shape__cctor_2_fn(uType* __type)
{
    ...
    Shape::FillProperty_ = (::g::Fuse::StyleProperty1__New2_fn(::TYPES[26/*Fuse.StyleProperty<Fuse.Shapes.Shape, Fuse.Drawing.Brush>*/], NULL, NULL, uDelegate::New(::TYPES[27/*Uno.Action<Fuse.Shapes.Shape, Fuse.Drawing.Brush>*/], (void*)Shape__SetFill_fn), uDelegate::New(::TYPES[28/*Uno.Func<Fuse.Shapes.Shape, Fuse.Drawing.Brush>*/], (void*)Shape__GetFill_fn), &ret4), ret4);
    Shape::StrokeProperty_ = (::g::Fuse::StyleProperty1__New2_fn(::TYPES[29/*Fuse.StyleProperty<Fuse.Shapes.Shape, Fuse.Drawing.Stroke>*/], NULL, NULL, uDelegate::New(::TYPES[30/*Uno.Action<Fuse.Shapes.Shape, Fuse.Drawing.Stroke>*/], (void*)Shape__SetStroke_fn), uDelegate::New(::TYPES[31/*Uno.Func<Fuse.Shapes.Shape, Fuse.Drawing.Stroke>*/], (void*)Shape__GetStroke_fn), &ret5), ret5);
    Shape::SmoothnessProperty_ = (::g::Fuse::StyleProperty1__New2_fn(::TYPES[32/*Fuse.StyleProperty<Fuse.Shapes.Shape, float>*/], uCRef(1.0f), uDelegate::New(::TYPES[33/*Uno.Action<Fuse.Shapes.Shape>*/], (void*)Shape__OnSmoothnessChanged_fn), uDelegate::New(::TYPES[34/*Uno.Action<Fuse.Shapes.Shape, float>*/], (void*)Shape__SetSmoothness_fn), uDelegate::New(::TYPES[35/*Uno.Func<Fuse.Shapes.Shape, float>*/], (void*)Shape__GetSmoothness_fn), &ret6), ret6);
}
...
Shape_type* Shape_typeof()
{
    ...
    type->interface1.fp_get_DataContext = (void(*)(uObject*, uObject**))::g::Fuse::Node__get_DataContext_fn;
    type->interface1.fp_set_DataContext = (void(*)(uObject*, uObject*))::g::Fuse::Node__set_DataContext_fn;
    ::TYPES[26] = ::g::Fuse::StyleProperty1_typeof()->MakeType(Shape_typeof(), ::g::Fuse::Drawing::Brush_typeof());
    ::TYPES[27] = ::g::Uno::Action2_typeof()->MakeType(Shape_typeof(), ::g::Fuse::Drawing::Brush_typeof());
    ::TYPES[28] = ::g::Uno::Func1_typeof()->MakeType(Shape_typeof(), ::g::Fuse::Drawing::Brush_typeof());
    ::TYPES[29] = ::g::Fuse::StyleProperty1_typeof()->MakeType(Shape_typeof(), ::g::Fuse::Drawing::Stroke_typeof());
    ::TYPES[30] = ::g::Uno::Action2_typeof()->MakeType(Shape_typeof(), ::g::Fuse::Drawing::Stroke_typeof());
    ::TYPES[31] = ::g::Uno::Func1_typeof()->MakeType(Shape_typeof(), ::g::Fuse::Drawing::Stroke_typeof());
    ::TYPES[32] = ::g::Fuse::StyleProperty1_typeof()->MakeType(Shape_typeof(), ::g::Uno::Float_typeof());
    ::TYPES[33] = ::g::Uno::Action1_typeof()->MakeType(Shape_typeof());
    ::TYPES[34] = ::g::Uno::Action2_typeof()->MakeType(Shape_typeof(), ::g::Uno::Float_typeof());
    ::TYPES[35] = ::g::Uno::Func1_typeof()->MakeType(Shape_typeof(), ::g::Uno::Float_typeof());
    ...
    ::TYPES[1] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[38] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Drawing::Stroke_typeof());
    ::TYPES[39] = ::g::Fuse::Drawing::Stroke_typeof();
    ::TYPES[40] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Fuse::Drawing::Brush_typeof());
    ::TYPES[41] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Fuse::Drawing::Stroke_typeof());
    ::TYPES[42] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Drawing::Brush_typeof());
    ::TYPES[43] = ::g::Fuse::Drawing::DynamicBrush_typeof();
    ::TYPES[11] = ::g::Uno::Action_typeof();
    ::TYPES[44] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Drawing::Stroke_typeof());
    ::TYPES[45] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Drawing::Brush_typeof());
    ::TYPES[46] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Drawing::Brush_typeof());
    ::TYPES[47] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Drawing::Stroke_typeof());
    type->SetInterfaces(
        ...
        ::g::Fuse::Triggers::Actions::IShow_typeof(), offsetof(Shape_type, interface2),
        ::g::Fuse::Triggers::Actions::IHide_typeof(), offsetof(Shape_type, interface3),
        ::g::Fuse::Triggers::Actions::ICollapse_typeof(), offsetof(Shape_type, interface4),
        ::g::Fuse::IActualPlacement_typeof(), offsetof(Shape_type, interface5),
        ::g::Fuse::Animations::IResize_typeof(), offsetof(Shape_type, interface6));
    type->SetFields(87,
    ...
    type->Reflection.SetFields(3,
        new uField("FillProperty", 92),
        new uField("SmoothnessProperty", 93),
        new uField("StrokeProperty", 94));
...
void Shape__CalcRenderBounds_fn(Shape* __this, ::g::Uno::Rect* __retval)
{
    ...
    if (__this->HasStrokes())
        ...
        for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(__this->Strokes()), ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::TYPES[39/*Fuse.Drawing.Stroke*/]))); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::g::Uno::Collections::IEnumerator_typeof())); )
        {
            ::g::Fuse::Drawing::Stroke* stroke = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[38/*Uno.Collections.IEnumerator<Fuse.Drawing.Stroke>*/]), &ret7), ret7);
...
void Shape__OnDraw_fn(Shape* __this, ::g::Fuse::DrawContext* dc)
{
    ...
    if (__this->HasFills())
        ...
        {
            ::g::Fuse::Drawing::Brush* fill = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[42/*Uno.Collections.IEnumerator<Fuse.Drawing.Brush>*/]), &ret10), ret10);
            __this->DrawFill(dc, fill);
        }

    if (__this->HasStrokes())

        for (uObject* enum3 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(__this->Strokes()), ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::TYPES[39/*Fuse.Drawing.Stroke*/]))); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum3), ::g::Uno::Collections::IEnumerator_typeof())); )
        {
            ::g::Fuse::Drawing::Stroke* stroke = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum3), ::TYPES[38/*Uno.Collections.IEnumerator<Fuse.Drawing.Stroke>*/]), &ret11), ret11);
...
{
    uStackFrame __("Fuse.Shapes.Shape", "OnResetStyle()");
    bool ret12;
    ...
    if (__this->_styleStrokes != NULL)
    {
        for (int i1 = 0; i1 < uPtr(__this->_styleStrokes)->Count(); i1++)
            ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(__this->Strokes()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[39/*Fuse.Drawing.Stroke*/])), (::g::Uno::Collections::List__get_Item_fn(uPtr(__this->_styleStrokes), uCRef<int>(i1), &ret15), ret15), &ret14);
...
{
    uStackFrame __("Fuse.Shapes.Shape", "AddStyleFill(Fuse.Drawing.Brush)");

    if (_styleFills == NULL)
        _styleFills = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[36/*Uno.Collections.List<Fuse.Drawing.Brush>*/]));
...
{
    uStackFrame __("Fuse.Shapes.Shape", "AddStyleStroke(Fuse.Drawing.Stroke)");

    if (_styleStrokes == NULL)
        _styleStrokes = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[37/*Uno.Collections.List<Fuse.Drawing.Stroke>*/]));

    ::g::Uno::Collections::List__Add_fn(uPtr(_styleStrokes), s);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Strokes()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[39/*Fuse.Drawing.Stroke*/])), s);
}
...
uObject* Shape::Fills()
{
    ...
    if (_fills == NULL)
        _fills = ((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[40/*Uno.Collections.ObservableList<Fuse.Drawing.Brush>*/], uDelegate::New(::TYPES[45/*Uno.Action<Fuse.Drawing.Brush>*/], (void*)Shape__OnFillAdded_fn, this), uDelegate::New(::TYPES[45/*Uno.Action<Fuse.Drawing.Brush>*/], (void*)Shape__OnFillRemoved_fn, this)));
...
void Shape::OnFillAdded(::g::Fuse::Drawing::Brush* f)
{
    ...
    if (uIs(f, ::TYPES[43/*Fuse.Drawing.DynamicBrush*/]))
        uPtr(uCast< ::g::Fuse::Drawing::DynamicBrush*>(f, ::TYPES[43/*Fuse.Drawing.DynamicBrush*/]))->add_ShadingChanged(uDelegate::New(::TYPES[11/*Uno.Action*/], (void*)Shape__OnShadingChanged_fn, this));
...
void Shape::OnFillRemoved(::g::Fuse::Drawing::Brush* f)
{
    ...
    if (uIs(f, ::TYPES[43/*Fuse.Drawing.DynamicBrush*/]))
        uPtr(uCast< ::g::Fuse::Drawing::DynamicBrush*>(f, ::TYPES[43/*Fuse.Drawing.DynamicBrush*/]))->remove_ShadingChanged(uDelegate::New(::TYPES[11/*Uno.Action*/], (void*)Shape__OnShadingChanged_fn, this));
...
{
    uStackFrame __("Fuse.Shapes.Shape", "OnShadingChanged()");
    InvalidateVisual();
}
...
void Shape::OnStrokeAdded(::g::Fuse::Drawing::Stroke* s)
{
    ...
    s->add_StrokeChanged(uDelegate::New(::TYPES[44/*Uno.Action<Fuse.Drawing.Stroke>*/], (void*)Shape__OnStrokeChanged_fn, this));
    OnStrokeChanged(s);
}
...
{
    uStackFrame __("Fuse.Shapes.Shape", "OnStrokeChanged(Fuse.Drawing.Stroke)");
    InvalidateVisual();
}
...
void Shape::OnStrokeRemoved(::g::Fuse::Drawing::Stroke* s)
{
    ...
    s->remove_StrokeChanged(uDelegate::New(::TYPES[44/*Uno.Action<Fuse.Drawing.Stroke>*/], (void*)Shape__OnStrokeChanged_fn, this));
    OnStrokeChanged(s);
}
...
uObject* Shape::Strokes()
{
    ...
    if (_strokes == NULL)
        _strokes = ((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[41/*Uno.Collections.ObservableList<Fuse.Drawing.Stroke>*/], uDelegate::New(::TYPES[44/*Uno.Action<Fuse.Drawing.Stroke>*/], (void*)Shape__OnStrokeAdded_fn, this), uDelegate::New(::TYPES[44/*Uno.Action<Fuse.Drawing.Stroke>*/], (void*)Shape__OnStrokeRemoved_fn, this)));
...
{
    uStackFrame __("Fuse.Shapes.Shape", "GetSmoothness(Fuse.Shapes.Shape)");
    Shape_typeof()->Init();
...
{
    uStackFrame __("Fuse.Shapes.Shape", "OnSmoothnessChanged(Fuse.Shapes.Shape)");
    Shape_typeof()->Init();
...
{
    uStackFrame __("Fuse.Shapes.Shape", "SetSmoothness(Fuse.Shapes.Shape,float)");
    Shape_typeof()->Init();
...
void Shape::SetStroke(Shape* s, ::g::Fuse::Drawing::Stroke* value)
{
    ...
    Shape_typeof()->Init();
    ::g::Uno::Collections::ICollection::Clear(uInterface(uPtr(uPtr(s)->Strokes()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[39/*Fuse.Drawing.Stroke*/])));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(s->Strokes()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[39/*Fuse.Drawing.Stroke*/])), value);
}
// }

// ../../../../../../../usr/local/share/uno/Packages/Fuse.Shapes/0.24.6/$.uno(1015)
// --------------------------------------------------------------------------------
...
// public generated Star() [instance] :1015
void Star::ctor_3()
{
    uStackFrame __("Fuse.Shapes.Star", ".ctor()");
    _points = 5;
    _ratio = 0.5f;
    _degrees = 0.0f;
    ctor_2();
...
// private float2 get__offset() [instance] :1019
::g::Uno::Float2 Star::_offset()
{
    uStackFrame __("Fuse.Shapes.Star", "get__offset()");
...
// public int get_Points() [instance] :1035
int Star::Points()
{
    uStackFrame __("Fuse.Shapes.Star", "get_Points()");
    return _points;
}

// public void set_Points(int value) [instance] :1036
void Star::Points(int value)
{
    uStackFrame __("Fuse.Shapes.Star", "set_Points(int)");
...
// private float get_Radius() [instance] :1029
float Star::Radius()
{
    uStackFrame __("Fuse.Shapes.Star", "get_Radius()");
    return ::g::Uno::Math::Min1(ActualSize().X, ActualSize().Y) * 0.5f;
}

// public float get_Ratio() [instance] :1047
float Star::Ratio()
{
    uStackFrame __("Fuse.Shapes.Star", "get_Ratio()");
    return _ratio;
}

// public void set_Ratio(float value) [instance] :1048
void Star::Ratio(float value)
{
    uStackFrame __("Fuse.Shapes.Star", "set_Ratio(float)");
...
// public float get_RotationDegrees() [instance] :1084
float Star::RotationDegrees()
{
    uStackFrame __("Fuse.Shapes.Star", "get_RotationDegrees()");
    return _degrees;
}

// public void set_RotationDegrees(float value) [instance] :1085
void Star::RotationDegrees(float value)
{
    uStackFrame __("Fuse.Shapes.Star", "set_RotationDegrees(float)");
...
// private float get_RotationRadians() [instance] :1096
float Star::RotationRadians()
{
    uStackFrame __("Fuse.Shapes.Star", "get_RotationRadians()");
    return (_degrees / 180.0f) * 3.14159274f;
}

// public float get_RoundRatio() [instance] :1060
float Star::RoundRatio()
{
    uStackFrame __("Fuse.Shapes.Star", "get_RoundRatio()");
    return _roundRatio;
}

// public void set_RoundRatio(float value) [instance] :1061
void Star::RoundRatio(float value)
{
    uStackFrame __("Fuse.Shapes.Star", "set_RoundRatio(float)");
...
// private float get_SpokeRadius() [instance] :1072
float Star::SpokeRadius()
{
    uStackFrame __("Fuse.Shapes.Star", "get_SpokeRadius()");
    return Radius() * Ratio();
}

// public generated Star New() [static] :1015
Star* Star::New1()
{

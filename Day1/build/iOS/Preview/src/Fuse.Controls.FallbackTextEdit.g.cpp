...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Controls/0.24.6/FallbackTextEdit/$.uno(710)
// --------------------------------------------------------------------------------------------------
...
// public bool IsWithinBounds(float x) :719
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual.DegreeSpan", ".ctor(float,float)");
    _a = a;
    _b = b;
}

// public bool IsWithinBounds(float x) [instance] :719
bool TextEditVisual__DegreeSpan::IsWithinBounds(float x)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual.DegreeSpan", "IsWithinBounds(float)");
    float angle1 = _a;
    float angle2 = _b;
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Controls/0.24.6/FallbackTextEdit/$.uno(222)
// --------------------------------------------------------------------------------------------------
...
// public LineCache(Uno.Action onTextChanged, Uno.Action invalideLayout) :296
...
// public Fuse.Controls.FallbackTextEdit.TextPosition BoundsToTextPos(Fuse.Controls.Internal.WordWrapInfo wrapInfo, Fuse.Elements.TextAlignment textAlignment, float boundsWidth, float2 p) :574
...
// public Fuse.Controls.FallbackTextEdit.TextPosition End(Fuse.Controls.Internal.WordWrapInfo wrapInfo, Fuse.Controls.FallbackTextEdit.TextPosition p) :554
...
// public string GetString(Fuse.Controls.FallbackTextEdit.TextSpan s) :616
...
// public Fuse.Controls.FallbackTextEdit.TextPosition Home(Fuse.Controls.Internal.WordWrapInfo wrapInfo, Fuse.Controls.FallbackTextEdit.TextPosition p) :549
...
// public Fuse.Controls.FallbackTextEdit.TextPosition InsertNewline(Fuse.Controls.FallbackTextEdit.TextPosition p) :311
...
// private bool IsWordBreaker(char c) :519
...
// public LineCache New(Uno.Action onTextChanged, Uno.Action invalideLayout) :296
...
// private int NextWordLeft(string str, int startIdx) :439
...
// private int NextWordRight(string str, int startIdx) :486
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryBackspace(Fuse.Controls.FallbackTextEdit.TextPosition p) :343
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryDelete(Fuse.Controls.FallbackTextEdit.TextPosition p) :321
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveDown(Fuse.Controls.Internal.WordWrapInfo wrapInfo, Fuse.Elements.TextAlignment textAlignment, float boundsWidth, Fuse.Controls.FallbackTextEdit.TextPosition p) :540
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveLeft(Fuse.Controls.FallbackTextEdit.TextPosition p) :399
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveOneWordLeft(Fuse.Controls.FallbackTextEdit.TextPosition p) :425
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveOneWordRight(Fuse.Controls.FallbackTextEdit.TextPosition p) :472
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveRight(Fuse.Controls.FallbackTextEdit.TextPosition p) :412
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveUp(Fuse.Controls.Internal.WordWrapInfo wrapInfo, Fuse.Elements.TextAlignment textAlignment, float boundsWidth, Fuse.Controls.FallbackTextEdit.TextPosition p) :531
...
// public LineCache(Uno.Action onTextChanged, Uno.Action invalideLayout) [instance] :296
...
// public Fuse.Controls.FallbackTextEdit.TextPosition BoundsToTextPos(Fuse.Controls.Internal.WordWrapInfo wrapInfo, Fuse.Elements.TextAlignment textAlignment, float boundsWidth, float2 p) [instance] :574
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCache", "BoundsToTextPos(Fuse.Controls.Internal.WordWrapInfo,Fuse.Elements.TextAlignment,float,float2)");
...
// public Fuse.Controls.FallbackTextEdit.TextPosition End(Fuse.Controls.Internal.WordWrapInfo wrapInfo, Fuse.Controls.FallbackTextEdit.TextPosition p) [instance] :554
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCache", "End(Fuse.Controls.Internal.WordWrapInfo,Fuse.Controls.FallbackTextEdit.TextPosition)");
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCache", "GetBoundsSize(Fuse.Controls.Internal.WordWrapInfo)");
    uArray* array3;
    int index4;
    int length5;
...
// public string GetString(Fuse.Controls.FallbackTextEdit.TextSpan s) [instance] :616
...
// public Fuse.Controls.FallbackTextEdit.TextPosition Home(Fuse.Controls.Internal.WordWrapInfo wrapInfo, Fuse.Controls.FallbackTextEdit.TextPosition p) [instance] :549
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCache", "Home(Fuse.Controls.Internal.WordWrapInfo,Fuse.Controls.FallbackTextEdit.TextPosition)");
...
// public Fuse.Controls.FallbackTextEdit.TextPosition InsertNewline(Fuse.Controls.FallbackTextEdit.TextPosition p) [instance] :311
...
// private bool IsWordBreaker(char c) [instance] :519
...
// private int NextWordLeft(string str, int startIdx) [instance] :439
...
// private int NextWordRight(string str, int startIdx) [instance] :486
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCache", "TextPosToBounds(Fuse.Controls.Internal.WordWrapInfo,Fuse.Elements.TextAlignment,float,Fuse.Controls.FallbackTextEdit.TextPosition)");
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryBackspace(Fuse.Controls.FallbackTextEdit.TextPosition p) [instance] :343
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryDelete(Fuse.Controls.FallbackTextEdit.TextPosition p) [instance] :321
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveDown(Fuse.Controls.Internal.WordWrapInfo wrapInfo, Fuse.Elements.TextAlignment textAlignment, float boundsWidth, Fuse.Controls.FallbackTextEdit.TextPosition p) [instance] :540
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCache", "TryMoveDown(Fuse.Controls.Internal.WordWrapInfo,Fuse.Elements.TextAlignment,float,Fuse.Controls.FallbackTextEdit.TextPosition)");
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveLeft(Fuse.Controls.FallbackTextEdit.TextPosition p) [instance] :399
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveOneWordLeft(Fuse.Controls.FallbackTextEdit.TextPosition p) [instance] :425
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveOneWordRight(Fuse.Controls.FallbackTextEdit.TextPosition p) [instance] :472
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveRight(Fuse.Controls.FallbackTextEdit.TextPosition p) [instance] :412
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveUp(Fuse.Controls.Internal.WordWrapInfo wrapInfo, Fuse.Elements.TextAlignment textAlignment, float boundsWidth, Fuse.Controls.FallbackTextEdit.TextPosition p) [instance] :531
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCache", "TryMoveUp(Fuse.Controls.Internal.WordWrapInfo,Fuse.Elements.TextAlignment,float,Fuse.Controls.FallbackTextEdit.TextPosition)");
    ::g::Uno::Float2 lineBounds = TextPosToBounds(wrapInfo, textAlignment, boundsWidth, p);
...
// public LineCache New(Uno.Action onTextChanged, Uno.Action invalideLayout) [static] :296
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Controls/0.24.6/FallbackTextEdit/$.uno(12)
// -------------------------------------------------------------------------------------------------
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCacheLine", "BoundsToPos(Fuse.Controls.Internal.WordWrapInfo,Fuse.Elements.TextAlignment,float,float2)");
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCacheLine", "BoundsToWrappedLine(Fuse.Controls.Internal.WordWrapInfo,float2)");
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCacheLine", "End(Fuse.Controls.Internal.WordWrapInfo,int)");
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCacheLine", "GetTotalHeight(Fuse.Controls.Internal.WordWrapInfo)");
    uArray* wrappedLines = GetWrappedLines(wrapInfo);
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCacheLine", "GetWrappedLines(Fuse.Controls.Internal.WordWrapInfo)");
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCacheLine", "Home(Fuse.Controls.Internal.WordWrapInfo,int)");
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCacheLine", "PosToBounds(Fuse.Controls.Internal.WordWrapInfo,Fuse.Elements.TextAlignment,float,int)");
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCacheLine", "PosToWrappedLine(Fuse.Controls.Internal.WordWrapInfo,int)");
    uArray* wrappedLines = GetWrappedLines(wrapInfo);
...
uString* LineCacheLine::VisualText()
{
    ...
    if (_transform != NULL)
        return ::g::Fuse::Controls::FallbackTextEdit::LineCacheTransform::Transform(uInterface(uPtr(_transform), ::TYPES[55/*Fuse.Controls.FallbackTextEdit.LineCacheTransform*/]), _text);
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Controls/0.24.6/FallbackTextEdit/$.uno(183)
// --------------------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Controls/0.24.6/FallbackTextEdit/$.uno(178)
// --------------------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Controls/0.24.6/FallbackTextEdit/$.uno(734)
// --------------------------------------------------------------------------------------------------
...
// public bool IsWithinBounds(float2 vector) :743
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual.SwipeGestureHelper", ".ctor(float,Fuse.Controls.FallbackTextEdit.TextEditVisual.DegreeSpan[])");
    _spans = spans;
    _lengthThreshold = lengthThreshold;
}

// public bool IsWithinBounds(float2 vector) [instance] :743
bool TextEditVisual__SwipeGestureHelper::IsWithinBounds(::g::Uno::Float2 vector)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual.SwipeGestureHelper", "IsWithinBounds(float2)");
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Controls/0.24.6/FallbackTextEdit/$.uno(702)
// --------------------------------------------------------------------------------------------------
...
::g::Fuse::Controls::Graphics::ControlVisual_type* TextEditVisual_typeof()
{
    ...
    ::TYPES[11] = ::g::Fuse::Controls::Internal::WordWrapInfo_typeof();
    ::TYPES[44] = ::g::Fuse::LayoutParams_typeof();
    ...
    ::TYPES[54] = ::g::Uno::UX::ValueChangedArgs_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[55] = ::g::Fuse::Controls::FallbackTextEdit::LineCacheTransform_typeof();
    type->SetInterfaces(
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "Attach()");
...
// private void BringCaretIntoView(Fuse.Controls.Internal.WordWrapInfo wrapInfo, float textBoundsWidth) :1048
...
// private float2 ControlToWindow(float2 p) :1079
...
// private Fuse.Controls.Internal.WordWrapInfo CreateWrapInfo(float wrapWidth, bool haveWidth) :929
...
// private void DeleteSelection() :1067
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "Detach()");
...
// private void DrawCaret(Fuse.Controls.Internal.WordWrapInfo wrapInfo, float textBoundsWidth, Fuse.DrawContext dc) :978
...
// private Uno.Rect GetCaretRect(Fuse.Controls.Internal.WordWrapInfo wrapInfo, float textBoundsWidth) :1059
...
// private Uno.Rect GetClampedTextBoundsRect(Fuse.Controls.Internal.WordWrapInfo wrapInfo) :995
...
// private float2 GetClampedTextBoundsSize(Fuse.Controls.Internal.WordWrapInfo wrapInfo) :1000
...
// public override sealed Fuse.Node GetSubNode(int index) :905
void TextEditVisual__GetSubNode_fn(TextEditVisual* __this, int* index, ::g::Fuse::Node** __retval)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "GetSubNode(int)");
    int ret21;
    int index_ = *index;
    ::g::Fuse::Node* ret22;
...
// private float2 GetTextBoundsSize(Fuse.Controls.Internal.WordWrapInfo wrapInfo) :1005
...
// private void HandleLeftArrow(Fuse.Input.KeyPressedArgs args) :1408
...
// private void HandleRightArrow(Fuse.Input.KeyPressedArgs args) :1441
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "OnArrangeMarginBox(float2,Fuse.LayoutParams)");
    ::g::Uno::Float2 ret23;
...
// protected override sealed void OnDraw(Fuse.DrawContext dc) :953
void TextEditVisual__OnDraw_fn(TextEditVisual* __this, ::g::Fuse::DrawContext* dc)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "OnDraw(Fuse.DrawContext)");
...
// private void OnGotFocus(object sender, Fuse.Input.FocusGainedArgs args) :1109
...
// protected override sealed void OnHitTest(Fuse.HitTestContext htc) :1525
void TextEditVisual__OnHitTest_fn(TextEditVisual* __this, ::g::Fuse::HitTestContext* htc)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "OnHitTest(Fuse.HitTestContext)");
...
// private void OnKeyPressed(object sender, Fuse.Input.KeyPressedArgs args) :1279
...
// private void OnLostCapture() :1154
void TextEditVisual__OnLostCapture_fn(TextEditVisual* __this)
{
    __this->OnLostCapture();
}

// private void OnLostFocus(object sender, Fuse.Input.FocusLostArgs args) :1129
...
// private void OnPointerMoved(object sender, Fuse.Input.PointerMovedArgs c) :1183
...
// private void OnPointerPressed(object sender, Fuse.Input.PointerPressedArgs c) :1164
...
// private void OnPointerReleased(object sender, Fuse.Input.PointerReleasedArgs c) :1212
...
// private void OnTextEdited() :882
void TextEditVisual__OnTextEdited_fn(TextEditVisual* __this)
{
    __this->OnTextEdited();
}

// private void OnTextEntered(object sender, Fuse.Input.TextEnteredArgs args) :1247
...
// private void OnUpdate(object s, object a) :1124
void TextEditVisual__OnUpdate_fn(TextEditVisual* __this, uObject* s, uObject* a)
{
    __this->OnUpdate(s, a);
}

// private void OnValueChanged(object sender, Uno.UX.ValueChangedArgs<string> args) :837
...
// private void ResetCaretBlink() :1032
void TextEditVisual__ResetCaretBlink_fn(TextEditVisual* __this)
{
    __this->ResetCaretBlink();
}

// private void ResetWindowPosition() :1021
void TextEditVisual__ResetWindowPosition_fn(TextEditVisual* __this)
{
    __this->ResetWindowPosition();
}

// private void Select(Fuse.Controls.FallbackTextEdit.TextPosition oldCaretPos, Fuse.Controls.FallbackTextEdit.TextPosition newCaretPos, bool shouldSelect) :1474
...
// public void SelectAll() :893
void TextEditVisual__SelectAll_fn(TextEditVisual* __this)
{
    __this->SelectAll();
}

// public string get_SelectedText() :856
void TextEditVisual__get_SelectedText_fn(TextEditVisual* __this, uString** __retval)
{
    *__retval = __this->SelectedText();
}

// private void SelectFunc(Fuse.Controls.FallbackTextEdit.TextPosition oldCaretPos, Fuse.Controls.FallbackTextEdit.TextPosition newCaretPos) :1486
...
// private float2 TextBoundsToWindow(float2 p) :1094
...
// private float2 WindowToControl(float2 p) :1084
...
// private float2 WindowToTextBounds(float2 p) :1089
...
// public TextEditVisual() [instance] :858
void TextEditVisual::ctor_3()
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", ".ctor()");
    RevealTime = 2.0;
...
// private void BringCaretIntoView(Fuse.Controls.Internal.WordWrapInfo wrapInfo, float textBoundsWidth) [instance] :1048
void TextEditVisual::BringCaretIntoView(::g::Fuse::Controls::Internal::WordWrapInfo* wrapInfo, float textBoundsWidth)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "BringCaretIntoView(Fuse.Controls.Internal.WordWrapInfo,float)");
...
// private void ClearPasswordReveal() [instance] :1272
void TextEditVisual::ClearPasswordReveal()
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "ClearPasswordReveal()");
...
// private float2 ControlToTextBounds(float2 p) [instance] :1099
::g::Uno::Float2 TextEditVisual::ControlToTextBounds(::g::Uno::Float2 p)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "ControlToTextBounds(float2)");
    return WindowToTextBounds(ControlToWindow(p));
}

// private float2 ControlToWindow(float2 p) [instance] :1079
::g::Uno::Float2 TextEditVisual::ControlToWindow(::g::Uno::Float2 p)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "ControlToWindow(float2)");
    return p;
}

// private Fuse.Controls.Internal.WordWrapInfo CreateWrapInfo(float wrapWidth, bool haveWidth) [instance] :929
::g::Fuse::Controls::Internal::WordWrapInfo* TextEditVisual::CreateWrapInfo(float wrapWidth, bool haveWidth)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "CreateWrapInfo(float,bool)");
...
// private void DeleteSelection() [instance] :1067
void TextEditVisual::DeleteSelection()
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "DeleteSelection()");
...
// private void DrawCaret(Fuse.Controls.Internal.WordWrapInfo wrapInfo, float textBoundsWidth, Fuse.DrawContext dc) [instance] :978
void TextEditVisual::DrawCaret(::g::Fuse::Controls::Internal::WordWrapInfo* wrapInfo, float textBoundsWidth, ::g::Fuse::DrawContext* dc)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "DrawCaret(Fuse.Controls.Internal.WordWrapInfo,float,Fuse.DrawContext)");
    ::g::Uno::Float4 ind4;
...
// private Uno.Rect GetCaretRect(Fuse.Controls.Internal.WordWrapInfo wrapInfo, float textBoundsWidth) [instance] :1059
::g::Uno::Rect TextEditVisual::GetCaretRect(::g::Fuse::Controls::Internal::WordWrapInfo* wrapInfo, float textBoundsWidth)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "GetCaretRect(Fuse.Controls.Internal.WordWrapInfo,float)");
...
// private Uno.Rect GetClampedTextBoundsRect(Fuse.Controls.Internal.WordWrapInfo wrapInfo) [instance] :995
::g::Uno::Rect TextEditVisual::GetClampedTextBoundsRect(::g::Fuse::Controls::Internal::WordWrapInfo* wrapInfo)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "GetClampedTextBoundsRect(Fuse.Controls.Internal.WordWrapInfo)");
    return ::g::Uno::Rect__New2(::g::Uno::Float2__New1(0.0f), GetClampedTextBoundsSize(wrapInfo));
}

// private float2 GetClampedTextBoundsSize(Fuse.Controls.Internal.WordWrapInfo wrapInfo) [instance] :1000
::g::Uno::Float2 TextEditVisual::GetClampedTextBoundsSize(::g::Fuse::Controls::Internal::WordWrapInfo* wrapInfo)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "GetClampedTextBoundsSize(Fuse.Controls.Internal.WordWrapInfo)");
    return ::g::Uno::Math::Max3(GetTextBoundsSize(wrapInfo), ActualSize());
}

// private Fuse.Font GetFontOrThrow() [instance] :946
::g::Fuse::Font* TextEditVisual::GetFontOrThrow()
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "GetFontOrThrow()");
...
// private float2 GetTextBoundsSize(Fuse.Controls.Internal.WordWrapInfo wrapInfo) [instance] :1005
::g::Uno::Float2 TextEditVisual::GetTextBoundsSize(::g::Fuse::Controls::Internal::WordWrapInfo* wrapInfo)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "GetTextBoundsSize(Fuse.Controls.Internal.WordWrapInfo)");
    return uPtr(_lineCache)->GetBoundsSize(wrapInfo);
}

// private void HandleLeftArrow(Fuse.Input.KeyPressedArgs args) [instance] :1408
void TextEditVisual::HandleLeftArrow(::g::Fuse::Input::KeyPressedArgs* args)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "HandleLeftArrow(Fuse.Input.KeyPressedArgs)");
...
// private void HandleRightArrow(Fuse.Input.KeyPressedArgs args) [instance] :1441
void TextEditVisual::HandleRightArrow(::g::Fuse::Input::KeyPressedArgs* args)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "HandleRightArrow(Fuse.Input.KeyPressedArgs)");
...
// private void InvalidateLineCacheLayout() [instance] :877
void TextEditVisual::InvalidateLineCacheLayout()
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "InvalidateLineCacheLayout()");
    InvalidateLayout(2);
}

// private bool get_IsWordWrapEnabled() [instance] :891
bool TextEditVisual::IsWordWrapEnabled()
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "get_IsWordWrapEnabled()");
...
// private void MoveSelection(float2 windowPoint) [instance] :1239
void TextEditVisual::MoveSelection(::g::Uno::Float2 windowPoint)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "MoveSelection(float2)");
...
// private void OnGotFocus(object sender, Fuse.Input.FocusGainedArgs args) [instance] :1109
void TextEditVisual::OnGotFocus(uObject* sender, ::g::Fuse::Input::FocusGainedArgs* args)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "OnGotFocus(object,Fuse.Input.FocusGainedArgs)");
    InvalidateLayout(2);
    InvalidateVisual();
    _selection = NULL;
...
// private void OnKeyPressed(object sender, Fuse.Input.KeyPressedArgs args) [instance] :1279
void TextEditVisual::OnKeyPressed(uObject* sender, ::g::Fuse::Input::KeyPressedArgs* args)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "OnKeyPressed(object,Fuse.Input.KeyPressedArgs)");
...
// private void OnLostCapture() [instance] :1154
void TextEditVisual::OnLostCapture()
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "OnLostCapture()");
    ::g::Fuse::Input::Focus::ReleaseFrom(this);
    _selection = NULL;
    _down = -1;
}

// private void OnLostFocus(object sender, Fuse.Input.FocusLostArgs args) [instance] :1129
void TextEditVisual::OnLostFocus(uObject* sender, ::g::Fuse::Input::FocusLostArgs* args)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "OnLostFocus(object,Fuse.Input.FocusLostArgs)");
...
// private void OnPointerMoved(object sender, Fuse.Input.PointerMovedArgs c) [instance] :1183
void TextEditVisual::OnPointerMoved(uObject* sender, ::g::Fuse::Input::PointerMovedArgs* c)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "OnPointerMoved(object,Fuse.Input.PointerMovedArgs)");
...
// private void OnPointerPressed(object sender, Fuse.Input.PointerPressedArgs c) [instance] :1164
void TextEditVisual::OnPointerPressed(uObject* sender, ::g::Fuse::Input::PointerPressedArgs* c)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "OnPointerPressed(object,Fuse.Input.PointerPressedArgs)");
...
// private void OnPointerReleased(object sender, Fuse.Input.PointerReleasedArgs c) [instance] :1212
void TextEditVisual::OnPointerReleased(uObject* sender, ::g::Fuse::Input::PointerReleasedArgs* c)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "OnPointerReleased(object,Fuse.Input.PointerReleasedArgs)");
...
// private void OnTextEdited() [instance] :882
void TextEditVisual::OnTextEdited()
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "OnTextEdited()");
...
// private void OnTextEntered(object sender, Fuse.Input.TextEnteredArgs args) [instance] :1247
void TextEditVisual::OnTextEntered(uObject* sender, ::g::Fuse::Input::TextEnteredArgs* args)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "OnTextEntered(object,Fuse.Input.TextEnteredArgs)");
    uString* array1;
    int index2;
    int length3;
    DeleteSelection();
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "OnTextLayoutPropertyChanged(object,Uno.EventArgs)");
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "OnTextRenderPropertyChanged(object,Uno.EventArgs)");
...
// private void OnUpdate(object s, object a) [instance] :1124
void TextEditVisual::OnUpdate(uObject* s, uObject* a)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "OnUpdate(object,object)");
    InvalidateVisual();
}

// private void OnValueChanged(object sender, Uno.UX.ValueChangedArgs<string> args) [instance] :837
void TextEditVisual::OnValueChanged(uObject* sender, ::g::Uno::UX::ValueChangedArgs* args)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "OnValueChanged(object,Uno.UX.ValueChangedArgs<string>)");
    uString* ret39;
...
// private void ResetCaretBlink() [instance] :1032
void TextEditVisual::ResetCaretBlink()
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "ResetCaretBlink()");
    _caretBlinkTime = ::g::Fuse::Time::FrameTime();
}

// private void ResetWindowPosition() [instance] :1021
void TextEditVisual::ResetWindowPosition()
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "ResetWindowPosition()");
    SetWindowPos(::g::Uno::Float2__New1(0.0f));
}

// private void Select(Fuse.Controls.FallbackTextEdit.TextPosition oldCaretPos, Fuse.Controls.FallbackTextEdit.TextPosition newCaretPos, bool shouldSelect) [instance] :1474
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "Select(Fuse.Controls.FallbackTextEdit.TextPosition,Fuse.Controls.FallbackTextEdit.TextPosition,bool)");
...
// public void SelectAll() [instance] :893
void TextEditVisual::SelectAll()
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "SelectAll()");
    _selection = uPtr(_lineCache)->GetFullTextSpan();
    _caretPosition = uPtr(_lineCache)->GetLastTextPos();
    InvalidateVisual();
}

// public string get_SelectedText() [instance] :856
uString* TextEditVisual::SelectedText()
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "get_SelectedText()");
...
// private void SelectFunc(Fuse.Controls.FallbackTextEdit.TextPosition oldCaretPos, Fuse.Controls.FallbackTextEdit.TextPosition newCaretPos) [instance] :1486
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "SelectFunc(Fuse.Controls.FallbackTextEdit.TextPosition,Fuse.Controls.FallbackTextEdit.TextPosition)");
...
// private void SetCaretPos(float2 p) [instance] :1037
void TextEditVisual::SetCaretPos(::g::Uno::Float2 p)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "SetCaretPos(float2)");
...
// private void SetWindowPos(float2 p) [instance] :1014
void TextEditVisual::SetWindowPos(::g::Uno::Float2 p)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "SetWindowPos(float2)");
...
// private void StartSelection(float2 windowPoint) [instance] :1230
void TextEditVisual::StartSelection(::g::Uno::Float2 windowPoint)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "StartSelection(float2)");
    SetCaretPos(WindowToLocal(windowPoint));
    ResetCaretBlink();
    _selection = NULL;
    _interactionSelectionStartPos = _caretPosition;
...
// private float2 TextBoundsToControl(float2 p) [instance] :1104
::g::Uno::Float2 TextEditVisual::TextBoundsToControl(::g::Uno::Float2 p)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "TextBoundsToControl(float2)");
    return WindowToControl(TextBoundsToWindow(p));
}

// private float2 TextBoundsToWindow(float2 p) [instance] :1094
::g::Uno::Float2 TextEditVisual::TextBoundsToWindow(::g::Uno::Float2 p)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "TextBoundsToWindow(float2)");
    return ::g::Uno::Float2__op_Subtraction2(p, _windowPos);
}

// private void TransformUpdate(object s, object a) [instance] :1532
void TextEditVisual::TransformUpdate(uObject* s, uObject* a)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "TransformUpdate(object,object)");
...
// private void UpdateValue(string value) [instance] :844
void TextEditVisual::UpdateValue(uString* value)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "UpdateValue(string)");
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "get_VisualTextTransform()");
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "set_VisualTextTransform(Fuse.Controls.FallbackTextEdit.VisualTextTransform)");
...
// private float2 WindowToControl(float2 p) [instance] :1084
::g::Uno::Float2 TextEditVisual::WindowToControl(::g::Uno::Float2 p)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "WindowToControl(float2)");
    return p;
}

// private float2 WindowToTextBounds(float2 p) [instance] :1089
::g::Uno::Float2 TextEditVisual::WindowToTextBounds(::g::Uno::Float2 p)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextEditVisual", "WindowToTextBounds(float2)");
    return ::g::Uno::Float2__op_Addition2(p, _windowPos);
}

// public TextEditVisual New() [static] :858
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Controls/0.24.6/FallbackTextEdit/$.uno(1551)
// ---------------------------------------------------------------------------------------------------

// internal sealed class TextPosition :1551
// {
// static TextPosition() :1551
...
// public TextPosition(int l, int c) :1630
void TextPosition__ctor__fn(TextPosition* __this, int* l, int* c)
{
    __this->ctor_(*l, *c);
}

// public override sealed bool Equals(object obj) :1636
...
// public override sealed int GetHashCode() :1647
...
// public static Fuse.Controls.FallbackTextEdit.TextPosition Max(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) :1623
void TextPosition__Max_fn(TextPosition* a, TextPosition* b, TextPosition** __retval)
{
    *__retval = TextPosition::Max(a, b);
}

// public static Fuse.Controls.FallbackTextEdit.TextPosition Min(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) :1618
void TextPosition__Min_fn(TextPosition* a, TextPosition* b, TextPosition** __retval)
{
    *__retval = TextPosition::Min(a, b);
}

// public TextPosition New(int l, int c) :1630
void TextPosition__New1_fn(int* l, int* c, TextPosition** __retval)
{
    *__retval = TextPosition::New1(*l, *c);
}

// public static operator ==(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) :1555
void TextPosition__op_Equality_fn(TextPosition* a, TextPosition* b, bool* __retval)
{
    *__retval = TextPosition::op_Equality(a, b);
}

// public static operator >(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) :1596
void TextPosition__op_GreaterThan_fn(TextPosition* a, TextPosition* b, bool* __retval)
{
    *__retval = TextPosition::op_GreaterThan(a, b);
}

// public static operator >=(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) :1607
...
// public static operator !=(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) :1569
void TextPosition__op_Inequality_fn(TextPosition* a, TextPosition* b, bool* __retval)
{
    *__retval = TextPosition::op_Inequality(a, b);
}

// public static operator <(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) :1574
void TextPosition__op_LessThan_fn(TextPosition* a, TextPosition* b, bool* __retval)
{
    *__retval = TextPosition::op_LessThan(a, b);
}

// public static operator <=(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) :1585
...
// public TextPosition(int l, int c) [instance] :1630
...
// public static Fuse.Controls.FallbackTextEdit.TextPosition Max(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) [static] :1623
...
// public static Fuse.Controls.FallbackTextEdit.TextPosition Min(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) [static] :1618
...
// public TextPosition New(int l, int c) [static] :1630
...
// public static operator ==(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) [static] :1555
...
// public static operator >(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) [static] :1596
...
// public static operator >=(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) [static] :1607
...
// public static operator !=(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) [static] :1569
...
// public static operator <(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) [static] :1574
...
// public static operator <=(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) [static] :1585
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Controls/0.24.6/FallbackTextEdit/$.uno(1653)
// ---------------------------------------------------------------------------------------------------

// internal sealed class TextSpan :1653
// {
...
// public TextSpan(Fuse.Controls.FallbackTextEdit.TextPosition start, Fuse.Controls.FallbackTextEdit.TextPosition end) :1688
...
// public bool Contains(Fuse.Controls.FallbackTextEdit.TextPosition p) :1711
...
// public override sealed bool Equals(object obj) :1695
...
// public override sealed int GetHashCode() :1706
...
// public static Fuse.Controls.FallbackTextEdit.TextSpan Intersection(Fuse.Controls.FallbackTextEdit.TextSpan a, Fuse.Controls.FallbackTextEdit.TextSpan b) :1679
void TextSpan__Intersection_fn(TextSpan* a, TextSpan* b, TextSpan** __retval)
{
    *__retval = TextSpan::Intersection(a, b);
}

// public static bool Intersects(Fuse.Controls.FallbackTextEdit.TextSpan a, Fuse.Controls.FallbackTextEdit.TextSpan b) :1674
void TextSpan__Intersects_fn(TextSpan* a, TextSpan* b, bool* __retval)
{
    *__retval = TextSpan::Intersects(a, b);
}

// public TextSpan New(Fuse.Controls.FallbackTextEdit.TextPosition start, Fuse.Controls.FallbackTextEdit.TextPosition end) :1688
...
// public static operator ==(Fuse.Controls.FallbackTextEdit.TextSpan a, Fuse.Controls.FallbackTextEdit.TextSpan b) :1655
void TextSpan__op_Equality_fn(TextSpan* a, TextSpan* b, bool* __retval)
{
    *__retval = TextSpan::op_Equality(a, b);
}

// public static operator !=(Fuse.Controls.FallbackTextEdit.TextSpan a, Fuse.Controls.FallbackTextEdit.TextSpan b) :1669
void TextSpan__op_Inequality_fn(TextSpan* a, TextSpan* b, bool* __retval)
{
    *__retval = TextSpan::op_Inequality(a, b);
}

// public TextSpan(Fuse.Controls.FallbackTextEdit.TextPosition start, Fuse.Controls.FallbackTextEdit.TextPosition end) [instance] :1688
...
// public bool Contains(Fuse.Controls.FallbackTextEdit.TextPosition p) [instance] :1711
...
// public static Fuse.Controls.FallbackTextEdit.TextSpan Intersection(Fuse.Controls.FallbackTextEdit.TextSpan a, Fuse.Controls.FallbackTextEdit.TextSpan b) [static] :1679
...
// public static bool Intersects(Fuse.Controls.FallbackTextEdit.TextSpan a, Fuse.Controls.FallbackTextEdit.TextSpan b) [static] :1674
...
// public TextSpan New(Fuse.Controls.FallbackTextEdit.TextPosition start, Fuse.Controls.FallbackTextEdit.TextPosition end) [static] :1688
...
// public static operator ==(Fuse.Controls.FallbackTextEdit.TextSpan a, Fuse.Controls.FallbackTextEdit.TextSpan b) [static] :1655
...
// public static operator !=(Fuse.Controls.FallbackTextEdit.TextSpan a, Fuse.Controls.FallbackTextEdit.TextSpan b) [static] :1669
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Controls/0.24.6/FallbackTextEdit/$.uno(1729)
// ---------------------------------------------------------------------------------------------------

// internal sealed class TextWindow :1729
// {
::g::Fuse::Elements::Element_type* TextWindow_typeof()
{
    ...
    type->interface1.fp_get_DataContext = (void(*)(uObject*, uObject**))::g::Fuse::Node__get_DataContext_fn;
    type->interface1.fp_set_DataContext = (void(*)(uObject*, uObject*))::g::Fuse::Node__set_DataContext_fn;
    ::TYPES[56] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[11] = ::g::Fuse::Controls::Internal::WordWrapInfo_typeof();
    ::TYPES[20] = ::g::Fuse::Node_typeof();
    ::TYPES[1] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Controls::FallbackTextEdit::LineCacheLine_typeof());
    ::TYPES[51] = ::g::Fuse::Controls::FallbackTextEdit::LineCache_typeof();
    ...
    ::TYPES[6] = ::g::Fuse::Controls::FallbackTextEdit::TextPosition_typeof();
    ::TYPES[7] = ::g::Fuse::Controls::FallbackTextEdit::TextSpan_typeof();
    ::TYPES[57] = ::g::Fuse::Elements::Internal::ElementDraw_typeof();
    type->SetInterfaces(
...
// public TextWindow(Fuse.Node parent, Fuse.Controls.FallbackTextEdit.LineCache lineCache) :1733
...
// protected override sealed Uno.Rect CalcRenderBounds() :1751
...
// public void Draw(Fuse.Controls.Internal.WordWrapInfo wrapInfo, Fuse.Controls.FallbackTextEdit.TextSpan selection, float4 textColor, float4 selectionColor, int maxTextLength, Fuse.Elements.TextAlignment textAlignment, float2 textBoundsSize, float2 offset, Fuse.DrawContext dc) :1756
...
// public TextWindow New(Fuse.Node parent, Fuse.Controls.FallbackTextEdit.LineCache lineCache) :1733
...
// protected override sealed void OnDraw(Fuse.DrawContext dc) :1773
...
// public TextWindow(Fuse.Node parent, Fuse.Controls.FallbackTextEdit.LineCache lineCache) [instance] :1733
void TextWindow::ctor_2(::g::Fuse::Node* parent, ::g::Fuse::Controls::FallbackTextEdit::LineCache* lineCache)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextWindow", ".ctor(Fuse.Node,Fuse.Controls.FallbackTextEdit.LineCache)");
    ctor_1();
...
// public void Draw(Fuse.Controls.Internal.WordWrapInfo wrapInfo, Fuse.Controls.FallbackTextEdit.TextSpan selection, float4 textColor, float4 selectionColor, int maxTextLength, Fuse.Elements.TextAlignment textAlignment, float2 textBoundsSize, float2 offset, Fuse.DrawContext dc) [instance] :1756
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextWindow", "Draw(Fuse.Controls.Internal.WordWrapInfo,Fuse.Controls.FallbackTextEdit.TextSpan,float4,float4,int,Fuse.Elements.TextAlignment,float2,float2,Fuse.DrawContext)");
...
// public TextWindow New(Fuse.Node parent, Fuse.Controls.FallbackTextEdit.LineCache lineCache) [static] :1733
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Controls/0.24.6/FallbackTextEdit/$.uno(696)
// --------------------------------------------------------------------------------------------------

...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Time/Calendars/$.uno(5)
// ---------------------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Time/Calendars/$.uno(40)
// ----------------------------------------------------------------------------------------------------
...
::g::Uno::Time::Calendars::YearMonthDayCalculator_type* GregorianYearMonthDayCalculator_typeof()
{
    ...
    ::TYPES[2] = ::g::Uno::Long_typeof();
    ::TYPES[3] = ::g::Uno::Time::Calendars::Era_typeof()->Array();
    ::TYPES[4] = ::g::Uno::Time::Calendars::Era_typeof();
    ::TYPES[5] = ::g::Uno::Int_typeof();
    ::TYPES[6] = ::g::Uno::Time::Instant_typeof();
    type->SetFields(6,
...
void GregorianYearMonthDayCalculator::ctor_1()
{
    ...
    ctor_(-27255, 31195, 12, 315569520000000LL, -621355968000000000LL, uArray::Init< ::g::Uno::Time::Calendars::Era*>(::TYPES[3/*Uno.Time.Calendars.Era[]*/], 2, (::g::Uno::Time::Calendars::Era*)::g::Uno::Time::Calendars::Era::BeforeCommon(), (::g::Uno::Time::Calendars::Era*)::g::Uno::Time::Calendars::Era::Common()));
}
...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Time/Calendars/$.uno(265)
// -----------------------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Time/Calendars/$.uno(405)
// -----------------------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Time/Calendars/$.uno(510)
// -----------------------------------------------------------------------------------------------------
...
YearMonthDayCalculator_type* YearMonthDayCalculator_typeof()
{
    ...
    ::TYPES[7] = ::g::Uno::Time::Preconditions_typeof()->MakeMethod(1, ::g::Uno::Time::Calendars::Era_typeof()->Array());
    ::TYPES[6] = ::g::Uno::Time::Instant_typeof();
    ::TYPES[2] = ::g::Uno::Long_typeof();
    ::TYPES[5] = ::g::Uno::Int_typeof();
    type->SetFields(0,
...
void YearMonthDayCalculator::ctor_(int minYear, int maxYear, int monthsInYear, int64_t averageTicksPerYear, int64_t ticksAtStartOfYear1, uArray* eras)
{
    ...
    _eras = ((uArray*)::g::Uno::Time::Preconditions::CheckNotNull(::TYPES[7/*Uno.Time.Preconditions.CheckNotNull<Uno.Time.Calendars.Era[]>*/], eras, ::STRINGS[10/*"eras"*/]));

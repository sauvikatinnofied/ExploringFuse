...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Runtime/Implementation/ShaderBackends/OpenGL/$.uno(8)
// ---------------------------------------------------------------------------------------------------------------------------------
...
GLCompiledProgram_type* GLCompiledProgram_typeof()
{
    ...
    ::TYPES[2] = ::g::OpenGL::GLProgramHandle_typeof();
    type->SetInterfaces(
...
void GLCompiledProgram::Dispose()
{
    ...
    ::g::OpenGL::GL::UseProgram(::g::OpenGL::GLProgramHandle::Zero());
...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Runtime/Implementation/ShaderBackends/OpenGL/$.uno(71)
// ----------------------------------------------------------------------------------------------------------------------------------
...
uStructType* GLDrawCall_typeof()
{
    ...
    ::TYPES[3] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Int_typeof());
    ::TYPES[1] = ::g::Uno::String_typeof()->Array();
    ::TYPES[4] = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram_typeof();
    ::TYPES[5] = ::g::Uno::Graphics::DeviceBuffer_typeof();
    ::TYPES[6] = ::g::OpenGL::GLBufferHandle_typeof();
    ::TYPES[7] = ::g::Uno::Int_typeof();
    ::TYPES[8] = ::g::OpenGL::GLTextureUnit_typeof();
    ::TYPES[9] = ::g::OpenGL::GLTextureHandle_typeof();
    ::TYPES[10] = ::g::OpenGL::GLTextureParameterValue_typeof();
    ::TYPES[11] = ::g::Uno::Graphics::SamplerState_typeof();
    ::TYPES[12] = ::g::Uno::Graphics::Texture2D_typeof();
    ::TYPES[13] = ::g::Uno::Graphics::VideoTexture_typeof();
    ::TYPES[14] = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLCompiledProgram_typeof();
    type->SetFields(0,
...
void GLDrawCall::ctor_(::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram* program)
{
    ...
    *this = uDefault<GLDrawCall>();
    ...
    if (GLDrawCall::_boundAttributes() == NULL)
        GLDrawCall::_boundAttributes() = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[3/*Uno.Collections.List<int>*/]));

    _constValues = uArray::New(::TYPES[1/*string[]*/], uPtr(program)->ConstantCount());
    Program(program);
    BlendEnabled(false);
...
void GLDrawCall::Attrib(int index, int componentCount, int componentType, bool normalized, ::g::Uno::Graphics::VertexBuffer* buf, int stride, int offset)
{
    ...
    ::g::OpenGL::GL::BindBuffer(34962, ::g::OpenGL::GLBufferHandle::Zero());
    ::g::Uno::Collections::List__Add_fn(uPtr(GLDrawCall::_boundAttributes()), uCRef<int>(location));
}
...
void GLDrawCall::Const1(int index, int value)
{
    ...
    ConstInternal(index, ::g::Uno::Int::ToString(value, ::TYPES[7/*int*/]));
}
...
void GLDrawCall::DisableSampler(int index, int target)
{
    ...
    ::g::OpenGL::GL::ActiveTexture(33984 + GLDrawCall::_currentTextureUnit());
    ::g::OpenGL::GL::BindTexture(target, ::g::OpenGL::GLTextureHandle::Zero());
    GLDrawCall::_currentTextureUnit()++;
}
...
void GLDrawCall::DrawElements(int count, int type, ::g::Uno::Graphics::IndexBuffer* buf)
{
    ...
    ::g::OpenGL::GL::BindBuffer(34963, ::g::OpenGL::GLBufferHandle::Zero());
    End();
}
...
void GLDrawCall::End()
{
    ...
    for (int i = 0; i < uPtr(GLDrawCall::_boundAttributes())->Count(); i++)
        ::g::OpenGL::GL::DisableVertexAttribArray((::g::Uno::Collections::List__get_Item_fn(uPtr(GLDrawCall::_boundAttributes()), uCRef<int>(i), &ret8), ret8));

    for (int i1 = 0; i1 < GLDrawCall::_currentTextureUnit(); i1++)
    {
    ...
    uPtr(GLDrawCall::_boundAttributes())->Clear();
    GLDrawCall::_currentTextureUnit() = 0;
}
...
void GLDrawCall::Sampler(int index, int target, uint32_t handle, bool isMipmap, bool isPow2)
{
    ...
    ::g::OpenGL::GL::Uniform12(location, GLDrawCall::_currentTextureUnit()++);
}
...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Runtime/Implementation/ShaderBackends/OpenGL/$.uno(620)
// -----------------------------------------------------------------------------------------------------------------------------------

// public sealed extern class GLException :620
// {
...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Runtime/Implementation/ShaderBackends/OpenGL/$.uno(639)
// -----------------------------------------------------------------------------------------------------------------------------------

// public static extern class GLHelpers :639
// {
uClassType* GLHelpers_typeof()
{
    ...
    ::TYPES[17] = ::g::OpenGL::GLRenderbufferHandle_typeof();
    ::TYPES[18] = ::g::Uno::Graphics::RenderTarget_typeof();
...
// public static void CheckError() :641
void GLHelpers__CheckError_fn()
{
    GLHelpers::CheckError();
}

// public static void CheckFramebufferStatus() :649
void GLHelpers__CheckFramebufferStatus_fn()
{
    GLHelpers::CheckFramebufferStatus();
}

// public static OpenGL.GLShaderHandle CompileShader(OpenGL.GLShaderType type, string source) :772
void GLHelpers__CompileShader_fn(int* type, uString* source, uint32_t* __retval)
{
    *__retval = GLHelpers::CompileShader(*type, source);
}

// public static OpenGL.GLRenderbufferHandle CreateDepthBuffer(int2 size) :758
void GLHelpers__CreateDepthBuffer_fn(::g::Uno::Int2* size, uint32_t* __retval)
{
    *__retval = GLHelpers::CreateDepthBuffer(*size);
}

// public static Uno.Graphics.RenderTarget CreateRenderTarget(OpenGL.GLTextureTarget colorTarget, OpenGL.GLTextureHandle colorBuffer, int mip, int2 size, bool depth) :723
...
// public static Uno.Graphics.RenderTarget CreateRenderTarget(OpenGL.GLTextureTarget colorTarget, OpenGL.GLTextureHandle colorBuffer, int mip, int2 size, OpenGL.GLRenderbufferHandle depthBuffer, bool ownsDepthBuffer) :728
...
// public static OpenGL.GLProgramHandle LinkProgram(OpenGL.GLShaderHandle vertexShader, OpenGL.GLShaderHandle fragmentShader) :790
...
// public static void TexImage2DFromBuffer(OpenGL.GLTextureTarget target, int w, int h, int mip, Uno.Graphics.Format format, Uno.Buffer data) :657
...
// public static void CheckError() [static] :641
void GLHelpers::CheckError()
{
    ...
    if (err != 0)
        ::g::Uno::Diagnostics::Debug::Log4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[3/*"GL error ("*/], ::g::Uno::Int::ToString(err, ::TYPES[7/*int*/])), ::STRINGS[4/*")"*/]), 3);
}

// public static void CheckFramebufferStatus() [static] :649
...
// public static OpenGL.GLShaderHandle CompileShader(OpenGL.GLShaderType type, string source) [static] :772
...
// public static OpenGL.GLRenderbufferHandle CreateDepthBuffer(int2 size) [static] :758
...
// public static Uno.Graphics.RenderTarget CreateRenderTarget(OpenGL.GLTextureTarget colorTarget, OpenGL.GLTextureHandle colorBuffer, int mip, int2 size, bool depth) [static] :723
::g::Uno::Graphics::RenderTarget* GLHelpers::CreateRenderTarget(int colorTarget, uint32_t colorBuffer, int mip, ::g::Uno::Int2 size, bool depth)
{
    ...
    return GLHelpers::CreateRenderTarget1(colorTarget, colorBuffer, mip, size, depth ? GLHelpers::CreateDepthBuffer(size) : ::g::OpenGL::GLRenderbufferHandle::Zero(), true);
}

// public static Uno.Graphics.RenderTarget CreateRenderTarget(OpenGL.GLTextureTarget colorTarget, OpenGL.GLTextureHandle colorBuffer, int mip, int2 size, OpenGL.GLRenderbufferHandle depthBuffer, bool ownsDepthBuffer) [static] :728
::g::Uno::Graphics::RenderTarget* GLHelpers::CreateRenderTarget1(int colorTarget, uint32_t colorBuffer, int mip, ::g::Uno::Int2 size, uint32_t depthBuffer, bool ownsDepthBuffer)
{
    ...
    if (::g::OpenGL::GLRenderbufferHandle::op_Inequality(depthBuffer, ::g::OpenGL::GLRenderbufferHandle::Zero()))
    {
...
// public static OpenGL.GLProgramHandle LinkProgram(OpenGL.GLShaderHandle vertexShader, OpenGL.GLShaderHandle fragmentShader) [static] :790
...
// public static void TexImage2DFromBuffer(OpenGL.GLTextureTarget target, int w, int h, int mip, Uno.Graphics.Format format, Uno.Buffer data) [static] :657
...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Runtime/Implementation/ShaderBackends/OpenGL/$.uno(828)
// -----------------------------------------------------------------------------------------------------------------------------------

// public static extern class GLInterop :828
// {
...
// public static OpenGL.GLBlendEquation ToGLBlendEquation(Uno.Graphics.BlendEquation x) :1094
void GLInterop__ToGLBlendEquation_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToGLBlendEquation(*x);
}

// public static OpenGL.GLBlendingFactor ToGLBlendingFactor(Uno.Graphics.BlendOperand x) :1016
void GLInterop__ToGLBlendingFactor_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToGLBlendingFactor(*x);
}

// public static OpenGL.GLBufferUsage ToGLBufferUsage(Uno.Graphics.BufferUsage x) :1130
void GLInterop__ToGLBufferUsage_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToGLBufferUsage(*x);
}

// public static OpenGL.GLCullFaceMode ToGLCullFaceMode(Uno.Graphics.PolygonFace x) :860
void GLInterop__ToGLCullFaceMode_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToGLCullFaceMode(*x);
}

// public static OpenGL.GLDepthFunction ToGLDepthFunction(Uno.Graphics.CompareFunc x) :902
void GLInterop__ToGLDepthFunction_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToGLDepthFunction(*x);
}

// public static OpenGL.GLFrontFaceDirection ToGLFrontFaceDirection(Uno.Graphics.PolygonWinding x) :830
void GLInterop__ToGLFrontFaceDirection_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToGLFrontFaceDirection(*x);
}

// public static OpenGL.GLIndexType ToGLIndexType(Uno.Graphics.IndexType x) :1148
void GLInterop__ToGLIndexType_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToGLIndexType(*x);
}

// public static OpenGL.GLPrimitiveType ToGLPrimitiveType(Uno.Graphics.PrimitiveType x) :968
void GLInterop__ToGLPrimitiveType_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToGLPrimitiveType(*x);
}

// public static void ToGLVertexAttributeType(Uno.Graphics.VertexAttributeType x, int& componentCount, OpenGL.GLDataType& componentType, bool& normalized) :1163
...
// public static Uno.Graphics.BlendEquation ToUnoGraphicsBlendEquation(OpenGL.GLBlendEquation x) :1112
void GLInterop__ToUnoGraphicsBlendEquation_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToUnoGraphicsBlendEquation(*x);
}

// public static Uno.Graphics.BlendOperand ToUnoGraphicsBlendOperand(OpenGL.GLBlendingFactor x) :1055
void GLInterop__ToUnoGraphicsBlendOperand_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToUnoGraphicsBlendOperand(*x);
}

// public static Uno.Graphics.CompareFunc ToUnoGraphicsCompareFunc(OpenGL.GLDepthFunction x) :935
void GLInterop__ToUnoGraphicsCompareFunc_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToUnoGraphicsCompareFunc(*x);
}

// public static Uno.Graphics.PolygonFace ToUnoGraphicsPolygonFace(OpenGL.GLCullFaceMode x) :881
void GLInterop__ToUnoGraphicsPolygonFace_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToUnoGraphicsPolygonFace(*x);
}

// public static Uno.Graphics.PolygonWinding ToUnoGraphicsPolygonWinding(OpenGL.GLFrontFaceDirection x) :845
void GLInterop__ToUnoGraphicsPolygonWinding_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToUnoGraphicsPolygonWinding(*x);
}

// public static Uno.Graphics.PrimitiveType ToUnoGraphicsPrimitiveType(OpenGL.GLPrimitiveType x) :992
void GLInterop__ToUnoGraphicsPrimitiveType_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToUnoGraphicsPrimitiveType(*x);
}

// public static OpenGL.GLBlendEquation ToGLBlendEquation(Uno.Graphics.BlendEquation x) [static] :1094
...
// public static OpenGL.GLBlendingFactor ToGLBlendingFactor(Uno.Graphics.BlendOperand x) [static] :1016
...
// public static OpenGL.GLBufferUsage ToGLBufferUsage(Uno.Graphics.BufferUsage x) [static] :1130
...
// public static OpenGL.GLCullFaceMode ToGLCullFaceMode(Uno.Graphics.PolygonFace x) [static] :860
...
// public static OpenGL.GLDepthFunction ToGLDepthFunction(Uno.Graphics.CompareFunc x) [static] :902
...
// public static OpenGL.GLFrontFaceDirection ToGLFrontFaceDirection(Uno.Graphics.PolygonWinding x) [static] :830
...
// public static OpenGL.GLIndexType ToGLIndexType(Uno.Graphics.IndexType x) [static] :1148
...
// public static OpenGL.GLPrimitiveType ToGLPrimitiveType(Uno.Graphics.PrimitiveType x) [static] :968
...
// public static void ToGLVertexAttributeType(Uno.Graphics.VertexAttributeType x, int& componentCount, OpenGL.GLDataType& componentType, bool& normalized) [static] :1163
...
// public static Uno.Graphics.BlendEquation ToUnoGraphicsBlendEquation(OpenGL.GLBlendEquation x) [static] :1112
...
// public static Uno.Graphics.BlendOperand ToUnoGraphicsBlendOperand(OpenGL.GLBlendingFactor x) [static] :1055
...
// public static Uno.Graphics.CompareFunc ToUnoGraphicsCompareFunc(OpenGL.GLDepthFunction x) [static] :935
...
// public static Uno.Graphics.PolygonFace ToUnoGraphicsPolygonFace(OpenGL.GLCullFaceMode x) [static] :881
...
// public static Uno.Graphics.PolygonWinding ToUnoGraphicsPolygonWinding(OpenGL.GLFrontFaceDirection x) [static] :845
...
// public static Uno.Graphics.PrimitiveType ToUnoGraphicsPrimitiveType(OpenGL.GLPrimitiveType x) [static] :992
...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Runtime/Implementation/ShaderBackends/OpenGL/$.uno(1303)
// ------------------------------------------------------------------------------------------------------------------------------------

// public sealed extern class GLProgram :1303
// {
uType* GLProgram_typeof()
{
    ...
    ::STRINGS[27] = uString::Const("\n"
        "");
    ::TYPES[1] = ::g::Uno::String_typeof()->Array();
    ::TYPES[19] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLCompiledProgram_typeof());
...
// internal GLProgram(string vsSource, string fsSource, int constCount, int attribCount, string[] constAttribAndUniformNames) :1320
...
// public int get_ConstantCount() :1317
void GLProgram__get_ConstantCount_fn(GLProgram* __this, int* __retval)
{
    *__retval = __this->ConstantCount();
}

// public static Uno.Runtime.Implementation.ShaderBackends.OpenGL.GLProgram Create(string vsSource, string fsSource, int constCount, int attribCount, string[] constAttribAndUniformNames) :1329
...
// public Uno.Runtime.Implementation.ShaderBackends.OpenGL.GLCompiledProgram GetCompiledProgram(string[] constStrings) :1357
...
// private Uno.Runtime.Implementation.ShaderBackends.OpenGL.GLCompiledProgram GetCompiledProgramInternal(string[] constStrings) :1334
...
// internal GLProgram New(string vsSource, string fsSource, int constCount, int attribCount, string[] constAttribAndUniformNames) :1320
...
// internal GLProgram(string vsSource, string fsSource, int constCount, int attribCount, string[] constAttribAndUniformNames) [instance] :1320
...
// public int get_ConstantCount() [instance] :1317
...
// public Uno.Runtime.Implementation.ShaderBackends.OpenGL.GLCompiledProgram GetCompiledProgram(string[] constStrings) [instance] :1357
::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLCompiledProgram* GLProgram::GetCompiledProgram(uArray* constStrings)
{
    ...
    if (_cachedPrograms == NULL)
        _cachedPrograms = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[19/*Uno.Collections.Dictionary<string, Uno.Runtime.Implementation.ShaderBackends.OpenGL.GLCompiledProgram>*/]));
...
// private Uno.Runtime.Implementation.ShaderBackends.OpenGL.GLCompiledProgram GetCompiledProgramInternal(string[] constStrings) [instance] :1334
...
// public static Uno.Runtime.Implementation.ShaderBackends.OpenGL.GLProgram Create(string vsSource, string fsSource, int constCount, int attribCount, string[] constAttribAndUniformNames) [static] :1329
...
// internal GLProgram New(string vsSource, string fsSource, int constCount, int attribCount, string[] constAttribAndUniformNames) [static] :1320

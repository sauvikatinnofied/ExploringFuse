...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Content/Models/$.uno(9)
// ---------------------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Content/Models/$.uno(78)
// ----------------------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Content/Models/$.uno(220)
// -----------------------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Content/Models/$.uno(253)
// -----------------------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Content/Models/$.uno(611)
// -----------------------------------------------------------------------------------------------------

// public sealed class ModelMesh :611
// {
uType* ModelMesh_typeof()
{
    ...
    ::TYPES[3] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Content::Models::VertexAttributeArray_typeof()));
    ::TYPES[4] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Content::Models::VertexAttributeArray_typeof()));
    ::TYPES[5] = ::g::Uno::Content::Models::VertexAttributeArray_typeof();
    ::TYPES[6] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Content::Models::VertexAttributeArray_typeof());
    type->SetFields(0,
...
// public ModelMesh(string name, Uno.Graphics.PrimitiveType type, Uno.Collections.Dictionary<string, Uno.Content.Models.VertexAttributeArray> vertexAttributes, [Uno.Content.Models.IndexArray indices]) :638
...
// public int get_IndexCount() :648
void ModelMesh__get_IndexCount_fn(ModelMesh* __this, int* __retval)
{
    *__retval = __this->IndexCount();
}

// public Uno.Content.Models.IndexArray get_Indices() :620
void ModelMesh__get_Indices_fn(ModelMesh* __this, ::g::Uno::Content::Models::IndexArray** __retval)
{
    *__retval = __this->Indices();
}

// public string get_Name() :614
void ModelMesh__get_Name_fn(ModelMesh* __this, uString** __retval)
{
    *__retval = __this->Name();
}

// public ModelMesh New(string name, Uno.Graphics.PrimitiveType type, Uno.Collections.Dictionary<string, Uno.Content.Models.VertexAttributeArray> vertexAttributes, [Uno.Content.Models.IndexArray indices]) :638
...
// public Uno.Content.Models.VertexAttributeArray get_Normals() :684
...
// public Uno.Content.Models.VertexAttributeArray get_Positions() :674
...
// public Uno.Graphics.PrimitiveType get_PrimitiveType() :617
void ModelMesh__get_PrimitiveType_fn(ModelMesh* __this, int* __retval)
{
    *__retval = __this->PrimitiveType();
}

// public Uno.Content.Models.VertexAttributeArray get_TexCoords() :679
...
// public Uno.Content.Models.VertexAttributeArray TryGetVertexAttribute(string name) :631
...
// public Uno.Collections.IEnumerable<Uno.Collections.KeyValuePair<string, Uno.Content.Models.VertexAttributeArray>> get_VertexAttributes() :624
void ModelMesh__get_VertexAttributes_fn(ModelMesh* __this, uObject** __retval)
{
    *__retval = __this->VertexAttributes();
}

// public int get_VertexCount() :653
void ModelMesh__get_VertexCount_fn(ModelMesh* __this, int* __retval)
{
    *__retval = __this->VertexCount();
}

// public ModelMesh(string name, Uno.Graphics.PrimitiveType type, Uno.Collections.Dictionary<string, Uno.Content.Models.VertexAttributeArray> vertexAttributes, [Uno.Content.Models.IndexArray indices]) [instance] :638
...
// public int get_IndexCount() [instance] :648
...
// public Uno.Content.Models.IndexArray get_Indices() [instance] :620
...
// public string get_Name() [instance] :614
...
// public Uno.Content.Models.VertexAttributeArray get_Normals() [instance] :684
...
// public Uno.Content.Models.VertexAttributeArray get_Positions() [instance] :674
...
// public Uno.Graphics.PrimitiveType get_PrimitiveType() [instance] :617
...
// public Uno.Content.Models.VertexAttributeArray get_TexCoords() [instance] :679
...
// public Uno.Content.Models.VertexAttributeArray TryGetVertexAttribute(string name) [instance] :631
...
// public Uno.Collections.IEnumerable<Uno.Collections.KeyValuePair<string, Uno.Content.Models.VertexAttributeArray>> get_VertexAttributes() [instance] :624
...
// public int get_VertexCount() [instance] :653
int ModelMesh::VertexCount()
{
    ...
    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(VertexAttributes()), ::TYPES[3/*Uno.Collections.IEnumerable<Uno.Collections.KeyValuePair<string, Uno.Content.Models.VertexAttributeArray>>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::g::Uno::Collections::IEnumerator_typeof())); )
    {
        ::g::Uno::Collections::KeyValuePair<uStrong<uString*>, uStrong< ::g::Uno::Content::Models::VertexAttributeArray*> > attrib = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[4/*Uno.Collections.IEnumerator<Uno.Collections.KeyValuePair<string, Uno.Content.Models.VertexAttributeArray>>*/]), &ret5), ret5);
        return uPtr(attrib.Value(::TYPES[6/*Uno.Collections.KeyValuePair<string, Uno.Content.Models.VertexAttributeArray>*/]))->Count();
    }

    return 0;
}

// public ModelMesh New(string name, Uno.Graphics.PrimitiveType type, Uno.Collections.Dictionary<string, Uno.Content.Models.VertexAttributeArray> vertexAttributes, [Uno.Content.Models.IndexArray indices]) [static] :638
...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Content/Models/$.uno(117)
// -----------------------------------------------------------------------------------------------------
...
uType* ModelNode_typeof()
{
    ...
    ::TYPES[7] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(ModelNode_typeof());
    ::TYPES[8] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Content::Models::ModelDrawable_typeof());
    ::TYPES[9] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Content::Models::ModelParameter1_typeof()->MakeType(::g::Uno::Float4x4_typeof()));
    type->SetFields(0,
...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Content/Models/$.uno(746)
// -----------------------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Content/Models/$.uno(1500)
// ------------------------------------------------------------------------------------------------------

// public sealed class VertexAttributeArray :1500
// {
uType* VertexAttributeArray_typeof()
{
    ...
    ::TYPES[13] = ::g::Uno::Short2_typeof();
    ::TYPES[14] = ::g::Uno::Short4_typeof();
    ::TYPES[15] = ::g::Uno::UShort2_typeof();
    ::TYPES[16] = ::g::Uno::UShort4_typeof();
    ::TYPES[17] = ::g::Uno::SByte4_typeof();
    ::TYPES[18] = ::g::Uno::Byte4_typeof();
    ::TYPES[1] = ::g::Uno::Buffer_typeof();
    type->SetFields(0,
...
// public byte4 GetByte4Normalized(int index) :1586
...
// public float4 GetFloat4(int index) :1608
...
// public VertexAttributeArray(float3[] data) [instance] :1536
...
// public VertexAttributeArray(float4[] data) [instance] :1541
...
// public VertexAttributeArray(Uno.Graphics.VertexAttributeType type, Uno.Buffer buffer) [instance] :1520
...
// public Uno.Buffer get_Buffer() [instance] :1512
...
// public int get_Count() [instance] :1517
...
// public byte4 GetByte4(int index) [instance] :1597
...
// public byte4 GetByte4Normalized(int index) [instance] :1586
...
// public float4 GetFloat4(int index) [instance] :1608
...
// public Uno.Graphics.VertexAttributeType get_Type() [instance] :1507
...
// public VertexAttributeArray New(float2[] data) [static] :1531
...
// public VertexAttributeArray New(float3[] data) [static] :1536
...
// public VertexAttributeArray New(float4[] data) [static] :1541

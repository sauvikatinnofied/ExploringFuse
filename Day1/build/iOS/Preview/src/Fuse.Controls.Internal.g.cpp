...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Controls/0.24.6/Internal/$.uno(11)
// -----------------------------------------------------------------------------------------
...
{
    uStackFrame __("Fuse.Controls.Internal.DefaultTextRenderer", ".ctor(Uno.Content.Fonts.FontFace)");
...
{
    uStackFrame __("Fuse.Controls.Internal.DefaultTextRenderer", "BeginRendering(float,float,float4x4,float2,float4,int)");
    _fontSize = fontSize;
...
{
    uStackFrame __("Fuse.Controls.Internal.DefaultTextRenderer", "DrawLine(Fuse.DrawContext,float,float,string)");
...
{
    uStackFrame __("Fuse.Controls.Internal.DefaultTextRenderer", "EndRendering(Fuse.DrawContext)");
...
{
    uStackFrame __("Fuse.Controls.Internal.DefaultTextRenderer", "get_FontFace()");
    return _FontFace;
}
...
{
    uStackFrame __("Fuse.Controls.Internal.DefaultTextRenderer", "set_FontFace(Uno.Content.Fonts.FontFace)");
    _FontFace = value;
}
...
{
    uStackFrame __("Fuse.Controls.Internal.DefaultTextRenderer", "GetBitmapFont(float,float,bool)");
    bool ret2;
...
{
    uStackFrame __("Fuse.Controls.Internal.DefaultTextRenderer", "GetLineHeight(float)");
...
{
    uStackFrame __("Fuse.Controls.Internal.DefaultTextRenderer", "GetLineHeightVirtual(float,float)");
...
{
    uStackFrame __("Fuse.Controls.Internal.DefaultTextRenderer", "MeasureString(float,float,string)");
...
{
    uStackFrame __("Fuse.Controls.Internal.DefaultTextRenderer", "MeasureStringVirtual(float,float,string)");
...
{
    uStackFrame __("Fuse.Controls.Internal.DefaultTextRenderer", "EnsureRendererCapacity(int)");
...
{
    uStackFrame __("Fuse.Controls.Internal.DefaultTextRenderer", "get_renderer()");
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Controls/0.24.6/Internal/$.uno(13)
// -----------------------------------------------------------------------------------------
...
{
    uStackFrame __("Fuse.Controls.Internal.DefaultTextRenderer.FontKey", "Equals(object)");
...
{
    uStackFrame __("Fuse.Controls.Internal.DefaultTextRenderer.FontKey", "GetHashCode()");
...
{
    uStackFrame __("Fuse.Controls.Internal.DefaultTextRenderer.FontKey", ".ctor(Uno.Content.Fonts.FontFace,int)");
    FontFace = fontFace;
    Size = size;
}
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Controls/0.24.6/Internal/$.uno(184)
// ------------------------------------------------------------------------------------------
...
{
    uStackFrame __("Fuse.Controls.Internal.ProperTextTransform", "get_CullFace()");
...
{
    uStackFrame __("Fuse.Controls.Internal.ProperTextTransform", "get_Matrix()");
...
{
    uStackFrame __("Fuse.Controls.Internal.ProperTextTransform", "set_Matrix(float4x4)");
...
{
    uStackFrame __("Fuse.Controls.Internal.ProperTextTransform", "ResolveClipSpaceMatrix()");
...
{
    uStackFrame __("Fuse.Controls.Internal.ProperTextTransform", ".ctor()");
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Controls/0.24.6/Internal/$.uno(216)
// ------------------------------------------------------------------------------------------

// internal sealed class WordWrapInfo :216
// {
...
// public WordWrapInfo(Fuse.Controls.Internal.DefaultTextRenderer textRenderer, bool isEnabled, float wrapWidth, float fontSize, float lineHeight, float lineSpacing, float absoluteZoom) :225
...
// public override sealed bool Equals(object obj) :236
void WordWrapInfo__Equals_fn(WordWrapInfo* __this, uObject* obj, bool* __retval)
{
    uStackFrame __("Fuse.Controls.Internal.WordWrapInfo", "Equals(object)");
...
// public override sealed int GetHashCode() :251
void WordWrapInfo__GetHashCode_fn(WordWrapInfo* __this, int* __retval)
{
    uStackFrame __("Fuse.Controls.Internal.WordWrapInfo", "GetHashCode()");
    bool ind1;
    float ind2;
    float ind3;
    float ind4;
...
// public WordWrapInfo New(Fuse.Controls.Internal.DefaultTextRenderer textRenderer, bool isEnabled, float wrapWidth, float fontSize, float lineHeight, float lineSpacing, float absoluteZoom) :225
...
// public WordWrapInfo(Fuse.Controls.Internal.DefaultTextRenderer textRenderer, bool isEnabled, float wrapWidth, float fontSize, float lineHeight, float lineSpacing, float absoluteZoom) [instance] :225
...
{
    uStackFrame __("Fuse.Controls.Internal.WordWrapInfo", ".ctor(Fuse.Controls.Internal.DefaultTextRenderer,bool,float,float,float,float,float)");
...
// public WordWrapInfo New(Fuse.Controls.Internal.DefaultTextRenderer textRenderer, bool isEnabled, float wrapWidth, float fontSize, float lineHeight, float lineSpacing, float absoluteZoom) [static] :225
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Controls/0.24.6/Internal/$.uno(294)
// ------------------------------------------------------------------------------------------

// internal static class WordWrapper :294
// {
...
// private static Uno.Collections.List<Fuse.Controls.Internal.WordWrapperWord> GetWords(Fuse.Controls.Internal.WordWrapInfo wrapInfo, string text) :335
...
// private static Fuse.Controls.Internal.WordWrapperWord SplitWord(Fuse.Controls.Internal.WordWrapInfo wrapInfo, Uno.Collections.List<Fuse.Controls.Internal.WrappedLine> wrappedLines, Fuse.Controls.Internal.WordWrapperWord word, int& lineStartIndex) :362
...
// public static Fuse.Controls.Internal.WrappedLine[] WrapLine(Fuse.Controls.Internal.WordWrapInfo wrapInfo, string text) :296
...
// private static Uno.Collections.List<Fuse.Controls.Internal.WordWrapperWord> GetWords(Fuse.Controls.Internal.WordWrapInfo wrapInfo, string text) [static] :335
::g::Uno::Collections::List* WordWrapper::GetWords(::g::Fuse::Controls::Internal::WordWrapInfo* wrapInfo, uString* text)
{
    uStackFrame __("Fuse.Controls.Internal.WordWrapper", "GetWords(Fuse.Controls.Internal.WordWrapInfo,string)");
...
// private static Fuse.Controls.Internal.WordWrapperWord SplitWord(Fuse.Controls.Internal.WordWrapInfo wrapInfo, Uno.Collections.List<Fuse.Controls.Internal.WrappedLine> wrappedLines, Fuse.Controls.Internal.WordWrapperWord word, int& lineStartIndex) [static] :362
...
{
    uStackFrame __("Fuse.Controls.Internal.WordWrapper", "SplitWord(Fuse.Controls.Internal.WordWrapInfo,Uno.Collections.List<Fuse.Controls.Internal.WrappedLine>,Fuse.Controls.Internal.WordWrapperWord,int&)");
...
// public static Fuse.Controls.Internal.WrappedLine[] WrapLine(Fuse.Controls.Internal.WordWrapInfo wrapInfo, string text) [static] :296
uArray* WordWrapper::WrapLine(::g::Fuse::Controls::Internal::WordWrapInfo* wrapInfo, uString* text)
{
    uStackFrame __("Fuse.Controls.Internal.WordWrapper", "WrapLine(Fuse.Controls.Internal.WordWrapInfo,string)");
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Controls/0.24.6/Internal/$.uno(272)
// ------------------------------------------------------------------------------------------
...
// public WordWrapperWord(string contents, string whitespace, int startIndex, float contentsWidth, float totalContentsWidth) :283
...
// public int get_EndIndex() :281
void WordWrapperWord__get_EndIndex_fn(WordWrapperWord* __this, int* __retval)
{
    *__retval = __this->EndIndex();
}

// public WordWrapperWord New(string contents, string whitespace, int startIndex, float contentsWidth, float totalContentsWidth) :283
...
// public WordWrapperWord(string contents, string whitespace, int startIndex, float contentsWidth, float totalContentsWidth) [instance] :283
...
{
    uStackFrame __("Fuse.Controls.Internal.WordWrapperWord", ".ctor(string,string,int,float,float)");
    Contents = contents;
...
// public int get_EndIndex() [instance] :281
int WordWrapperWord::EndIndex()
{
    uStackFrame __("Fuse.Controls.Internal.WordWrapperWord", "get_EndIndex()");
    return StartIndex + uPtr(TotalContents)->Length();
}

// public WordWrapperWord New(string contents, string whitespace, int startIndex, float contentsWidth, float totalContentsWidth) [static] :283
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Controls/0.24.6/Internal/$.uno(401)
// ------------------------------------------------------------------------------------------

// internal sealed class WrappedLine :401
// {
...
// public WrappedLine(string text, int lineTextStartOffset, float yOffset, float lineWidth) :410
...
// public int BoundsToPos(Fuse.Controls.Internal.WordWrapInfo wrapInfo, float p) :435
...
// public float GetXOffset(Fuse.Elements.TextAlignment textAlignment, float boundsWidth, float absoluteZoom) :418
...
// public int get_LineTextEndOffset() :408
void WrappedLine__get_LineTextEndOffset_fn(WrappedLine* __this, int* __retval)
{
    *__retval = __this->LineTextEndOffset();
}

// public WrappedLine New(string text, int lineTextStartOffset, float yOffset, float lineWidth) :410
...
// public float PosToBounds(Fuse.Controls.Internal.WordWrapInfo wrapInfo, int p) :461
...
// public WrappedLine(string text, int lineTextStartOffset, float yOffset, float lineWidth) [instance] :410
void WrappedLine::ctor_(uString* text, int lineTextStartOffset, float yOffset, float lineWidth)
{
    uStackFrame __("Fuse.Controls.Internal.WrappedLine", ".ctor(string,int,float,float)");
    Text = text;
...
// public int BoundsToPos(Fuse.Controls.Internal.WordWrapInfo wrapInfo, float p) [instance] :435
int WrappedLine::BoundsToPos(::g::Fuse::Controls::Internal::WordWrapInfo* wrapInfo, float p)
{
    uStackFrame __("Fuse.Controls.Internal.WrappedLine", "BoundsToPos(Fuse.Controls.Internal.WordWrapInfo,float)");
    int c = 0;
...
// public float GetXOffset(Fuse.Elements.TextAlignment textAlignment, float boundsWidth, float absoluteZoom) [instance] :418
float WrappedLine::GetXOffset(int textAlignment, float boundsWidth, float absoluteZoom)
{
    uStackFrame __("Fuse.Controls.Internal.WrappedLine", "GetXOffset(Fuse.Elements.TextAlignment,float,float)");
...
// public int get_LineTextEndOffset() [instance] :408
int WrappedLine::LineTextEndOffset()
{
    uStackFrame __("Fuse.Controls.Internal.WrappedLine", "get_LineTextEndOffset()");
    return LineTextStartOffset + uPtr(Text)->Length();
}

// public float PosToBounds(Fuse.Controls.Internal.WordWrapInfo wrapInfo, int p) [instance] :461
float WrappedLine::PosToBounds(::g::Fuse::Controls::Internal::WordWrapInfo* wrapInfo, int p)
{
    uStackFrame __("Fuse.Controls.Internal.WrappedLine", "PosToBounds(Fuse.Controls.Internal.WordWrapInfo,int)");
...
// public WrappedLine New(string text, int lineTextStartOffset, float yOffset, float lineWidth) [static] :410

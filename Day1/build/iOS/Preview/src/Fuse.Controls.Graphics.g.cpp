...
{
    uStackFrame __("Fuse.Controls.Graphics.CircleVisual", "DrawFill(Fuse.DrawContext,Fuse.Drawing.Brush)");
...
{
    uStackFrame __("Fuse.Controls.Graphics.CircleVisual", "DrawStroke(Fuse.DrawContext,Fuse.Drawing.Stroke)");
    float startAngle = uPtr(__this->Circle())->StartAngle();
    float endAngle = uPtr(__this->Circle())->EffectiveEndAngle();
...
{
    uStackFrame __("Fuse.Controls.Graphics.CircleVisual", "OnHitTest(Fuse.HitTestContext)");
...
{
    uStackFrame __("Fuse.Controls.Graphics.CircleVisual", ".ctor()");
    ctor_3();
}
...
{
    uStackFrame __("Fuse.Controls.Graphics.CircleVisual", "get_Circle()");
...
// public generated DefaultTextVisual() :64
...
{
    uStackFrame __("Fuse.Controls.Graphics.DefaultTextVisual", "GetMarginSize(Fuse.LayoutParams)");
...
// public generated DefaultTextVisual New() :64
...
{
    uStackFrame __("Fuse.Controls.Graphics.DefaultTextVisual", "OnDraw(Fuse.DrawContext)");
    uArray* array10;
    int index11;
    int length12;
...
// public generated DefaultTextVisual() [instance] :64
void DefaultTextVisual::ctor_4()
{
    uStackFrame __("Fuse.Controls.Graphics.DefaultTextVisual", ".ctor()");
    ctor_3();
}
...
{
    uStackFrame __("Fuse.Controls.Graphics.DefaultTextVisual", "InitWrap(float,string)");
    uArray* array7;
    int index8;
    int length9;
...
{
    uStackFrame __("Fuse.Controls.Graphics.DefaultTextVisual", "GetTextRenderer(Fuse.Font)");
...
// public generated DefaultTextVisual New() [static] :64
...
{
    uStackFrame __("Fuse.Controls.Graphics.EllipseVisual", "UpdatePath(Fuse.Drawing.PathGeometryRenderer)");
...
{
    uStackFrame __("Fuse.Controls.Graphics.EllipseVisual", ".ctor()");
...
{
    uStackFrame __("Fuse.Controls.Graphics.EllipseVisual", "get_Ellipse()");
...
{
    uStackFrame __("Fuse.Controls.Graphics.ImageElementDraw", ".ctor()");
    init_DrawCalls();
}
...
{
    uStackFrame __("Fuse.Controls.Graphics.ImageElementDraw", "Draw(Fuse.DrawContext,Fuse.Node,float2,float2,float2,float2,texture2D,Fuse.Drawing.ResampleMode,float4)");
...
{
    uStackFrame __("Fuse.Controls.Graphics.ImageElementDraw", "GetSamplerState(Fuse.Drawing.ResampleMode)");
...
{
    uStackFrame __("Fuse.Controls.Graphics.ImageElementDraw", "init_DrawCalls()");
...
{
    uStackFrame __("Fuse.Controls.Graphics.ImageVisual", "Attach()");
...
{
    uStackFrame __("Fuse.Controls.Graphics.ImageVisual", "Detach()");
...
{
    uStackFrame __("Fuse.Controls.Graphics.ImageVisual", "GetMarginSize(Fuse.LayoutParams)");
...
{
    uStackFrame __("Fuse.Controls.Graphics.ImageVisual", "OnArrangeMarginBox(float2,Fuse.LayoutParams)");
    ::g::Uno::Float2 ret13;
...
{
    uStackFrame __("Fuse.Controls.Graphics.ImageVisual", "OnDraw(Fuse.DrawContext)");
    ::g::Uno::Float4 ind1;
    ::g::Uno::Float4 ind2;
    ::g::Uno::Float4 ind3;
...
{
    uStackFrame __("Fuse.Controls.Graphics.ImageVisual", "OnHitTest(Fuse.HitTestContext)");
...
{
    uStackFrame __("Fuse.Controls.Graphics.ImageVisual", ".ctor()");
    ctor_2();
}
...
{
    uStackFrame __("Fuse.Controls.Graphics.ImageVisual", "get_Container()");
...
{
    uStackFrame __("Fuse.Controls.Graphics.ImageVisual", "GetSize()");
...
{
    uStackFrame __("Fuse.Controls.Graphics.ImageVisual", "OnParamChanged(object,object)");
    InvalidateLayout(2);
    InvalidateVisual();
}
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Controls/0.24.6/Graphics/$.uno(174)
// ------------------------------------------------------------------------------------------

// public sealed class LinearSliderBehavior :174
// {
::g::Fuse::Behavior_type* LinearSliderBehavior_typeof()
{
    ...
    ::STRINGS[3] = uString::Const("Use just LinearRangeBehavior from Fuse.Gestures");
    ::STRINGS[4] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls/0.24.6/Graphics/$.uno");
    ::STRINGS[5] = uString::Const(".ctor");
    ::TYPES[10] = uObject_typeof();
    type->SetFields(7);
    type->Reflection.SetFunctions(1,
...
{
    uStackFrame __("Fuse.Controls.Graphics.PathShapeVisual`1", "AlignMatrix(float4x4)");
    ::g::Uno::Float4x4 b_ = *b;
...
{
    uStackFrame __("Fuse.Controls.Graphics.PathShapeVisual`1", "Attach()");
...
{
    uStackFrame __("Fuse.Controls.Graphics.PathShapeVisual`1", "DrawFill(Fuse.DrawContext,Fuse.Drawing.Brush)");
...
{
    uStackFrame __("Fuse.Controls.Graphics.PathShapeVisual`1", "DrawStroke(Fuse.DrawContext,Fuse.Drawing.Stroke)");
...
{
    uStackFrame __("Fuse.Controls.Graphics.PathShapeVisual`1", "get_LocalRenderBounds()");
...
{
    uStackFrame __("Fuse.Controls.Graphics.PathShapeVisual`1", "OnHitTest(Fuse.HitTestContext)");
...
void PathShapeVisual__PrepareDraw_fn(PathShapeVisual* __this, ::g::Fuse::DrawContext* dc)
{
    ...
    uStackFrame __("Fuse.Controls.Graphics.PathShapeVisual`1", "PrepareDraw(Fuse.DrawContext)");
...
{
    uStackFrame __("Fuse.Controls.Graphics.PathShapeVisual`1", "SoftDispose()");
...
{
    uStackFrame __("Fuse.Controls.Graphics.PathShapeVisual`1", ".ctor()");
...
uObject* PathShapeVisual::GetHitPart(::g::Uno::Float2 localCoords)
{
    ...
    uStackFrame __("Fuse.Controls.Graphics.PathShapeVisual`1", "GetHitPart(float2)");
...
{
    uStackFrame __("Fuse.Controls.Graphics.PathShapeVisual`1", "Invalidated()");
    InvalidateVisual();
}
...
{
    uStackFrame __("Fuse.Controls.Graphics.PathShapeVisual`1", "get_Renderer()");
...
{
    uStackFrame __("Fuse.Controls.Graphics.PathVisual", "AlignMatrix(float4x4)");
    ::g::Uno::Float4x4 b_ = *b;
...
{
    uStackFrame __("Fuse.Controls.Graphics.PathVisual", "GetMarginSize(Fuse.LayoutParams)");
    ::g::Fuse::LayoutParams lp_ = *lp;
...
{
    uStackFrame __("Fuse.Controls.Graphics.PathVisual", "get_LocalRenderBounds()");
...
{
    uStackFrame __("Fuse.Controls.Graphics.PathVisual", "OnArrangeMarginBox(float2,Fuse.LayoutParams)");
    ::g::Uno::Float4 ind1;
    ::g::Uno::Float4 ind2;
    ::g::Uno::Float2 ret6;
    ::g::Uno::Float2 position_ = *position;
...
{
    uStackFrame __("Fuse.Controls.Graphics.PathVisual", "UpdatePath(Fuse.Drawing.PathGeometryRenderer)");
...
{
    uStackFrame __("Fuse.Controls.Graphics.PathVisual", ".ctor()");
...
{
    uStackFrame __("Fuse.Controls.Graphics.PathVisual", "GetNaturalContentSize()");
...
{
    uStackFrame __("Fuse.Controls.Graphics.PathVisual", "get_Path()");
...
{
    uStackFrame __("Fuse.Controls.Graphics.RectangleVisual", "DrawFill(Fuse.DrawContext,Fuse.Drawing.Brush)");
...
{
    uStackFrame __("Fuse.Controls.Graphics.RectangleVisual", "DrawStroke(Fuse.DrawContext,Fuse.Drawing.Stroke)");
...
{
    uStackFrame __("Fuse.Controls.Graphics.RectangleVisual", "OnHitTest(Fuse.HitTestContext)");
    ::g::Uno::Float2 lp = uPtr(htc)->LocalPoint();
...
{
    uStackFrame __("Fuse.Controls.Graphics.RectangleVisual", ".ctor()");
    ctor_3();
}
...
{
    uStackFrame __("Fuse.Controls.Graphics.RectangleVisual", "get_Rectangle()");
...
{
    uStackFrame __("Fuse.Controls.Graphics.RegularPolygonVisual", "UpdatePath(Fuse.Drawing.PathGeometryRenderer)");
...
{
    uStackFrame __("Fuse.Controls.Graphics.RegularPolygonVisual", ".ctor()");
    ctor_4();
}
...
{
    uStackFrame __("Fuse.Controls.Graphics.RegularPolygonVisual", "get_Offset()");
...
{
    uStackFrame __("Fuse.Controls.Graphics.RegularPolygonVisual", "get_Radius()");
...
{
    uStackFrame __("Fuse.Controls.Graphics.RegularPolygonVisual", "get_RegularPolygon()");
...
{
    uStackFrame __("Fuse.Controls.Graphics.ShapeVisual`1", "Attach()");
...
{
    uStackFrame __("Fuse.Controls.Graphics.ShapeVisual`1", "Detach()");
...
{
    uStackFrame __("Fuse.Controls.Graphics.ShapeVisual`1", "GetMarginSize(Fuse.LayoutParams)");
    ::g::Fuse::LayoutParams lp_ = *lp;
...
{
    uStackFrame __("Fuse.Controls.Graphics.ShapeVisual`1", "OnDraw(Fuse.DrawContext)");
...
{
    uStackFrame __("Fuse.Controls.Graphics.ShapeVisual`1", "PrepareDraw(Fuse.DrawContext)");
...
{
    uStackFrame __("Fuse.Controls.Graphics.ShapeVisual`1", ".ctor()");
    ctor_2();
}
...
::g::Fuse::Controls::Shape* ShapeVisual::Shape()
{
    ...
    uStackFrame __("Fuse.Controls.Graphics.ShapeVisual`1", "get_Shape()");
...
{
    uStackFrame __("Fuse.Controls.Graphics.StarVisual", "UpdatePath(Fuse.Drawing.PathGeometryRenderer)");
...
{
    uStackFrame __("Fuse.Controls.Graphics.StarVisual", ".ctor()");
    ctor_4();
}
...
{
    uStackFrame __("Fuse.Controls.Graphics.StarVisual", "get_Offset()");
    return (ActualSize().X > ActualSize().Y) ? ::g::Uno::Float2__New2((ActualSize().X * 0.5f) - (ActualSize().Y * 0.5f), 0.0f) : ::g::Uno::Float2__New2(0.0f, (ActualSize().Y * 0.5f) - (ActualSize().X * 0.5f));
}
...
{
    uStackFrame __("Fuse.Controls.Graphics.StarVisual", "get_Radius()");
    return ::g::Uno::Math::Min1(ActualSize().X, ActualSize().Y) * 0.5f;
}
...
{
    uStackFrame __("Fuse.Controls.Graphics.StarVisual", "get_SpokeRadius()");
...
{
    uStackFrame __("Fuse.Controls.Graphics.StarVisual", "get_Star()");

...
void ConcurrentCollection__Add_fn(ConcurrentCollection* __this, void* item)
{
    ...
    uStackFrame __("Uno.Collections.ConcurrentCollection`1", "Add(T)");
...
void ConcurrentCollection__Contains_fn(ConcurrentCollection* __this, void* item, bool* __retval)
{
    ...
    uStackFrame __("Uno.Collections.ConcurrentCollection`1", "Contains(T)");
...
void ConcurrentCollection__get_Item_fn(ConcurrentCollection* __this, int* index, uTRef __retval)
{
    ...
    uStackFrame __("Uno.Collections.ConcurrentCollection`1", "get_Item(int)");
...
void ConcurrentCollection__Remove_fn(ConcurrentCollection* __this, void* item, bool* __retval)
{
    ...
    uStackFrame __("Uno.Collections.ConcurrentCollection`1", "Remove(T)");
...
void ConcurrentCollection::ctor_()
{
    ...
    uStackFrame __("Uno.Collections.ConcurrentCollection`1", ".ctor()");
...
{
    uStackFrame __("Uno.Collections.ConcurrentCollection`1", "Clear()");
    uPtr(_back)->Clear();
...
int ConcurrentCollection::Count()
{
    ...
    uStackFrame __("Uno.Collections.ConcurrentCollection`1", "get_Count()");
...
{
    uStackFrame __("Uno.Collections.ConcurrentCollection`1", "DeferChanges()");
    _defer = true;
}
...
uObject* ConcurrentCollection::DeferLock()
{
    ...
    uStackFrame __("Uno.Collections.ConcurrentCollection`1", "DeferLock()");
...
void ConcurrentCollection::EndDefer()
{
    ...
    uStackFrame __("Uno.Collections.ConcurrentCollection`1", "EndDefer()");
...
uObject* ConcurrentCollection::GetEnumerator()
{
    ...
    uStackFrame __("Uno.Collections.ConcurrentCollection`1", "GetEnumerator()");
...
::g::Uno::Collections::List* ConcurrentCollection::Mod()
{
    ...
    uStackFrame __("Uno.Collections.ConcurrentCollection`1", "get_Mod()");
...
{
    uStackFrame __("Uno.Collections.ConcurrentCollection`1.DeferLockImpl", ".ctor(Uno.Collections.ConcurrentCollection<T>)");
    _collection = c;
}
...
{
    uStackFrame __("Uno.Collections.ConcurrentCollection`1.DeferLockImpl", "Dispose()");
...
LinkedList__Enumerator_type* LinkedList__Enumerator_typeof()
{
    ...
    ::TYPES[26] = ::g::Uno::Collections::LinkedList_typeof();
    ::TYPES[27] = ::g::Uno::Collections::LinkedListNode_typeof();
    type->SetPrecalc(
        ::TYPES[26/*Uno.Collections.LinkedList`1*/]->MakeType(type->T(0)),
        ::TYPES[27/*Uno.Collections.LinkedListNode`1*/]->MakeType(type->T(0)));
    type->SetInterfaces(
...
HashSet__Enumerator_type* HashSet__Enumerator_typeof()
{
    ...
    ::STRINGS[2] = uString::Const("Collection was modified");
    ::TYPES[29] = ::g::Uno::Collections::Dictionary_typeof();
    ::TYPES[3] = ::g::Uno::Bool_typeof();
    ::TYPES[10] = ::g::Uno::Int_typeof();
    ::TYPES[11] = ::g::Uno::Collections::Dictionary__Bucket_typeof();
    ::TYPES[8] = uObject_typeof()->Array();
    type->SetPrecalc(
        ::TYPES[29/*Uno.Collections.Dictionary`2*/]->MakeType(type->T(0), ::TYPES[3/*bool*/]),
...
Dictionary__Enumerator_type* Dictionary__Enumerator_typeof()
{
    ...
    ::TYPES[8] = uObject_typeof()->Array();
    type->SetPrecalc(
        ::TYPES[29/*Uno.Collections.Dictionary`2*/]->MakeType(type->T(0), type->T(1)),
        ::TYPES[9/*Uno.Collections.KeyValuePair`2*/]->MakeType(type->T(0), type->T(1)),
        ::TYPES[11/*Uno.Collections.Dictionary`2.Bucket*/]->MakeType(type->T(0), type->T(1)),
        ::TYPES[11/*Uno.Collections.Dictionary`2.Bucket*/]->MakeType(type->T(0), type->T(1))->Array());
    type->SetInterfaces(
...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Collections/$.uno(79)
// -------------------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Collections/$.uno(1460)
// ---------------------------------------------------------------------------------------------------

// public struct Stack<T>.Enumerator :1460
// {
// public T get_Current() [adapter] :1476
...
// public void Dispose() [adapter] :1482
...
// public bool MoveNext() [adapter] :1494
...
Stack__Enumerator_type* Stack__Enumerator_typeof()
{
    ...
    ::STRINGS[2] = uString::Const("Collection was modified");
    ::TYPES[30] = ::g::Uno::Collections::Stack_typeof();
    type->SetPrecalc(
        ::TYPES[30/*Uno.Collections.Stack`1*/]->MakeType(type->T(0)));
    type->SetInterfaces(
...
// internal Enumerator(Uno.Collections.Stack<T> source) :1467
...
// internal Enumerator New(Uno.Collections.Stack<T> source) :1467
...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Collections/$.uno(77)
// -------------------------------------------------------------------------------------------------
...
// public Uno.Collections.LinkedListNode<T> AddFirst(T value) :890
...
// ../../../../../../../usr/local/share/uno/Packages/Uno.Collections/0.24.0/Extensions/$.uno(402)
// ----------------------------------------------------------------------------------------------
...
// public Queue(int capacity) :1306
void Queue__ctor_1_fn(Queue* __this, int* capacity)
{
    __this->ctor_1(*capacity);
}

// public void Clear() :1324
void Queue__Clear_fn(Queue* __this)
{
    __this->Clear();
}

// public bool Contains(T item) :1333
...
// public Queue New(int capacity) :1306
...
// public Queue(int capacity) [instance] :1306
...
// public void Clear() [instance] :1324
void Queue::Clear()
{
...
// public Queue New(int capacity) [static] :1306
...
// ../../../../../../../usr/local/share/uno/Packages/UnoCore/0.24.3/Source/Uno/Collections/$.uno(1434)
// ---------------------------------------------------------------------------------------------------

// public sealed class Stack<T> :1434
// {
...
// public Stack(int capacity) :1446
void Stack__ctor_1_fn(Stack* __this, int* capacity)
{
    __this->ctor_1(*capacity);
}

// public void Clear() :1516
void Stack__Clear_fn(Stack* __this)
{
    __this->Clear();
}

// public bool Contains(T item) :1523
...
// public Stack(int capacity) [instance] :1446
...
// public void Clear() [instance] :1516
void Stack::Clear()
{
...
// public int get_Count() [instance] :1454
int Stack::Count()
{
...
// private void EnsureCapacity() [instance] :1560
...
// public Uno.Collections.IEnumerator<T> GetEnumerator() [instance] :1511
...
// public Stack New(int capacity) [static] :1446

...
// ../../../../../../../usr/local/share/uno/Packages/Outracks.Simulator.Reflection.Uno/0.0.0/$.uno(63)
// ---------------------------------------------------------------------------------------------------
...
DelegateReflection_type* DelegateReflection_typeof()
{
    ...
    type->interface0.fp_CreateDelegate = (void(*)(uObject*, ::g::Outracks::Simulator::Bytecode::TypeName*, uObject*, ::g::Outracks::Simulator::Bytecode::TypeMemberName*, ::g::Outracks::Simulator::Bytecode::Signature*, uObject**))DelegateReflection__OutracksSimulatorRuntimeIReflectionCreateDelegate_fn;
...
// private object Outracks.Simulator.Runtime.IReflection.CreateDelegate(Outracks.Simulator.Bytecode.TypeName delegateType, object instance, Outracks.Simulator.Bytecode.TypeMemberName methodName, Outracks.Simulator.Bytecode.Signature methodSignature) :109
...
{
    uStackFrame __("Outracks.Simulator.Reflection.DelegateReflection", "Outracks.Simulator.Runtime.IReflection.CreateDelegate(Outracks.Simulator.Bytecode.TypeName,object,Outracks.Simulator.Bytecode.TypeMemberName,Outracks.Simulator.Bytecode.Signature)");
